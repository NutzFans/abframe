...
%>
  <script>
      ...
      function updateRecord()
      {
        ...
        var url = "org.gocom.abframe.tools.FileUploadManager.flow";
  ...
  <body topmargin="0" leftmargin="0">
    ...
    <e:datasource name="uploadFiles" type="entity" path="org.gocom.abframe.dataset.tools.AtFileupload" />
    <h:form name="query_form" action="org.gocom.abframe.tools.FileUploadManager.flow" method="post" onsubmit="return checkForm(this);">
        ...
        <table align="center" border="0" width="100%" class="form_table">
          ...
          <tr class="form_bottom">
            <td colspan="12" class="form_bottom">
              <input type="hidden" name="criteria/_entity" value="org.gocom.abframe.dataset.tools.AtFileupload">
    ...
    <h:form name="page_form" action="org.gocom.abframe.tools.FileUploadManager.flow" method="post">
      <input type="hidden" name="_eosFlowAction" value="pageQuery"/>
        ...
        <table align="center" border="0" width="100%" class="EOS_table">
          ...
          <tr>
            ...
            <th>         <!-- 文件类型 -->
             ...
             <th>         <!-- 文件大小-->
              <b:message key="FileuploadManager_AtFileUpload.fileSize"></b:message>(M)
            </th>
            <th>         <!-- 操作员姓名 -->
