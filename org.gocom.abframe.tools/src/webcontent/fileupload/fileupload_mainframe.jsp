...
<body topmargin="0" leftmargin="0">
    <w:tabPanel id="fileuploadManagerTab" height="100%" width="100%">
        <w:tabPage id="filemanager" tabType="iframe" title="<%=fileManager%>" url="org.gocom.abframe.tools.FileUploadManager.flow?_eosFlowAction=enterManager" >
        </w:tabPage>
        <w:tabPage id="fileupload" tabType="iframe" title="<%=fileUpload%>" url="org.gocom.abframe.tools.FileUploadManager.flow?_eosFlowAction=enterUpload" >
        </w:tabPage>
    </w:tabPanel>
</body>
</html>
