...
<html>
  <head>
    ...
    <script language="javascript">
		...
		function fileUpdate()
		{
		    ...
		    var myAjax = new Ajax("org.gocom.abframe.tools.FileUploadManager.updateFile.biz");
		    //增加参数
  ...
  <body leftmargin="0" rightmargin="0" topmargin="0" class="eos-panel-table">
    <e:datasource name="atFileupload" type="entity" path="org.gocom.abframe.dataset.tools.AtFileupload" />
