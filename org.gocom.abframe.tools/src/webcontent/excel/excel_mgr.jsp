...
<script language="JavaScript" type="text/javascript">
	...
	function dictImport()
	{
		...
		frm.action = "org.gocom.abframe.tools.ExcelMgr.flow?_eosFlowAction=importExcel&excelFile=" + excelFile;
		frm.submit();
	}     
...
<body leftmargin="0" rightmargin="0" topmargin="0">
	<table align="center" border="0" width="100%" class="form_table">
		<h:form id="importForm" action="org.gocom.abframe.tools.ExcelMgr.flow?_eosFlowAction=importExcel" method="post" enctype="multipart/form-data" onsubmit="return checkForm(this);">
		<tr height="4%">
