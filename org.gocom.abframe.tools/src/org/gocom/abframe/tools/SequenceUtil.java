/*******************************************************************************
 * $Header: /cvsroot/MIS10/src/NEWERP/org.gocom.abframe.tools/src/org/gocom/abframe/tools/SequenceUtil.java,v 1.2 2014/12/01 10:25:10 huangqj Exp $
 * $Revision: 1.2 $
 * $Date: 2014/12/01 10:25:10 $
 *
 *==============================================================================
 *
 ...
 * Revision 1.2  2014/12/01 10:25:10  huangqj
 * *** empty log message ***
 *
...
public class SequenceUtil {
	...
	public static String getNextSequenceValue(String dsName, String entityName, String propertyName, String pattern, String whereString, int length) {
		...
		//执行数据库
		if(whereString != null && whereString.equals("assetnum=BJ")){
			String tempPattern = pattern.concat("%");
			Object[] tempResult = DatabaseExt.queryByNamedSql("default", "com.primeton.eos.machine.machine.getMaxAssetNum",tempPattern);
			DataObject[] result = null;
			if(tempResult.length == 1){
				result = new DataObject[tempResult.length];
				result[0] = (DataObject) tempResult[0];
			}
