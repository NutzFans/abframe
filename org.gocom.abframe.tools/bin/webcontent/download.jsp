...
<%@page import="java.io.*"%><%
      ...
      String localFile=(String)XpathUtil.getStringValue("r",pageContext,"downloadFile");
      LogUtil.logInfo(">>>>download file is {0}",null ,new Object[]{localFile});
	  byte[] buffer = new byte[512]; 
	  int size = 0; 
	  response.reset();
	  response.setContentType("application/vnd.ms-excel");
 	  response.setHeader("Content-disposition", "attachment;filename=\""+ java.net.URLEncoder.encode("DictExport.xls","UTF-8") + "\"");
