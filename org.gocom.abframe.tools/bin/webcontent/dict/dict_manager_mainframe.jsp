...
<body topmargin="0" leftmargin="0">
    <w:tabPanel id="operatorManagerTab" height="100%" width="100%">
        <w:tabPage id="dictManager" tabType="iframe" title="<%=dictManagerLabel%>" url="org.gocom.abframe.tools.DictManager.flow?_eosFlowAction=dictManager" ><!-- 业务字典导入管理 -->
        </w:tabPage>
        <w:tabPage id="dictImport" tabType="iframe" title="<%=dictImportLabel%>" url="org.gocom.abframe.tools.DictManager.flow?_eosFlowAction=dictImport" ><!-- 业务字典导入管理 -->
        </w:tabPage>
    </w:tabPanel>
</body>
</html>
