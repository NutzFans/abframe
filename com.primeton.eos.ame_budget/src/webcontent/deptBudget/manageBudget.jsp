...
<div style="width: 1450px;height: 100%;overflow:scroll; margin: 0px;">
	...
	<div id="grid_manage" class="nui-datagrid" style="width:1082px;height:auto;" dataField="sumCost" url="com.primeton.eos.ame_budget.deptbudget.queryCost.biz.ext" 
	...
	<script type="text/javascript">
		nui.parse();
		var grid = nui.get("grid_manage");
    	//管理成本costtype设置为3
    	var costtype = "3";
    	var costtypename = "管理成本";
