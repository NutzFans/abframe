...
<div style="width: 1450px;height: 100%;overflow:scroll; margin: 0px;">
	...
	<div id="grid_sale" class="nui-datagrid" style="width:1082px;height:auto;" dataField="sumCost" url="com.primeton.eos.ame_budget.deptbudget.queryCost.biz.ext" 
    sizeList="[10,20,50,100]" idField="appid" showPager="false" showSummaryRow="true" ondrawsummarycell="doCountSum">
		<div property="columns">
			<div field="type" width="140" align="center"  headerAlign="center">分类</div>
	...
	<script type="text/javascript">
		nui.parse();
		var grid = nui.get("grid_sale");
    	//销售成本costtype设置为2
    	var costtype = "2";
    	var costtypename = "销售成本";
