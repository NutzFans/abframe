...
<div style="width: 1450px;height: 100%;overflow:scroll; margin: 0px;">
	...
	<div id="grid_market" class="nui-datagrid" style="width:1082px;height:auto;" dataField="sumCost" url="com.primeton.eos.ame_budget.deptbudget.queryCost.biz.ext" 
	...
	<script type="text/javascript">
		nui.parse();
		var grid = nui.get("grid_market");
    	//市场成本costtype设置为5
    	var costtype = "5";
    	var costtypename = "市场成本";
