	 	...
	 	<form id="form1" method="post" >
	        ...
	        <input class="nui-hidden" name="criteria._expr[4]._op" value="between"/>
 			<div class="nui-toolbar" style="border-bottom:0;padding:0px;">
	            ...
	            <div id="grid_1" class="nui-datagrid" style="width:100%;height:auto;" showPager="true" sizeList="[20,50,100,500]" pageSize="20"
	            	url="com.primeton.eos.ame_budget.ame_budget.getPemp.biz.ext" 
	            ...
	            <div property="columns">
	              ...
	              <div field="taskname" width="25px" headerAlign="center">项目活动</div>
	              <div field="projectno" width="30px" headerAlign="center" >项目代码</div>  
	              <div field="projectName" width="35px" headerAlign="center" >项目名称</div> 
	              <div field="custjc" width="30px" headerAlign="center">所属客户</div> 
	              <div field="repContent" width="35px" headerAlign="center">工作内容</div>
