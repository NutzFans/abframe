...
-->
<head>
<title>合同收款记录管理</title>
<meta http-equiv="content-type" content="text/html; charset=UTF-8" />
<script src="<%= request.getContextPath() %>/common/nui/nui.js" type="text/javascript"></script>
</head>
<body>
	<!-- 
		1、通过菜单进入（商务、财务、运营平台查看全公司、事业部、业务单元查看各自权限范围内数据）
		2、查询条件:部门、合同编号、签署单位、受益销售、所属事业部、收款状态、预计收款年月范围、实际收款日期范围
		3、查询列表:合同编号、签署单位、合同名称、合同金额、收款次数编号，收款状态，预计收款年月、预计收款金额(含税），预计收款金额（不含税），实际收款日期
		4、按照事业部、受益销售、预测收款年月顺序排序
		5、列表下提供统计行，针对数字字段进行统计
		6、合同编号、收款次数编号提供链接，分别链接对应详细信息
		7、事业部人员进入，能够控制数据权限
	 -->
	<div class="nui-panel" title="合同收款记录管理" width="auto">
		<div style="width:100%;height:20;padding:0px;margin:0px;"id="csGatherFcForm">
			<div class="nui-toolbar" style="border-bottom:0;padding:0px;">
				<table style="width:100%;">
					<tr>
						<td align="right" style="width: 120px;" nowrap="nowrap"><span>合同编号:</span></td>
						...
						<td align="right" style="width: 120px;" nowrap="nowrap"><span>收款状态:</span></td>
						<td align="left" nowrap="nowrap">
							<input class="nui-dictcombobox" name="criteria._expr[5]._value" id="status" style="width:150px;" dictTypeId="AME_GATHERSTATUS" showNullItem="true" multiSelect="true" />
						...
						<td align="right" style="width: 120px;" nowrap="nowrap"><span>受益部门:</span></td>
						<td align="left" nowrap="nowrap">
					...
					<tr>
						<td align="right" style="width: 120px;"><span>项目编号:</span></td>
						<td align="left">
						...
						<td align="right" style="width: 120px;"><span>预计收款年月范围:</span></td>
						<td align="left">
					...
					<tr>
						...
						<td align="right" style="width: 120px;"><span>收款开票状态:</span></td>
						<td align="left">
							<input class="nui-dictcombobox" name="criteria._expr[11]._value" id="billstatus" style="width:150px;" dictTypeId="MIS_GATHERBILL" showNullItem="true" multiSelect="true" />
						    <input class="nui-hidden" name="criteria._expr[11]._property" value="billstatus"/>
						    <input class="nui-hidden" name="criteria._expr[11]._op" value="in"/>
						</td>
						<td align="right" style="width: 120px;"><span>实际收款日期范围 :</span></td>
		            	<td align="left" >
					...
					<tr>
		    			<td align="center" colspan="4">
                            ...
                            <a class="nui-button" onclick="exportCsReves" iconCls="icon-download" style="width:145px;" id="exportButton">导出合同收款记录</a>
						...
						<td align="right" style="width: 120px;"><span>财报收款日期范围 :</span></td>
		            	<td align="left" >
					        <input class="nui-datepicker" name="criteria._expr[12]._min" id="startTime" style="width:90px"/>
					         -
					        <input class="nui-datepicker" name="criteria._expr[12]._max" id="endTime" style="width:90px"/>
					        <input class="nui-hidden" name="criteria._expr[12]._property" value="confirmday"/>
	    ...
	    <div class="nui-toolbar" style="border-bottom:0;padding:0px;">
            <table style="width:100%;">
            	<tr>
                    <td style="width:20%;">
                        <a class="nui-button" id="addBtn" iconCls="icon-edit" onclick="addOrEdit()">增加/更新合同收款记录</a>
                    </td>
                </tr>
             </table>           
        </div>
	    <div id="csGatherFcGrid" class="nui-datagrid" style="width:100%;height:350px;" allowResize="true" dataField="csGatherFcs" showSummaryRow="true" ondrawsummarycell="doCsGatherFcSum"
			...
			<div property="columns">
				...
				<div field="salename" width="70" align="center" headerAlign="center" allowSort="false">受益销售</div> 
				...
				<div field="status" width="80" align="center" headerAlign="center" renderer="dictstatus">收款状态</div>
				...
				<div field="fcsum2" width="140" align="right" headerAlign="center" dataType="currency" summaryType="sum" currencyUnit="￥">预计收款金额（不含税）</div>
				<div field="actsum" width="140" align="right" headerAlign="center" dataType="currency" summaryType="sum" currencyUnit="￥">已收款金额</div>	
				<div field="maconfirmday" width="80" align="center" headerAlign="center" >实际收款日期</div>	
				<div field="confirmday" width="80" align="center" headerAlign="center" >财报收款日期</div>
				<div field="projectno" width="180" align="center" headerAlign="center" renderer="detailProj" >项目编号</div>
				<div field="projectname1" width="0" align="center" headerAlign="center" renderer="detailProj" >项目名称</div>	
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function init(){
			...
			var json = {"code":"HTSKJLGL","map":{"property":"status","op":"=","value":"running"}};
				nui.ajax({
		...
		function doCsGatherFcSum(e){        	
            if (e.field == "contsum" || e.field == "fcsum" || e.field == "fcsum2" || e.field == "actsum") {
	    ...
	    function search(){
			...
			csGatherFcGrid.sortBy("contnum","desc");
    		csGatherFcGrid.load(data);
	    }
