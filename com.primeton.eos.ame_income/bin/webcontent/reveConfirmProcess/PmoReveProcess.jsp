		...
		<fieldset style="border:solid 1px #aaa;padding:3px;">
            <legend>合同收入记录列表</legend>
				...
				<div property="columns">
					...
					<div field="yearmonth" width="70" headerAlign="center" align="center" headerAlign="center" >预计确认年月</div>
<!-- 					<div field="newmonthperiod" width="65" align="center"  headerAlign="center" renderer="dictmonth">预计确认旬度</div> -->
					...
					<div field="actsum" width="70" align="right" headerAlign="center" summaryType="sum" dataType="currency" summaryType="sum" >实际确认金额</div>	
					<div field="mamaconfirmday" width="70" align="center" headerAlign="center" >确认日期</div>
...
<!-- 					<div field="actreveproof" width="70" align="center" headerAlign="center" renderer="dictproof">实际收入确认证据</div>		 -->
			...
			<div style="padding:5px;">
				...
				<table style="table-layout:fixed;">
					...
					<tr id="setyearmonth" style="display: none;">
						...
						<td style="width:130px"><input name="csReveForecast.setstart" id="setstart" required="true" class="nui-monthpicker" format="yyyyMM" style="width:120px" allowInput="false" onvaluechanged="selectYM"/></td>
						<td align="right" style="width:100px">本次结算结束年月：</td>
						<td style="width:130px"><input name="csReveForecast.setend" id="setend" required="true" class="nui-monthpicker" format="yyyyMM" style="width:150px" allowInput="false" onvaluechanged="selectYM"/></td>
					...
					<tr>
						<td align="right" style="width:110px">确认日期：</td>
						<td style="width:130px"><input name="csReveForecast.maconfirmday" id="confirmday" class="nui-datepicker" style="width:120px" /></td>
						<td align="right" style="width:130px">实际收入确认证据：</td>
						<td colspan="1" style="width:130px"><input name="csReveForecast.actreveproof" id="actreveproof" class="nui-dictcombobox" dictTypeId="MIS_INCOMECONV" multiSelect="true" style="width:200px" /></td>
						<td align="right" style="width:110px">预计收入确认证据：</td>
						<td style="width:150px" name="csReveForecast.reveproof" id="reveproof" /></td>
					</tr>
					<tr>
						<td align="right" style="width:110px">确认开始日期：</td>
						<td style="width:130px"><input name="csReveForecast.maconfirmdayStart" id="confirmdayStart" class="nui-datepicker" style="width:120px" /></td>
					</tr>
				</table>
				<fieldset id="field3" style="border:solid 1px #aaa;padding:3px;">
					<legend>合同收入金额信息</legend>
						<table style="table-layout:fixed;">
							...
							<tr> 
								...
								<td style="width:140px"><input name="csReveForecast.actproductsum" id="actproductsum" style="width:120px" class="nui-spinner" onvaluechanged="onvaluechanged(e)" changeOnMousewheel="false" inputStyle="text-align:right;" format="n2" showbutton="false" minValue="-100000000" maxValue="100000000" /></td>
								<td style="width:140px"><input name="csReveForecast.productrate" id="productrate" style="width:120px" class="nui-spinner" onvaluechanged="onvaluechanged(e)" changeOnMousewheel="false" inputStyle="text-align:right;" format="p0" showbutton="false"/></td>
								<td style="width:140px"><input name="csReveForecast.actproductsum2" id="actproductsum2" style="width:120px" class="nui-spinner" changeOnMousewheel="false" inputStyle="text-align:right;" format="n2" showbutton="false" minValue="-100000000" maxValue="100000000"/></td>
							</tr>
							<tr>
								<td align="right" style="width:120px">服务：</td>
								<td style="width:120px" name="csReveForecast.servicesum" id="servicesum" /></td>
								<td style="width:140px"><input name="csReveForecast.actservicesum" id="actservicesum" style="width:120px" class="nui-spinner"onvaluechanged="onvaluechanged(e)" changeOnMousewheel="false" inputStyle="text-align:right;" format="n2" showbutton="false" minValue="-100000000" maxValue="100000000"/></td>
								<td style="width:140px"><input name="csReveForecast.servicerate" id="servicerate" style="width:120px" class="nui-spinner" onvaluechanged="onvaluechanged(e)" changeOnMousewheel="false" showbutton="false" inputStyle="text-align:right;" format="p0"/></td>
								<td style="width:140px"><input name="csReveForecast.actservicesum2" id="actservicesum2" style="width:120px" class="nui-spinner" changeOnMousewheel="false" inputStyle="text-align:right;" format="n2" showbutton="false" minValue="-100000000" maxValue="100000000"/></td>
							</tr>
							<tr>
								<td align="right" style="width:120px">MA：</td>
								<td style="width:120px" name="csReveForecast.masum" id="masum" /></td>
								<td style="width:140px"><input name="csReveForecast.actmasum" id="actmasum" style="width:120px" class="nui-spinner"onvaluechanged="onvaluechanged(e)" changeOnMousewheel="false" inputStyle="text-align:right;" format="n2" showbutton="false" minValue="-100000000" maxValue="100000000"/></td>
								<td style="width:140px"><input name="csReveForecast.marate" id="marate" style="width:120px" class="nui-spinner" onvaluechanged="onvaluechanged(e)" changeOnMousewheel="false" inputStyle="text-align:right;" format="p0" showbutton="false"/></td>
								<td style="width:140px"><input name="csReveForecast.actmasum2" id="actmasum2" style="width:120px" class="nui-spinner" changeOnMousewheel="false" inputStyle="text-align:right;" format="n2" showbutton="false" minValue="-100000000" maxValue="100000000"/></td>
							</tr>
							<tr>
								<td align="right" style="width:120px">总金额：</td>
								<td style="width:120px" name="csReveForecast.fcsum" id="fcsum" /></td>
								<td style="width:140px"><input name="csReveForecast.actsum" id="actsum" class="nui-spinner" changeOnMousewheel="false" style="width:120px" inputStyle="text-align:right;" format="n2" showbutton="false" minValue="-100000000" maxValue="100000000"/></td>
								<td style="width:140px"></td>
								<td style="width:140px"><input name="csReveForecast.actsum2" id="actsum2" style="width:120px" class="nui-spinner" changeOnMousewheel="false" onblur="countprofit"  inputStyle="text-align:right;" format="n2" showbutton="false" minValue="-100000000" maxValue="100000000"/></td>
							</tr>
						</table>
					</fieldset>
					<table style="table-layout:fixed;">
						<tr>
							...
							<td><input name="csReveForecast.memo" id="memo" class="nui-textarea" style="width:560px"/></td>
						</tr>
					</table>
					<table>
						<tr>
	...
	<fieldset id="field3" style="border:solid 1px #aaa;padding:3px;">
		...
		<div  class="nui-tabs" style="width:100%;" activeIndex="0">
			...
			<div title="该合同成本数据" style="width:100%;" visible="true">
    ...
    <fieldset id="field3" style="border:solid 1px #aaa;padding:3px;">
		...
		<br/>
   		<div style="width: 100%;height: 30px;">
   			<span style="font-size: 16px;color: red;font-weight: bold;">收入确认完成后是否启动项目考核流程</span>
       		<div style="display: inline-block;font-size: 16px;" class="nui-radiobuttonlist" id="isDistribution" valueField="id" textField="text" data="[{'id': '1','text': '是'},{'id': '0','text': '否'}]" onvaluechanged="showPerson" ></div>
   			<input class="nui-combobox" id="projcheckid" style="width:400px;" textField="projectname" valueField="projcheckid"  showNullItem="false" allowInput="false" required="true" >
   		</div>
   		<br/>
...
<script type="text/javascript">
	...
	function loadData(){
		...
		nui.ajax({
			...
			success:function (o){
		    	...
		    	//计算不含税金额
		    	var actproductsum2 = parseFloat(o.csReveForecast.actproductsum/(1+parseFloat(o.csReveForecast.productrate))).toFixed(2);
		    	var actservicesum2 = parseFloat(o.csReveForecast.actservicesum/(1+parseFloat(o.csReveForecast.servicerate))).toFixed(2);
		    	var actmasum2 = parseFloat(o.csReveForecast.actmasum/(1+parseFloat(o.csReveForecast.marate))).toFixed(2);
            	...
            	var datas = o.datas;
            	var check = o.check;
            	var isDistribution = o.csReveForecast.isDistribution;
            	if(isDistribution!=null){
            		nui.get("isDistribution").setValue(isDistribution);
            	}
            	showPerson();
            	nui.get("projcheckid").setData(datas);
            	if(check!=null){
            		nui.get("projcheckid").setValue(check.projcheckid);
            		nui.get("projcheckid").setText(check.projectname);
            	}
            	if(o.workitem.activityDefID == 'manualActivity10'){
        			document.getElementById("field55").style.display="none";
        			//document.getElementById("projcheckid").style.display="none";
        		...
        		}else if(o.workitem.activityDefID == 'manualActivity101'){
        			document.getElementById("field55").style.display="";
        			showIncomeCheck(o.workitem.processInstID);
        		}
			},
			error:function(){}
		});
    ...
    function onOk(e) {
    	...
    	var projcheckid = nui.get("projcheckid").getValue();
    	if(isDistribution==null||isDistribution==""){
    		alert("是否启动项目考核流程没有填选,请选择后再进行提交！");
    		return;
    	}
    	if(isDistribution=='1'){
    		if(projcheckid==null||projcheckid==""){
    			alert("项目考核信息不能为空！");
    			return;
    		}
    	}
    ...
    function SaveData() {
		...
		var projectname = nui.get("projcheckid").getText();
		var projcheckid = nui.get("projcheckid").getValue();
		var isDistribution = nui.get("isDistribution").getValue();
		reve.csReveForecast.projectnames = projectname;
		reve.csReveForecast.projcheckid = projcheckid;
		reve.csReveForecast.isDistribution = isDistribution;
        ...
        var json = nui.encode({csReveForecast:reve.csReveForecast,misOpinion:opin.misOpinion,csIncomecheck:checklistrow,otherPurchases:data_otherPurchases});
        nui.ajax({
    ...
    //选择供应商弹窗
    	...
    	function showPerson(){
    		var isDistribution = nui.get("isDistribution").getValue();
    		if(isDistribution=='1'){
    			document.getElementById("projcheckid").style.display='';
