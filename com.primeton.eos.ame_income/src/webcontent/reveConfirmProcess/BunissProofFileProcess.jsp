...
<div class="nui-fit">
			...
			<div style="padding:5px;">
				...
				<table style="table-layout:fixed;">
					...
					<tr>
						...
						<td style="width:200px" name="csReveForecast.revetimedesc" id="revetimedesc"/></td>
					</tr>
					...
					<tr>
						...
						<td colspan="1"  id="actreveproof"><!-- <input name="csReveForecast.actreveproof" id="actreveproof" class="nui-dictcombobox" dictTypeId="MIS_INCOMECONV" multiSelect="true" style="width:200px" /> --></td>
					...
					<legend>合同收入金额信息</legend>
						<table style="table-layout:fixed;">
							...
							<tr> 
								...
								<td style="width:140px"><input name="csReveForecast.actproductsum" id="actproductsum" readonly="readonly" style="width:120px" class="nui-spinner" changeOnMousewheel="false" inputStyle="text-align:right;" format="n2" showbutton="false" minValue="-100000000" maxValue="100000000" /></td>
								<td style="width:140px"><input name="csReveForecast.productrate" id="productrate" readonly="readonly" style="width:120px" class="nui-spinner" changeOnMousewheel="false" inputStyle="text-align:right;" format="p0" showbutton="false"/></td>
								<td style="width:140px"><input name="csReveForecast.actproductsum2" id="actproductsum2" readonly="readonly" style="width:120px" class="nui-spinner" changeOnMousewheel="false" inputStyle="text-align:right;" format="n2" showbutton="false" minValue="-100000000" maxValue="100000000"/></td>
							</tr>
							<tr>
								<td align="right" style="width:120px">服务：</td>
								<td style="width:120px" name="csReveForecast.servicesum" id="servicesum" /></td>
								<td style="width:140px"><input name="csReveForecast.actservicesum" id="actservicesum" readonly="readonly" style="width:120px" class="nui-spinner" changeOnMousewheel="false" inputStyle="text-align:right;" format="n2" showbutton="false" minValue="-100000000" maxValue="100000000"/></td>
								<td style="width:140px"><input name="csReveForecast.servicerate" id="servicerate" readonly="readonly" style="width:120px" class="nui-spinner" changeOnMousewheel="false" showbutton="false" inputStyle="text-align:right;" format="p0"/></td>
								<td style="width:140px"><input name="csReveForecast.actservicesum2" id="actservicesum2" readonly="readonly" style="width:120px" class="nui-spinner" changeOnMousewheel="false" inputStyle="text-align:right;" format="n2" showbutton="false" minValue="-100000000" maxValue="100000000"/></td>
							</tr>
							<tr>
								<td align="right" style="width:120px">MA：</td>
								<td style="width:120px" name="csReveForecast.masum" id="masum" /></td>
								<td style="width:140px"><input name="csReveForecast.actmasum" id="actmasum" readonly="readonly" style="width:120px" class="nui-spinner" changeOnMousewheel="false" inputStyle="text-align:right;" format="n2" showbutton="false" minValue="-100000000" maxValue="100000000"/></td>
								<td style="width:140px"><input name="csReveForecast.marate" id="marate" readonly="readonly" style="width:120px" class="nui-spinner" changeOnMousewheel="false" inputStyle="text-align:right;" format="p0" showbutton="false"/></td>
								<td style="width:140px"><input name="csReveForecast.actmasum2" readonly="readonly" id="actmasum2" style="width:120px" class="nui-spinner" changeOnMousewheel="false" inputStyle="text-align:right;" format="n2" showbutton="false" minValue="-100000000" maxValue="100000000"/></td>
							</tr>
							<tr>
								<td align="right" style="width:120px">总金额：</td>
								<td style="width:120px" name="csReveForecast.fcsum" id="fcsum" /></td>
								<td style="width:140px"><input name="csReveForecast.actsum" id="actsum" readonly="readonly" class="nui-spinner" changeOnMousewheel="false" style="width:120px" inputStyle="text-align:right;" format="n2" showbutton="false" minValue="-100000000" maxValue="100000000"/></td>
								<td style="width:140px"></td> 
								<td style="width:140px"><input name="csReveForecast.actsum2" id="actsum2" readonly="readonly" style="width:120px" class="nui-spinner" changeOnMousewheel="false" onblur="countprofit" inputStyle="text-align:right;" format="n2" showbutton="false" minValue="-100000000" maxValue="100000000"/></td>
							</tr>
						</table>
					</fieldset>
					<table style="table-layout:fixed;">
						<tr>
							<td align="right" style="width:200px">收入确认相关说明：</td>
							<td><input name="csReveForecast.memo" id="memo" readonly="readonly" class="nui-textarea" style="width:560px"/></td>
						</tr>
					</table>
			</div>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div id="allSuccess" name="allSuccess" style="font-size: 16px"class="nui-checkbox"><span style="color: red;">所有外部证据已归档。</span></div>
			<div style="width:100%;">
	...
	<!-- <fieldset id="field3" style="border:solid 1px #aaa;padding:3px;">
		...
		<table id="project" style="display:none;">
			<tr>
	...
	<div id="form_purChaseYesOrNo" style="display: none">
		<table style="table-layout:fixed;">
			<tr>
...
<script type="text/javascript">
    ...
    function onOk(e) {
    	...
    	if(nui.get("auditstatus").getValue()==1){		//审核意见为通过
	    	if(nui.get("allSuccess").getValue()!= "true"){
	    		alert("请确认并勾选外部证据已归档的选项后提交。");
	    		return;
	    	}
    	}
    	if(confirm("确认提交？")){
