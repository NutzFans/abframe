			...
			<div style="padding:5px;">
				...
				<table style="table-layout:fixed;">
					...
					<tr>
						...
						<td align="right" style="width:180px">实际确认服务额：</td>
						...
						<td align="right" style="width:180px">实际确认MA额：</td>
					...
					<tr>
						<td align="right" style="width:180px">实际确认金额：</td>	
						...
						<td align="right" style="width:180px">确认日期：</td>
						...
						<td align="right" style="width:180px">实际收入确认证据：</td>
					...
					<tr>
						<td align="right" style="width:180px">收入确认相关说明：</td>
	...
	function loadData(){
		...
		nui.ajax({
			...
			success:function (o){
	            ...
	            //nui.get("isCLoseProject").disable();
