...
<!-- 
  - Author(s): 朱勇伦
  - Date: 2016-12-20 14:55:15
  - Description:
-->
<head>
	<title>重新发起合同收款开票流程</title>
	...
	<div class="nui-fit">
		...
		<form id="form_cont" method="post">
	        ...
	        <fieldset style="border:solid 1px #aaa;padding:3px;display: none;width: 100%;" id="kpcpxxxx">
	            ...
	            <div style="width: 600px;height: 25px;margin-left: 155px;float:left;">
					<table style="table-layout:fixed;font-weight: bold;" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td align="right" style="width: 180px;"></td>
							<!-- 产品金额 -->
							<td id="prodmonTotal" style="width: 140px;" align="right" ></td>
							<!-- 开票单价 -->
							<td id="prodPriceTotal" style="width: 0px;display: none;" align="right" ></td>
							<!-- 开票数量 -->
							<td id="prodNumTotal" style="width: 200px;" align="right" ></td>
	        ...
	        <fieldset style="border:solid 1px #aaa;padding:3px;display: none;width: 100%;" id="kpfwxxxx">
	            ...
	            <div style="width: 530px;height: 25px;margin-left: 216px;float:left;">
					<table style="table-layout:fixed;font-weight: bold;" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<!-- 服务金额 -->
							<td id="servMonTotal" style="width: 100px;" align="left" ></td>
							<td align="right" style="width: 100px;"></td>
							<!-- 开票单价 -->
							<td id="servPriceTotal" style="width: 100px;display: none;" align="right" ></td>
							<!-- 开票数量 -->
							<td id="servNumTotal" style="width: 96px;" align="right" ></td>
				...
				<div style="padding:5px;">
					...
					<table style="table-layout:fixed;" id="table_file">
						...
						<tr>
							...
							<td align="right" style="width:100px" colspan="3">开票单位：</td>
							<td>
