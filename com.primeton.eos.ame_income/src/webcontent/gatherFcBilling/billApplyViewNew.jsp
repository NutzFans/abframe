		            ...
		            <table style="width:100%;">
		                <tr>
		                    <td style="width:100%;">
		                    	...
		                    	<a class="nui-button" onclick="saveTicks()" iconCls="icon-save" style="width:95px;margin-right:20px;" id="saveButton">保存发票</a>	
	                    	</td>
		                </tr>
		            </table>           
		        </div>
...
<div style="text-align:center;padding:0px;border-width:1px 0px 0px 0px;" class="nui-toolbar" id="temp11" style="display:">
    ...
    <a class="nui-button" onclick="onCancel" style="width:60px;;margin-right:20px;">关闭</a>
    <a class="nui-button"  id="delete" onclick="deletes()" style="width:80px;">开票作废</a>
</div>
...
<script type="text/javascript">
    ...
    //打印页面
    function doPrint(){
		var url = "/default/ame_income/gatherFcBilling/printFcBilling.jsp?billid=" + billid;
		window.open(url);
    }
