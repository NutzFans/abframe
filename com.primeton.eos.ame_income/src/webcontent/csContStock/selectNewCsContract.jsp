...
<!-- 
  - Author(s): mengyy
  - Date: 2019-02-18 16:57:45
  - Description:
-->
<head>
<title>查询合同综合信息</title>
...
<body> 
  <div class="nui-toolbar" style="text-align:center;line-height:30px;" borderStyle="border:0;">
    <div id="form1">
  	...
  	<div class="nui-fit">
    	<div id="datagrid1" class="nui-datagrid" style="width:100%;height:100%;" idField="custid" onrowdblclick="onRowDblClick" url="com.primeton.mis.newcont.newCont.queryContract.biz.ext" dataField="contracts" 
