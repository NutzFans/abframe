...
<body> 
  <div class="nui-toolbar" style="text-align:center;line-height:30px;" borderStyle="border:0;">
    <div id="form1">
      	...
      	<table style="width:100%;" class="table">
        	<tr>
	          	...
	          	<td align="left">
            		...
            		<input class="nui-textbox" name="criteria._ref[0]._expr[0]._value" id="dyassetnum1" style="width:150px;" />
  	...
  	<div class="nui-fit">
    	<div id="datagrid1" class="nui-datagrid" style="width:100%;height:100%;" idField="custid" onrowdblclick="onRowDblClick" url="com.primeton.eos.ame_income.csReveForecast.selectCsContract.biz.ext" dataField="contracts" sizeList=[5,10,20,50,100] multiSelect="false" pageSize="10"   >
      		<div property="columns" >
		        ...
		        <div field="misCustinfo.custname" width="150" dateFormat="yyyy-MM-dd" headerAlign="center" allowSort="true">签署单位</div>
		        <div field="contsum" dataType="currency" summaryType="sum" currencyUnit="￥" align="right" width="80" headerAlign="center" allowSort="true">总金额（元）</div>
	         	<div field="confirmMoney" dataType="currency" summaryType="sum" currencyUnit="￥" align="right" width="90" headerAlign="center" allowSort="true">已确认收入（元）</div>
  ...
  <script type="text/javascript">
	...
	//importPLData下addData 页面需要用
	var salename = '<%=request.getParameter("salename") %>';
	if(salename=='null' || salename=='undefined'){
		
	}else{
		nui.getbyName("criteria._expr[2].salename").setValue(salename);
	}
