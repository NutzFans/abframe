...
<div class="nui-fit">
	            ...
	            <legend>合同收入记录详细信息</legend>
	            	<table style="table-layout:fixed;" id="table_file">
							...
							<tr id="setyearmonth" style="display: none;">
								...
								<td align="right" style="width:150px">本次结算工作量：</td>
								<td id="labormonth" style="width:250px" ></td>
							</tr>
							<tr>
								<td align="right" style="width:150px">实际应收开始日期：</td>
								<td colspan="5" id="maconfirmdayStart"></td>
							</tr>
							<tr>
								<td align="right" style="width:150px">说明：</td>
								<td colspan="5"><input id="memo" class="nui-textarea" readonly="readonly" height="100px" style="width:900px"/></td>
							</tr>
	            	</table>
        ...
        <fieldset style="border:solid 1px #aaa;padding:3px;" id="feildchange">
            <legend>合同产品分成记录</legend>
            <div id="product_reve_grid" class="nui-datagrid" style="width:100%;height:auto;" dataField="productReves" ondrawsummarycell="drawProdReveSum" showSummaryRow="true" 
		            ...
		            <div property="columns">
		                ...
		                <div field="prodtypename1" width="120" headerAlign="center" align="center">产品分类</div>
		                <div field="prodrevetype" width="80" headerAlign="center" align="center" renderer="getReveProdtype">产品分类</div>
		                ...
		                <div field="pratio" dataType="currency" width="80" align="right" headerAlign="center">分成比例</div>
	...
	<div style="text-align:center;padding:10px;border-width:1px 0px 0px 0px;" id="temp1" class="nui-toolbar">
		<a class="nui-button" onclick="doViewProc(0)" id="viewProc" style="width:120px;">收入确认流程图</a>
		<a class="nui-button" onclick="doViewProc(1)" id="viewProc1" style="width:160px;">已确认收入成本作业流程图</a>
	        ...
	        function setData(reveid){ 
	        	...
	        	nui.ajax({
		            ...
		            success: function (o) {
						...
						document.getElementById("confirmday").innerHTML = o.csReveForecast.maconfirmday == null ?"":o.csReveForecast.maconfirmday;
						document.getElementById("maconfirmdayStart").innerHTML = o.csReveForecast.maconfirmdayStart == null ?"":o.csReveForecast.maconfirmdayStart;
						...
						nui.get("memo").setValue(o.csReveForecast.memo == null ?"":o.csReveForecast.memo);
						...
						product_reve_grid.load({"contnum": o.csReveForecast.contnum,"reveid":o.csReveForecast.reveid},function(e){
						});
		            }
		     });
		}		
