...
<body>
	 	...
	 	<legend><span id="titletext" style="font-size: 12px;">部门合同收入确认明细信息</span></legend>
	        ...
	        <div id="datagrid1" class="nui-datagrid" style="width:100%;height: auto;" allowResize="true" dataField="objs" 
				...
				<div property="columns">
					...
					<div field="maconfirmday" width="80" align="center" dateFormat="yyyy-MM-dd" headerAlign="center" >实际确认日期</div>
	...
	<script type="text/javascript">
		...
		//最大月份
		var monthmax = getUrlParam("monthmax");
		//年度
		...
		function onGenderStatus(e) {
	    	...
	    	if(e.value == "3" || e.value == "7" || e.value == "8"){
				return "已确认";
			}else if (e.value == "0" || e.value  == "6"){
				return "未确认";
			}else{
				return "确认流程中";
			}
        ...
        function exportIncomeDetail(){
            ...
            function (action) {            
                if (action == "ok") {
					...
					nui.ajax({
		    			url: "com.primeton.eos.ame_income.csContract.exportCsContractRecognisedIncomeDetailManage.biz.ext",
				        type: "post",
				        data: json,
				        cache: false,
