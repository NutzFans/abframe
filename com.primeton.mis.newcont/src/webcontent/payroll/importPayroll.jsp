...
<body>
	<fieldset id="importPayroll">
		<legend>薪资福利导入</legend>
		<form id="form2" class="" action="com.primeton.mis.newcont.importPayroll.flow" target="hidden_frame" method="post" enctype="multipart/form-data">
            ...
            <table style="width:100%;">
                ...
                <tr>
			        ...
			        <td style="width:12%x;" colspan="4">
			        	<div style="color: red;">上传用的 Excel 文件版本为 97-2007版本，即 .xlsx 为后缀的版本，数据全部放在第一个工作表内，数据要从第四行开始填写。</div>
			       	</td>
		        </tr>
		        <tr>
		        	<td style="width:13%;"colspan="5"><a href="<%=request.getContextPath() %>/amepayrollTemplate.xlsx">点击下载Excel 模板文件</a></td>
		        </tr>
            </table>           
        </div>
        </form>
