	    ...
	    <div id="processDetailTab" title="<%=I18nUtil.getMessage(request, "bps.wfclient.process.ProcDetail") %>">
			<div id ="form" style="height:100%">
	        	<table id="processDetail" class="nui-form-table" style="width:100%">           
	           		<tr>
		                ...
		                <td><input id="processDefID" name="processDefID" class="nui-textbox asLabel" readOnly="true" style="width:300px"/></td>
	            	</tr>
	            	<tr>
          ...
          {id:'3',text:'<%=I18nUtil.getMessage(request, "bps.wfclient.bizdict.Published") %>'}]"
	            	...
	            	<tr>
		                ...
		                <td><input id="processDefName" name="processDefName" class="nui-textbox asLabel" readOnly="true" style="width:300px"/></td>
	            	</tr>
	            	<tr>
		                <td style="text-align:right"><%=I18nUtil.getMessage(request, "bps.wfclient.process.CreationTime") %>:</td>
		                <td><input id="createTime" formatter="yyyy-MM-dd HH:mm:ss" name="createTime" class="nui-textbox asLabel" readOnly="true" style="width:300px"/></td>
	            	</tr>
	            	<tr>
		                <td style="text-align:right"><%=I18nUtil.getMessage(request, "bps.wfclient.process.UpdateTime") %>:</td>
		                <td><input id="updateTime" name="updateTime" class="nui-textbox asLabel" readOnly="true" style="width:300px"/></td>
	            	</tr>
	            	<tr>
		                <td style="text-align:right"><%=I18nUtil.getMessage(request, "bps.wfclient.process.VersionNumber") %>:</td>
		                <td><input id="versionSign" name="versionSign" class="nui-textbox asLabel" readOnly="true" style="width:300px"/></td>
	            	</tr>
	            	<tr>
		                <td style="text-align:right"><%=I18nUtil.getMessage(request, "bps.wfclient.process.VersionDescription") %>:</td>
		                <td><input id="versionDesc" name="versionDesc" class="nui-textbox asLabel" readOnly="true" style="width:400px"/></td>
	            	</tr>
	            	<tr>
		                <td style="text-align:right"><%=I18nUtil.getMessage(request, "bps.wfclient.process.PackageName") %>:</td>
		                <td><input id="packageName" name="packageName" class="nui-textbox asLabel" readOnly="true" style="width:300px"/></td>
	            	</tr>
	            </table>
            </div>
	    </div>
