...
<workflowProcess productVersion="6.1" schemaVersion="6.0">
  <processHeader>
    <processBasicInfo>
      <processId>com.primeton.rdmgr.project.projectCreateApplication</processId>
      <processName>项目创建申请流程</processName>
    ...
    <dataFields>
      <dataField>
        ...
        <description>是否新客户，默认0不是新客户</description>
  ...
  <transitions>
    ...
    <transition>
      ...
      <complexCondition>
        ...
        <scriptValue>isNewCust.equals(&quot;1&quot;)</scriptValue>
      </complexCondition>
      <bendPoints/>
    </transition>
    <transition>
  ...
  <activities>
    ...
    <activity>
      ...
      <activityName>项目创建申请</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <customURL>
            ...
            <urlInfo>/project/projectCreateApply/projectEdit.jsp</urlInfo>
    ...
    <activity>
      ...
      <activityName>项目创建申请信息审核</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <customURL>
            <isSpecifyURL>true</isSpecifyURL>
            <urlInfo>/project/projectCreateApply/projectPMOCheck.jsp</urlInfo>
            <urlType>webpage</urlType>
          </customURL>
          <resetUrl>
            <isSpecifyURL>false</isSpecifyURL>
    ...
    <activity>
      ...
      <activityName>发送通知邮件微信</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
        ...
        <autoActivity>
          ...
          <taskApplication>
            <applicationInfo>
              ...
              <application>
                <actionType>logic-flow</actionType>
                <applicationUri>com.primeton.rdmgr.project.createApplication.projectAutoEmail</applicationUri>
                <transactionType>join</transactionType>
    ...
    <activity>
      ...
      <activityName>新客户商务审核</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <customURL>
            <isSpecifyURL>true</isSpecifyURL>
            <urlInfo>/project/projectCreateApply/BunissNewCustCheck.jsp</urlInfo>
            <urlType>webpage</urlType>
          </customURL>
          <resetUrl>
            <isSpecifyURL>false</isSpecifyURL>
  ...
  <notes>
    <note>
      <content>项目创建申请流程，申请成功后发送邮件</content>
      <title>温阳阳	16-7-15 上午10:36</title>
      <location>
        <x>87</x>
        <y>285</y>
      </location>
