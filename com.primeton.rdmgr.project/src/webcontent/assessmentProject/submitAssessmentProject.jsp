		       ...
		       <legend>预算情况</legend>
					<table style="table-layout:fixed;" id="a2">
						...
						<tr>
							...
							<td id="buddeviate" class="asLabel" style="width:150px"></td>
						</tr>
					</table>
		     </fieldset>
	     	...
	     	<legend>项目考核模拟</legend>
				...
				<input class="nui-hidden" id="managerrate"/>
		     	<table style="table-layout:fixed;" id="a4">
					...
					<tr>
						<td align="right" style="width:150px;">考核时实际服务成本：</td>
						<td>
   ...
   <input type="hidden" name="fileName" filter="false"/>
	...
	<script type="text/javascript">
		...
		function init(){
			...
			nui.ajax({
				...
				success: function (o){
                    ...
                    document.getElementById("projgrossrate").innerHTML = projcheck.projgrossrate == null? "":formatNumber(projcheck.projgrossrate);
        ...
        function selectProjectCheck(){
        	var btnEdit = this;
            nui.open({
                url:"<%=request.getContextPath() %>/project/assessmentProject/selectProjectCheck.jsp",
                title: "选择考核项目",
                width: 850,
                height: 460,
		...
		function SaveData(){
			...
			var json = nui.encode({"rdprojcheck":rdprojcheck,"misOpinion": data_opioion.misOpinion,"projcheck":projcheck});
			 nui.ajax({
                url: "com.primeton.rdmgr.project.assessmentProject.submitAssessmentProject.biz.ext",
                data: json,
                type: 'POST',
                cache: false,
                contentType: 'text/json',
