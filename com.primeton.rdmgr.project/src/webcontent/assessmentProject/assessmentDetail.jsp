...
<body>
<div class="nui-fit">
    <div class="mini-panel" title="项目考核分配详情" style="width: auto">
...
<form name="viewlist1" id="viewlist1" action="com.primeton.eos.ame_common.ameExportCommon.flow" method="post">
	...
	<script type="text/javascript">
		...
		function init(){
			...
			nui.ajax({
				url: "com.primeton.rdmgr.project.assessmentProject.getProjcheckDetail.biz.ext",
				type: "post",
				data: json,
				...
				success: function (o){
					...
					if(projcheck.labordiffcost){
						document.getElementById("budgetactcost").innerHTML = formatNumber(parseFloat(projcheck.budgetcost)+parseFloat(projcheck.labordiffcost));
