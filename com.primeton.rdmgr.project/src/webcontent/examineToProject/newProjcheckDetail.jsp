		       ...
		       <legend>预算情况</legend>
					<table style="table-layout:fixed;" id="a2">
						...
						<tr>
							...
							<td align="right" style="width:150px;">已确认成本：</td>
							<td id="assessmentcost" class="asLabel" style="width:150px"></td>
							<td align="right" style="width:150px;">预计后续成本：</td>
							<td style="width:150px" id="followupcost" class="asLabel"></td>
						</tr>
						<tr>
							...
							<td style="width:150px" id="buddeviate" class="asLabel"></td>
						</tr>
					</table>
		     </fieldset>
		       ...
		       <legend>项目考核分配</legend>
		       		<table style="table-layout:fixed;" id="a3">
		       			<tr>
							...
							<td align="right" style="width:150px;">项目总成本：</td>
							<td id="assessmentcost1" class="asLabel" style="width:150px"></td>
							<td align="right" style="width:150px;">奖金发放年月：</td>
							<td colspan="5" class="asLabel" id="costyearmonth"></td>
						</tr>
						<tr>
						...
						<div title="项目组内分配方案">
			     			<div id="projEmp" class="nui-datagrid" style="width:100%;height:auto;" allowCellEdit="true" allowCellSelect="true" editNextOnEnterKey="true"
							    ...
							    <div property="columns">
							        ...
							        <div field="workdays" width="50" align="right" headerAlign="center" allowSort="true" summaryType="sum">人天数</div>
							        ...
							        <div field="sum" width="40" align="right" headerAlign="center" summaryType="sum" numberFormat="n2" allowSort="true">奖金</div>
...
<form name="viewlist1" id="viewlist1" action="com.primeton.eos.ame_common.ameExportCommon.flow" method="post">
	...
	<script type="text/javascript">
		...
		function init(){
			...
			nui.ajax({
				url: "com.primeton.rdmgr.project.examineToProject.getProjcheckDetail.biz.ext",
				type: "post",
				data: json,
				...
				success: function (o){
                    ...
                    document.getElementById("buddeviate").innerHTML = projcheck.buddeviate == null? "":formatNumber(projcheck.buddeviate);
					...
					document.getElementById("followupcost").innerHTML = projcheck.followupcost == null? "":projcheck.followupcost;
					...
					if(projcheck.costyearmonth){
						document.getElementById("costyearmonth").innerHTML = projcheck.costyearmonth;
					}
					
	            	//查询审核意见
					var grid = nui.get("datagrid1");
					var grid2 = nui.get("datagrid2");
					if(projcheck.processinstid1!=null||projcheck.processinstid!=""){
						grid.sortBy("time", "desc");
						grid.load({processInstID: projcheck.processinstid1},function(){
							grid2.sortBy("time", "desc");
							grid2.load({processInstID: projcheck.processinstid},function(){
								form.unmask();
							});
						});
					}
