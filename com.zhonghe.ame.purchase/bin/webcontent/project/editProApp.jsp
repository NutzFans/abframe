					...
					<div style="padding: 5px;">
						<table style="table-layout: fixed;">
							<tr>
								...
								<td  >
									<input name="proAppAgentUserid" id="proAppAgentUserid"  emptyText="请选择" class="nui-buttonedit" 
										onbuttonclick="selectOmEmployee" style="width: 170px" allowInput="false" />
								</td>
	...
	<script type="text/javascript">
       <% long workItemID=(Long)request.getAttribute("workItemID");%>
    	...
    	function onOk(e){
    		...
    		var grid_1 = nui.get("grid_1").getData();
