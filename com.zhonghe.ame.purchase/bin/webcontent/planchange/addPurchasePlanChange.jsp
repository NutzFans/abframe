		...
		<fieldset id="field1" style="border: solid 1px #aaa;padding: 3px;width: 99%;">
        	...
        	<tr>
                ...
                <td colspan="1">
	                ...
	                <input id="needOrgId" name="needOrgId" class="nui-hidden" required="true" style="width:100%;" value="<%=userOrgId %>"/>
             ...
             <tr>
          	...
          	<tr>
	            ...
	            <td colspan="7" style="color: red">
	              		在经管系统编辑计划做好物项的归类，选择采购物项时选择物项大类即可，细分项填写到备注框里，可以保留实际采购的灵活性
	            </td>
	        </tr>
          	<tr>
 ...
 <a class="nui-button" id="addbtn" iconCls="icon-add" onclick="addTicket()">增加</a> 
    	...
    	<div id="grid_traveldetail" class="nui-datagrid" style="width: 100%;height: auto;" allowCellSelect="true" 
           ...
           <div property="columns">
                ...
                <div field=purchaseFirstName width="100" align="center" headerAlign="center"  >物项大类名称 
                ...
                <div  field="purchaseTwoName" width="110" align="center" headerAlign="center" renderer="onViewL" >物项中类名称 
                	<input  property="editor"  name="purchaseTwoName" class="nui-textbox"   readOnly="true"  vtype="maxLength:100" />
                </div> 
                <div field="purchaseThreeCode" id="purchaseThreeCode" width="110" align="center" headerAlign="center"  readOnly="true"  visible="false">物项小类编码
							<input  property="editor"  name="purchaseThreeCode" class="nui-textbox" enabled="false" />
                </div>
                <div field="purchaseThreeName"  width="110" align="center" headerAlign="center"  readOnly="true" >物项小类名称 
	            ...
	            <div  field="number" width="100"  align="center" headerAlign="center"  vtype="required" headerStyle="color:red">数量
					<input id="number" name="number" property="editor"  class="nui-textbox"/>
	            </div>
                ...
                <div field="keyIssus"  width="100" align="center" headerAlign="center"  renderer="onYn" headerStyle="color:red">是否关键事项
                	<input property="editor"  class="nui-dictcombobox" name="keyIssus"  dictTypeId="MIS_YN" required="true"  style="width:100%;"/>
                </div>
                <div field="isProject"  width="130" align="center" headerAlign="center" value="1" renderer="onYn" headerStyle="color:red">是否工程建设下项目采购
	    ...
	    nui.get("year").setData(yeariterm);
	   	...
	   	function onOk(e){
			...
			if(type!=3){
				var putunder = nui.get("putunder").value;
					if(putunder==null || putunder==''){
						showTips("公司本部职能部分发起采购计划变更时归口部门不能够为空");
						return;
					}
				}
			if(!confirm("是否"+title+"单据？")){
    			...
    			ajaxCommon({
					"url": "com.zhonghe.ame.purchase.planchange.addPurPlanChange.biz.ext",
					"data": json,
					"success": function(data) {
						if(data.result==1){
							showTips(title+"采购计划变更成功");
							closeOk();
						}else{
