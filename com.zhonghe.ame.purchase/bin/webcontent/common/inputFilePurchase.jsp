...
<div>
  <div class="nui-toolbar" id="filedetail" style="border-bottom:0;padding:0px;">
	...
	<fieldset id="field" style="border:solid 1px #aaa;padding:3px;">
<!-- 		<legend>添加附件</legend> -->
		<form id="fileForm" class="" action="com.primeton.eos.ame_common.ame_fileupload.flow" target="hidden_frame" method="post" enctype="multipart/form-data">
			<!--附件存放目录-->
