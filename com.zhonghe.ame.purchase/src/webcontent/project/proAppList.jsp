...
<script type="text/javascript">
    	...
    	function init(){
			...
			var json = {"code":"cglx","map":{"property":"status","op":"=","value":"running"}};
    		nui.ajax({
	...
	debugger
		...
		exportExcel({"data":data,"url": "com.zhonghe.ame.purchase.exportExcel.exportaProApp.biz.ext","fileName":"采购立项表"})
	}
