...
<body>
	<div class="nui-fit">
		<div class="mini-panel" title="" style="width: 100%;">
			<fieldset id="field1" style="border: solid 1px #aaa;padding: 0px;width: 100%;">
				<legend>采购立项</legend>
							...
							<tr>
								...
								<td  >
									<input name="proAppAgentUserid" id="proAppAgentUserid"  class="nui-buttonedit" 
										onbuttonclick="selectOmEmployee" style="width: 100%" emptyText="请选择" allowInput="false" />
								</td>
							<!-- <td align="right" style="width:160px">立项编号：</td>
								<td><input name="proAppCode"  class="nui-textbox" style="width: 100%" required="true"/></td> -->
		     ...
		     <a href="<%=request.getContextPath() %>/purProgramMoneyTable.docx" download="采购立项费用估算表">采购立项费用估算表下载</a>
			    	<div id="grid_detail" class="nui-datagrid" style="width: 100%;height: auto;" allowCellSelect="true" 
			           ...
			           <div property="columns">
			           		...
			           		<div  field="name" width="110" align="center" headerAlign="center" >计划名称</div>
