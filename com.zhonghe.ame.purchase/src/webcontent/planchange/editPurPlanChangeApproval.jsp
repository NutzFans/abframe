...
<div class="nui-fit" >
		<fieldset id="field1" style="border: solid 1px #aaa;padding: 3px;width: 99%;">
        	...
        	<tr>
                ...
                <td >
                    <input id="putunder" name="putunder" class="nui-dictcombobox"  dictTypeId="ZH_PUTUNDER"   style="width:100%;"/>
                </td>
             </tr>
             <tr>
 ...
 <div class="fieldset-body"  style="width:100%; margin: 0px auto">
    	...
    	<div id="grid_traveldetail" class="nui-datagrid" style="width: 100%;height: auto;" allowCellSelect="true"  allowCellwrap="true"
    	 	showPager="false" allowCellEdit="true" multiSelect="true" oncellendedit="getHTZQ" onshowrowdetail="onShowRowDetail">
           <div property="columns">
                ...
                <div  field="purchaseTwoName" width="160" align="center" headerAlign="center" >物项中类名称 
                ...
                <div field="unit"  width="50" align="center" headerAlign="center" renderer="unitValue">单位
                ...
                <div field="projectname"  width="100" align="center" headerAlign="center"  visible="false">所属项目名称
...
<script type="text/javascript">
	   ...
	   function loadData(){
			...
			ajaxCommon({
				"url": "com.zhonghe.ame.purchase.planchange.getPurPlanChangeByWorkitemId.biz.ext",
				"data": json,
				"success": function(o) {
					//付款申请基本信息
					form.setData(o.data)
