...
<body>
	...
	<div class="nui-fit" style="padding: 5px;">
		...
		<fieldset style="border: solid 1px #aaa;">
			...
			<div id="grid_traveldetail" class="nui-datagrid" style="width: 95%; height: auto;" allowCellSelect="true" allowCellwrap="true" showPager="false" allowCellEdit="true" multiSelect="true"
				...
				<div property="columns">
					...
					<div header="调整后" headerAlign="center">
						<div property="columns">
							<div field="onePrice" width="70" align="center" headerAlign="center" vtype="required" headerStyle="color:red">
								单价(万元)
							...
							<div field="newBudgetAmount" width="70" align="center" headerAlign="center" vtype="required" headerStyle="color:red">
								预算金额(万元)
					...
					<div field="remark" width="100" align="center" headerAlign="center" vtype="required" headerStyle="color:red">
						调整原因
		...
		function isChangeExcess() {
			...
			if (budgetAmount != null && newBudgetAmount != null) {
				...
				if (purType == 1) {
					if (excess >= 5) {
						isExcess = true;
					} else if (ratio >= 0.2 && excess > 2) {
						isExcess = true;
					}
				} else {
					if (excess >= 10) {
						isExcess = true;
					} else if (ratio >= 0.1 && excess > 2) {
						isExcess = true;
					}
				}
			}
