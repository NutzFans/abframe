...
<div class="nui-fit">
    <div>
		    	...
		    	<div id="grid_traveldetail" class="nui-datagrid" style="width: 100%;height: auto;" allowCellSelect="true" allowCellwrap="true"
		           ...
		           <div property="columns">
		               ...
		               <div header="调整后" headerAlign="center">
		                    ...
		                    <div field="newUnit"  width="40" align="center" headerAlign="center" renderer="unitValue"><span style="color:red;">单位</span></div> 
				                <div field="newNumber"  width="40" align="center" headerAlign="center"><span style="color:red;">数量</span></div>
				                <div field="newBudgetAmount"  width="70" align="center" headerAlign="center" ><span style="color:red;">预算金额(万元)</span></span></div>
			                </div>
			            </div>
		...
		<fieldset id="field2" style="border:solid 1px #aaa;padding:1px;width: 97%">
