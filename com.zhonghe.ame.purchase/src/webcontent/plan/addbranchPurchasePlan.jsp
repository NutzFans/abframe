			...
			<fieldset id="field1" style="border: solid 1px #aaa;padding: 3px;width: 99%;">
                ...
                <tr id="one22">
              	...
              	<tr>
                    ...
                    <td  colspan="7">    
                        <input style="width:100%;height:70px;" name="remark" class="nui-textarea" id="remark" required="true"/>
                    </td>
              	</tr>
            </table>
        </div>
...
<script type="text/javascript">
	    ...
	    var threeItemName = nui.get("threeItemName");
	   	...
	   	function loadItem(){
	   		...
	   		if(purchaseType==""||putunder==""){
	   			return ;
	   		}else{
	   			
	   			grid_traveldetail.load({"purType":purchaseType,"orgId":putunder});
    	  ...
    	  function getHTZQ(e){
	   	...
	   	function typeChange(e){
	   		...
	   		if(e.value==2){
	    		...
	    		document.getElementById("one11").style.display="none";
	    		document.getElementById("one111").style.display="none";
	    		/* nui.get("firstItemName").setReadOnly("true");
	   			nui.get("secondItemName").setReadOnly("true"); */
	   		}else if(e.value==1){
	          ...
	          /*   nui.get("firstItemName").setReadOnly("true");
	    		...
	    		document.getElementById("one111").style.display="none";
	   			...
	   			/* nui.get("firstItemName").setReadOnly("false");
	   			nui.get("secondItemName").setReadOnly("false"); */
