				...
				<table style="table-layout: fixed;" id="table_file">
	            	...
	            	<tr>
	                 ...
	                 <tr>
	                    ...
	                    <td  colspan="7">    
	                        <input style="width:100%;height:50px;" id="items" type="checkbox" class="nui-textarea" readonly="readonly"/>
	                    </td>
	              	</tr>
	              	<tr>
     ...
     <a class="nui-button" id="addbtn" iconCls="icon-add" onclick="addTicket()">增加</a> 
	    	...
	    	<div id="grid_traveldetail" class="nui-datagrid" style="width: 100%;height: auto;" allowCellSelect="true" 
	           ...
	           <div property="columns">
	                ...
	                <div field="purchaseThreeName"  width="100" align="center" headerAlign="center"  readOnly="true" >物项小类名称 
	                ...
	                <div field="isProject"  width="120" align="center" headerAlign="center" value="1" renderer="onYn" headerStyle="color:red">是否工程建设下项目采购
