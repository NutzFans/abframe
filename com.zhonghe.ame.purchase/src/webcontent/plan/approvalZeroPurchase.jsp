	...
	<div class="nui-fit" style="padding: 5px;">
		...
		<fieldset id="field3" style="border: solid 1px #aaa;">
			...
			<div class="fieldset-body" style="width: 100%; height: 100%; margin: 0px auto">
				<div id="grid_traveldetail" class="nui-datagrid" style="width: 80%; height: auto;" allowCellSelect="true" showPager="false" allowCellEdit="false" multiSelect="true" dataField="purZeroItem"
