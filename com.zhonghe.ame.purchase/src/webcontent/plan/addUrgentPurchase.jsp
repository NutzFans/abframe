		...
		<div class="mini-panel" title="" style="width: 100%;">
			...
			<fieldset style="height: 100%; border: solid 1px #aaa; padding: 3px; width: 99%;">
				<div class="fieldset-body" style="width: 100%; height: 100%; margin: 0px auto">
					...
					<div id="grid_traveldetail" class="nui-datagrid" style="width: 99%; height: auto;" allowCellSelect="true" showPager="false" allowCellEdit="true" multiSelect="true" oncellendedit="changeValueon">
						<div property="columns">
							<div field="" width="30px" headerAlign="center" align="center" allowSort="true" renderer="buttonRenderConclude" headerStyle="color:red">请选择</div>
							<div field="purchaseFirstCode" width="110px" align="center" headerAlign="center" visible="false">采购物项大类编码</div>
							<div field="purchaseFirstId" width="110px" align="center" headerAlign="center" visible="false">采购物项大类主键ID</div>
							<div field="firstItemName" width="110px" align="center" headerAlign="center">采购物项大类名称</div>
							<div field="purchaseTwoCode" width="110px" align="center" headerAlign="center" visible="false">采购物项中类编码</div>
							<div field="purchaseTwoId" width="110px" align="center" headerAlign="center" visible="false">采购物项中类主键ID</div>
							<div field="secondItemName" width="110px" align="center" headerAlign="center" renderer="onViewL">采购物项中类名称</div>
							<div field="purchaseThreeCode" width="110px" align="center" headerAlign="center" visible="false">采购物项小类编码</div>
							<div field="purchaseThreeId" width="110px" align="center" headerAlign="center" visible="false">采购物项小类主键ID</div>
							<div field="threeItemName" width="110px" align="center" headerAlign="center" renderer="onViewL">采购物项小类名称</div>
							<div field="brandSpec" align="center" headerAlign="center">
								规格
								<input id="brandSpec" name="brandSpec" property="editor" class="nui-textbox" width="100%" />
							</div>
							<div field="onePrice" align="center" headerAlign="center" vtype="required" headerStyle="color:red">
								单价(万元)
								<input id="supplierName" name="supplierName" property="editor" class="nui-textbox" width="100%" />
							</div>
							<div field="number" align="center" headerAlign="center" vtype="required" headerStyle="color:red">
								数量
	...
	<script type="text/javascript">
		...
		function buttonRenderConclude(e) {
			...
			s = '<a class="conclude_edit_button  mini-button control_buttons"  data-tooltip="新增" data-placement="top" onclick="onButtonEdit123()">'
					+ '<span class="mini-button-text  mini-button-iconOnly " >' + '<span class="mini-button-icon mini-iconfont icon-add" style="margin:3;margin-top: 12%;">'
					+ '<span class="mini-button-text"></span>' + '</span>' + '</span>' + '</ a>'
			return s;
		}
