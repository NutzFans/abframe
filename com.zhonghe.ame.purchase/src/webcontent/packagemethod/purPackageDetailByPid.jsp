...
<body>
	<div class="nui-fit">
						...
						<table style="table-layout: fixed;">
							...
							<tr>
								<td align="right" style="width: 120px">是否设招标限价：</td>
									<td colspan="1"><input class="nui-dictcombobox"
								dictTypeId="ZH_BIDSTATUS" id="isPriceLimit" name="isPriceLimit" shownullItem="true" readOnly="readOnly"
								style="width: 300px;" /> 
     ...
     <div class="fieldset-body"  style="width:100%; height:100%; margin: 0px auto">
	    		...
	    		url="com.zhonghe.ame.purchase.purchasePackage.queryPurPackageSup.biz.ext"> -->
...
<!--	<div style="text-align: center;padding: 10px;" class="nui-toolbar">
	...
	<script type="text/javascript">
        ...
        function init(){
        	...
        	nui.ajax({
		                url: "com.zhonghe.ame.purchase.purchasePackage.queryPurPackageByPid.biz.ext",
		                data: json,
		                type: 'POST',
		                success: function (o) {
		                	alert(nui.encode({"o":o}));
		               		 var result=o.purPackage;
							 ...
							 nui.get("isPriceLimit").setText(result.isPriceLimit);
