	...
	<div class="nui-fit">
					...
					<div style="padding: 5px;">
						<table style="table-layout: fixed;">
							...
							<td class="form_label" align = "right">发包编号：</td>
								<td>
									<input name="packageCode"  class="nui-textbox" style="width: 200px" emptyText="系统自动生成"  readonly="readonly"/>
								</td>
							...
							<td align="right" style="width:160px">立项编号：</td>
								<td><input name="proappId" onbuttonclick="onButtonEdit" class="nui-buttonedit" allowInput="false" style="width: 200px" emptyText="请选择"  required="true" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td align="right" style="width: 120px">是否在电采平台发布公告：</td>
									<td colspan="1"><input class="nui-dictcombobox"
								dictTypeId="ZH_BIDSTATUS"  name="isElectricMining" shownullItem="true"
								style="width: 200px;" onValueChanged="priceTypeChange" required="true" />
							...
							<tr>
								<td align="right" style="width:160px">申请日期：</td>
									...
									<td align="right" style="width: 120px">分公司职能部门经办人：</td>
									<td>
		    	...
		    	<div id="grid_traveldetail" class="nui-datagrid" style="width: 80%;height: auto;" allowCellSelect="true" 
		            ...
		            <div property="columns">
		                <div field="custname"  width="130" align="center" headerAlign="center"  >供应商名称
								<input id="custname" onbuttonclick="onButtonEdit1" allowInput="false"  class="nui-buttonedit" name="custname" property="editor" />
		                </div>
		               <div  field="isqualified" width="130" align="center" headerAlign="center" renderer="dictstatus" >是否合格供应商</div>
		                <div  field="registercap"  width="130" align="center" headerAlign="center"  >注册资金(万元)
								<!-- <input id="registercap" name="registercap" property="editor"  class="nui-textbox"  /> -->
		                </div>
		                <div  field="linkman"  width="130" align="center" headerAlign="center">联系人
								<!-- <input id="linkman" name="linkman" property="editor"  class="nui-textbox"  /> -->
		                </div>
		                <div   field="linktel" width="130" align="center" headerAlign="center" >联系电话
							<!-- 	<input id="linktel" name="linktel" property="editor"  class="nui-textbox"  /> -->
		                </div>
		            </div>
		        </div>
		...
		<tr>
	        <td class="form_label"  align="right" id="chooseSupplierReason1" style="width:600px;">选择上述供应商原因：</td>
                <td>    
                    <input style="width:72%;height: 40px;" name="chooseSupplierReason" class="nui-textarea"  id="chooseSupplierReason" dictTypeId="ZH_PURCHASE" />
                </td>
		</tr>
		</fieldset>
		</div>
    ...
    function priceTypeChange(e){
       ...
       function removeTicket(){
    	...
    	function SaveData(){
			...
			var json = nui.encode({'purchasePackage':data,'supData':supData,"judge":judge});
			if(!confirm("是否提交？")){
    				return;
			}else{	
    			ajaxCommon({
