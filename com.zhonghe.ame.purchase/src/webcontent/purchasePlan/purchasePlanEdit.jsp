		...
		<form id="form1" method="post">
			...
			<table style="table-layout: fixed; width: 100%" id="table_file">
            	...
            	<tr>
                    ...
                    <td colspan="1">    
                        <input class="nui-dictcombobox" name="type" id="type" dictTypeId="ZH_PURCHASE" required="true" readonly="readonly" onvaluechanged="changeexptype" onbeforeshowpopup="beforechanged" style="width:100%;" />
                    </td>
	            ...
	            <tr>
	                ...
	                <td  colspan="6">    
	                    <input style="width:100%;height:70px;" id="items" class="nui-textarea" readonly="readonly"/>
	                </td>
	          	</tr>
	          	<tr>
	 	...
	 	<div class="fieldset-body"  style="width:100%; height:100%; margin: 0px auto">
	    	...
	    	<div id="grid_traveldetail" class="nui-datagrid" style="width: 100%;height: auto;" allowCellSelect="true" 
	           ...
	           <div property="columns">
	           		...
	           		<div field="code" width="110" align="center" headerAlign="center">计划编号
<!-- 									<input name="code"  property="editor"  enabled="true" class="nui-textbox" readOnly="true" > -->
                ...
                <div field="materialName"  width="100" align="center" headerAlign="center" vtype="required" headerStyle="color:red">采购物项名称 
...
<!--                 	<input property="editor" class="nui-spinner" minValue="0" width="100%" maxValue="999999999" name="budgetAmount" readonly="readonly" visible="true"/> -->
                ...
                <div field="remark"  width="150" align="center" headerAlign="center"  >备注
