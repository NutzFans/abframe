		...
		<div class="mini-panel" title="" style="width: 100%;">
					...
					<div style="padding: 5px;">
						<table style="table-layout: fixed;">
							<tr>
								...
								<td>
									<input name="userId" id="userId" class="nui-buttonedit" onbuttonclick="selectOmEmployee" style="width: 100%" required="true" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<input name="totalPrice" readOnly="readOnly" id="totalPrice" class="nui-textbox" style="width: 100%" required="true" />
								</td>
							</tr>
							<tr>
			...
			<fieldset style="height: 100%; border: solid 1px #aaa; padding: 3px; width: 98%;">
				...
				<div class="fieldset-body" style="width: 100%; height: 100%; margin: 0px auto">
					...
					<div id="grid_traveldetail" class="nui-datagrid" style="width: 100%; height: auto;" allowCellSelect="true" url="com.zhonghe.ame.purchase.purchaseVerify.queryVerifyDetailTotal.biz.ext"
						dataField="purVerifyDetail" showPager="false" allowCellEdit="true" multiSelect="true" oncellendedit="changeValue">
						<div property="columns">
							<div type="indexcolumn" align="center" headerAlign="center">序号</div>
							<div field="goodsName" width="130" align="center" headerAlign="center" vtype="required;String">
								货物名称
							...
							<div field="singlePrice" width="130" align="center" headerAlign="center">
								单价(万元)
								<input id="singlePrice" name="singlePrice" property="editor" width="100%" class="nui-textbox" />
							</div>
							<div field="totalPriceDetail" width="130" align="center" headerAlign="center" renderer="doIt">
								总价(万元)
