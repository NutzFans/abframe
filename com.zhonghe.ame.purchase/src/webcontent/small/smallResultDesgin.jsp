...
<body>
	<div style="background-image: url('/default/common/flow/smallResultFlow.png'); width: 1463px; height: 1039px; position: relative;">
		...
		<!-- 企业发展部备案 -->
		<div id="div8" style="position: absolute; left: 558px; top: 700px; width: 75px; height: 50px; cursor: pointer;"></div>
		
		<!-- 反馈一体化平台录入结果 -->
		<div id="div9" style="position: absolute; left: 558px; top: 814px; width: 75px; height: 50px; cursor: pointer;"></div>		
	...
	<script type="text/javascript">
		layui.use([ 'jquery', 'layer' ], function() {
			...
			$('#div9').click(function() {
				layer.open({
					title : '反馈一体化平台录入结果 - 调整审批人',
					content : '通过【角色管理】模块修改角色编号为【cg_sm_am_fk】的角色数据',
					btn : []
				});
			});						
