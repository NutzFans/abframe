...
<body>
	<div class="nui-fit" style="padding: 5px;">
		<fieldset id="field1" style="border: solid 1px #aaa;">
			<legend>小额采购 - 结果确认审批</legend>
			<form id="form1" method="post">
				<input name="id" class="nui-hidden" />
				<input name="zeroId" class="nui-hidden" />
				...
				<div style="padding: 5px;">
					<table style="table-layout: fixed;">
						<tr>
							...
							<td colspan="2">
								<input name="purchaseCode" class="nui-textbox" style="width: 400px;" readonly="readonly" />
							</td>
						...
						<tr>
							...
							<td colspan="2">
								<input name="contractor" class="nui-textbox" style="width: 100%;" readonly="readonly" />
							</td>
							<td align="right" style="width: 140px">预计采购时间：</td>
							<td>
								<input name="purchaseDate" class="nui-datepicker" style="width: 100%" readonly="readonly" />
							</td>
						</tr>
						<tr>
							<td align="right" style="width: 140px">是否为科研项目：</td>
							<td colspan="2">
								<input name="keYanProject" class="nui-dictcombobox" dictTypeId="ZH_YN" style="width: 100%;" readonly="readonly" />
							</td>
							<td align="right" style="width: 140px">是否已有年度采购计划：</td>
							<td>
								<input name="isPlan" class="nui-dictcombobox" dictTypeId="ZH_YN" style="width: 200px" readonly="readonly" />
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="5">
								<input style="width: 100%; height: 120px;" name="applyReason" class="nui-textarea" id="remark" readonly="readonly" />
							</td>
						</tr>
					</table>
				</div>
	...
	<div style="text-align: center; position: relative; bottom: 10px" class="nui-toolbar">
		...
		<a class="nui-button" id="printBtn" iconCls="icon-print" onclick="print()" style="width: 60px; margin-right: 20px; display: none;">打印</a>
	...
	<script type="text/javascript">
		...
		function init() {
			...
			nui.ajax({
				...
				data : json,
				success : function(o) {
					var workItemInfo = o.workItemInfo;
					if(workItemInfo.workItemName=="反馈一体化平台录入结果"){
						$("#printBtn").show();
					}
					form.setData(o.smallResult);
					var grid = nui.get("datagrid1");
					grid.load({
						processInstID : o.smallResult.processId
					});
					...
					nui.get("backTo").setData(o.smallResult.backList);
					var jsonData = {
		...
		function SaveData() {
			setTimeout(function() {
				...
				ajaxCommon({
					url : "com.zhonghe.ame.purchase.small.approvalSmallResult.biz.ext",
					data : json,
		...
		function print() {
			...
			var id = formData.id;
			executeUrl = "<%=request.getContextPath()%>/purchase/small/smallResultToPrint.jsp?id=" + id;
