...
<body>
				...
				<div style="padding: 5px;">
					<table style="table-layout: fixed;">
						<tr>
							...
							<td>
								<input class="nui-textbox" name="winner" id="winner" style="width: 350px" required="true" />
							</td>
							<td align="right" style="width: 120px">中标金额（万元）：</td>
							<td>
								<input name="awardAmount" id="awardAmount" class="nui-spinner" minValue="0" maxValue="999999" style="width: 350px" required="true" />
							</td>
						</tr>
					</table>
				</div>
	...
	<script type="text/javascript">
		...
		function SaveData() {
			...
			ajaxCommon({
				url : "com.zhonghe.ame.purchase.purchaseReviewReport.updateApprovalReviewReport.biz.ext",
				data : json,
				contentType : 'text/json',
