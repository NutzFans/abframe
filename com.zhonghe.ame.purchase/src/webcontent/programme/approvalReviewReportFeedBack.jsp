...
<body>
	...
	<div style="text-align: center; position: relative; bottom: 10px" class="nui-toolbar">
		...
		<a class="nui-button" onclick="onCancel" id="saveReimbProcess" style="width: 80px; margin-right: 20px;">关闭</a>
	...
	<script type="text/javascript">
		...
		function init() {
			...
			nui.ajax({
				...
				success : function(o) {
					...
					if (o.workitem.workItemName == '发起人接收及中标反馈' || o.workitem.workItemName == '专业化集采机构接收并反馈中标通知书') {
		...
		function printBtn() {
			var url = "<%=request.getContextPath()%>/purchase/programme/reviewReportFeedBackDetail.jsp?id=" + id;
