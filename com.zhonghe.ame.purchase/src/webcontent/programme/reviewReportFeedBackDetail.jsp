		...
		<form class="layui-form layui-form-pane" lay-filter="dataFrm" id="dataFrm">
			...
			<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
				<blockquote class="layui-elem-quote" style="width: 97%">
					基本信息
					<span style="font-size: 14px; float: right; color: red;">该项目已完成定标，请专业化集采机构根据审批确定的成交供应商信息及成交价格安排成交通知书及采购结果公告发布事宜</span>
				</blockquote>
	...
	<script>
	 ...
	 layui.use([ 'jquery', 'layer', 'form', 'table'], function() {
				...
				function getData() {
					$.ajax({
						...
						success : function(data) {
							var formData = data.reviewReport[0];
		...
		function downloadZipFile() {
			...
			var relationId = id;
			var fileCatalog = 'purReviewReport';
			var json = nui.encode({
