...
<body>
	<div class="nui-panel" title="付费合同管理" style="width:100%;">
        <div  id="form1">
        <input class="nui-hidden" name="critria._entity" value="com.zhonghe.ame.purchase.common.ZhPayContractEntity"/>
		  <div class="nui-toolbar" style="border-bottom:0;padding:0px;">
		      ...
		      <tr>
		          ...
		          <td colspan="1">
			    	<input name="critria._expr[12]._value" class="nui-dictcombobox" dictTypeId="ZH_CONTRACT_TYPE" style="width:65%;" />
...
<div >
    ...
    <div id="datagrid1" frozenStartColumn="0"  sizeList="[10,20,50,100]" showPager="true" dataField="data"  sortMode="client" 
    	class="nui-datagrid" style="width:100%;height:350px;" url="com.zhonghe.ame.purchase.common.payContractAll.biz.ext" 
        ...
        <div type="indexcolumn" align="center" headerAlign="center">序号</div>
            ...
            <div field="contractSum" width="120" align="center" headerAlign="center" allowSort="true" >合同金额（元）</div>
            ...
            <div field="contractType" width="120" align="center" headerAlign="center" allowSort="true"  renderer="zhContractType">合同类型</div>
            <div field="appStatus"  align="center" headerAlign="center" allowSort="true" renderer="zhFlowType" >审批状态</div>
            <div field="startTime"  dateFormat="yyyy-MM-dd" width="80" align="center" headerAlign="center" >合同起始日期</div>
            <div field="endTime" dateFormat="yyyy-MM-dd" width="80" align="center" headerAlign="center" >合同结束日期</div>
        </div>
        </div>
		</div>
