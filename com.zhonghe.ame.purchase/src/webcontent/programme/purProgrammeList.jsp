...
<div class="nui-fit">
    <div id="datagrid1"  sizeList="[10,20,50,100]" showPager="true" dataField="purProgrammes" showSummaryRow="true"  sortMode="client"  
    	class="nui-datagrid" style="width:100%;height:100%;" url="com.zhonghe.ame.purchase.purchaseProgramme.queryPurProgramme.biz.ext" 
        ...
        <div property="columns">
        	...
        	<div field="programmeName" width="80" align="center" headerAlign="center" allowSort="true" renderer="lookInfo" >采购方案名称</div>
