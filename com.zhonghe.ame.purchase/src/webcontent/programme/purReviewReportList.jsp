...
<body>
    ...
    <div class="nui-fit">
    <div id="datagrid1"  sizeList="[10,20,50,100]" showPager="true" dataField="reviewReport" multiSelect="false" 
    	class="nui-datagrid" style="width:100%;height:100%;" url="com.zhonghe.ame.purchase.purchaseReviewReport.queryReviewReport.biz.ext"> 
    	
        <div property="columns">
        <div type="checkcolumn"></div>
        <div type="indexcolumn" align="center" headerAlign="center">序号</div>
        	<div field="code" width="80" align="center" headerAlign="center">评审报告编号</div>
        	<div field="reportName" width="80" align="center" headerAlign="center" allowSort="true" renderer="lookInfo" >评审报告名称</div>
