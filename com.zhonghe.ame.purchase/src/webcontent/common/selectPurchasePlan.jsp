...
<div  id="form1">
  <div class="nui-toolbar"  style="border-bottom:0;padding:0px;">
	  <table align="center" border="0" width="100%" height="40px" class="form_table">
			<tr>
          <td >
          ...
          <td class="form_label" align = "right">采购计划名称</td>
           <td colspan="2">
						 <input name="criteria._expr[9].name" id="namePro" class="nui-textbox"  style="width:100%;"/>
						 <input class="nui-hidden" name="criteria._expr[9]._op" value="like"/>
           </td>
          <td class="form_label" align = "right">采购计划编号</td>
           <td colspan="2">
						 <input name="criteria._expr[10].code" id="codePro" class="nui-textbox"  style="width:100%;"/>
	...
	class="nui-datagrid" style="width:100%;height:100%;" url="com.zhonghe.ame.purchase.purchaseplan.selsetPlanItems.biz.ext" >
		 <div property="columns">
        	...
        	<div field="putunderName"  align="left" headerAlign="center" allowSort="true">归口部门</div>
        	<div field="name" width="160" align="left" headerAlign="center" allowSort="true">采购计划名称</div>
            <div field="code" width="100" align="left" headerAlign="center" allowSort="true">采购计划编号</div>
            ...
            <div field="newBudgetAmount" width="70" align="center" headerAlign="center" allowSort="true">预算金额(万元)</div>
