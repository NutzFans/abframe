		...
		<table align="center" border="0" width="100%" class="form_table">
			<tr >
				<td>
	          	...
	          	<td class="form_label" align = "right">方案名称:</td>
	          	<td colspan="1">
					<input name="critria._expr[0].type" class="nui-hidden" value="2"/>
					<input name="critria._expr[2].programmeName" class="nui-textbox" style="width:65%;" />
...
<div class="nui-fit">
    <div id="datagrid1"  sizeList="[10,20,50,100]" showPager="true" dataField="purProgrammes" 
    	class="nui-datagrid" style="width:100%;height:95%;" url="com.zhonghe.ame.purchase.purchaseProgramme.queryPurProgramme.biz.ext" 
    	multiSelect="false" >
        <div property="columns">
        	<div type="checkcolumn"></div>
	        <div type="indexcolumn" align="center" headerAlign="center">序号</div>
	        <div field="code" width="80" align="center" headerAlign="center" allowSort="true">采购文件编号</div>
        	<div field="programmeName" width="80" align="center" headerAlign="center" allowSort="true" renderer="lookInfo" >采购文件名称</div>
...
<script type="text/javascript">
	...
	function init() {
		...
		var json = {"code":"cgwj","map":{"property":"status","op":"=","value":"running"}};
		ajaxCommon({
   ...
   function add(){
		nui.open({
			url: "/default/purchase/procurementDocuments/addProDocuments.jsp",
			width: '90%',
			height: '80%',
			title: "采购文件申请",
			onload: function () {
