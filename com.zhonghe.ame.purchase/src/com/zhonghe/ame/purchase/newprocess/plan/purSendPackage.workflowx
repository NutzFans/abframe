...
<workflowProcess productVersion="6.1" schemaVersion="6.0">
  <processHeader>
    <processBasicInfo>
      <processId>com.zhonghe.ame.purchase.newprocess.plan.purSendPackage</processId>
      <processName>采购发包流程</processName>
    ...
    <dataFields>
      <dataField>
        ...
        <description>承办单位id</description>
        <isArray>false</isArray>
      </dataField>
      <dataField>
        <name>branchOrgid</name>
        <dataType>
          <typeClass>primitive</typeClass>
          <typeValue>String</typeValue>
        </dataType>
        <initialValue></initialValue>
        <description>分公司职能部门id串</description>
        <isArray>false</isArray>
      </dataField>
      <dataField>
        <name>wfp</name>
      ...
      <dataField>
        ...
        <initialValue></initialValue>
        <description>会签部门审批人</description>
      ...
      <dataField>
        ...
        <initialValue></initialValue>
        <description>判断分子公司还是本部</description>
        <isArray>false</isArray>
      </dataField>
      <dataField>
        <name>putunder</name>
        ...
        <initialValue></initialValue>
        <description>采购物项归口部门</description>
        <isArray>false</isArray>
      </dataField>
      <dataField>
        <name>processid</name>
      ...
      <dataField>
        ...
        <initialValue></initialValue>
        <description>职能部门经办人</description>
        <isArray>false</isArray>
      </dataField>
      <dataField>
        <name>leader</name>
        ...
        <initialValue></initialValue>
        <description>职能部门负责人</description>
        <isArray>false</isArray>
      </dataField>
      <dataField>
    ...
    <triggerEvents>
      <triggerEvent>
        <applicationInfo>
          ...
          <application>
            <actionType>logic-flow</actionType>
            <applicationUri>com.zhonghe.ame.purchase.purchaseItems.updateSendPackage</applicationUri>
            ...
            <parameters>
              ...
              <parameter>
                ...
                <dataType>
                  <typeClass>sdo</typeClass>
                  <typeValue>com.zhonghe.ame.purchase.purchase.ZhPurchasePackage</typeValue>
                </dataType>
                <isArray>false</isArray>
                <fillBack>false</fillBack>
                <description></description>
  ...
  <transitions>
    ...
    <transition>
      ...
      <isDefault>true</isDefault>
      <priority>60</priority>
      <displayName>需职能部门审核</displayName>
      <type>simpleCondition</type>
      <simpleCondition>
        <leftValueType>variable</leftValueType>
        <compType>EQ</compType>
    ...
    <transition>
      ...
      <isDefault>false</isDefault>
      <priority>60</priority>
      <displayName>无需职能部门审核</displayName>
      <type>simpleCondition</type>
      <simpleCondition>
        <leftValueType>variable</leftValueType>
        <leftValue>operator</leftValue>
  ...
  <activities>
    ...
    <activity>
      ...
      <activityName>采购承办单位经办人发起发包申请</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <customURL>
            ...
            <urlInfo>/purchase/packagemethod/editPackageApp.jsp</urlInfo>
    ...
    <activity>
      ...
      <activityName>分公司职能部门经办人审核</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <participants>
            <participantType>relevantdata</participantType>
            <specialActivityID></specialActivityID>
            <specialPath>operator</specialPath>
          </participants>
          <formFields/>
          <timeLimit>
            <isTimeLimitSet>false</isTimeLimitSet>
    ...
    <activity>
      ...
      <activityName>分公司职能部门负责人审核</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
