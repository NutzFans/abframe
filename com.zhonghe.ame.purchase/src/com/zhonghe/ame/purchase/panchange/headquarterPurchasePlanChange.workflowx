...
<workflowProcess productVersion="6.1" schemaVersion="6.0">
  <processHeader>
    <processBasicInfo>
      <processId>com.zhonghe.ame.purchase.panchange.headquarterPurchasePlanChange</processId>
      <processName>公司本部采购计划变更流程</processName>
  ...
  <activities>
    <activity>
      ...
      <activityName>公司本部采购需求单位负责人审核</activityName>
      <description></description>
    ...
    <activity>
      ...
      <activityName>公司本部采购需求单位经办人发起</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
