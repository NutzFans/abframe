...
<workflowProcess productVersion="6.1" schemaVersion="6.0">
  <processHeader>
    <processBasicInfo>
      <processId>com.zhonghe.ame.purchase.headquarterPurBranch</processId>
      <processName>公司本部紧急采购申报流程</processName>
  ...
  <notes>
    <note>
      <content>紧急采购公司本部流程</content>
      <title>huangqj	21-4-25 下午3:07</title>
      <location>
        <x>120</x>
        <y>465</y>
      </location>
