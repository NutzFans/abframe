				...
				<form id=tianBaoForm " method="post">
					...
					<table style="table-layout: fixed;">
						...
						<tr>
							...
							<td>
								<input name="taskProgress" class="nui-textarea" style="width: 820px; height: 65px" readonly="readonly" />
							</td>
						</tr>
						<tr>
							<td align="right" style="width: 110px">截至本月完成情况：</td>
							<td>
								<input name="taskMonthComple" class="nui-textarea" style="width: 820px; height: 65px" readonly="readonly" />
							</td>
						</tr>						
						<tr id="riskMeasuresTr">
							<td align="right" style="width: 100px">风险及措施：</td>
							<td>
								<input id="riskMeasures" name="riskMeasures" class="nui-textarea" style="width: 820px; height: 65px" readonly="readonly" />
							</td>
						</tr>
					</table>
				</form>
			...
			nui.ajax({
				...
				success : function(o) {
					...
					if (filePath != null && filePath != "") {
						var fileName = "集团重点任务_支撑材料附件.zip";
