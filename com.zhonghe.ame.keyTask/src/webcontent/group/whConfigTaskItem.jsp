...
<body>
				...
				<div style="padding: 5px;">
					<table style="table-layout: fixed;">
						<tr>
							...
							<td>
								<input id="taskYear" name="taskYear" class="nui-textbox" style="width: 150px" required="true"/>
							</td>
							<td align="right" style="width: 90px">领域：</td>
							<td>
								<input id="taskDomain" name="taskDomain" class="nui-textbox" style="width: 500px" required="true" />
							</td>
						</tr>
						<tr>
							<td align="right" style="width: 90px">任务名称：</td>
							<td colspan="3">
								<input id="taskName" name="taskName" class="nui-textbox" style="width: 100%" required="true" />
							</td>
						</tr>
						<tr>
							<td align="right" style="width: 90px">行动计划：</td>
							<td colspan="3">
								<input id="actionPlan" name="actionPlan" class="nui-textbox" style="width: 100%" required="true" />
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="3">
								<input id="measureStandard" name="measureStandard" class="nui-textarea" style="width: 100%; height: 100px" required="true" />
							</td>
						</tr>
					</table>
				</div>
	...
	<script type="text/javascript">
		...
		function save() {
			...
			ajaxCommon({
				"url" : "com.zhonghe.ame.keyTask.group.whSaveTaskItem.biz.ext",
				data : json,
