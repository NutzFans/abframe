...
<body>
	<div class="nui-fit" style="padding: 5px;">
		<fieldset id="field1" style="border: solid 1px #aaa; padding: 5px;">
			...
			<div style="width: 99%">
				<form id="editForm" method="post">
					<input name="mainId" class="nui-hidden" />
		...
		<fieldset id="field2" style="border: solid 1px #aaa; padding: 5px;">
			...
			<div style="width: 99%; margin: 0 auto;">
				...
				<div id="taskDecGrid" class="nui-datagrid" style="width: 100%; height: 350px;" showPager="false" multiSelect="true" allowCellEdit="true" allowCellSelect="true"
					url="com.zhonghe.ame.keyTask.company.queryItemListByTaskNameAndMainId.biz.ext" dataField="itemDatas" allowCellWrap="true">
	...
	<script type="text/javascript">
		...
		function save() {
			...
			var gridChangeData = taskDecGrid.getChanges("removed", false);
			var gridData = taskDecGrid.getData();
			var json = nui.encode({
				"mainData" : formData,
				"itemChangeDatas" : gridChangeData,
				"itemDatas" : gridData
			});
			ajaxCommon({
				"url" : "com.zhonghe.ame.keyTask.company.editItem.biz.ext",
				data : json,
