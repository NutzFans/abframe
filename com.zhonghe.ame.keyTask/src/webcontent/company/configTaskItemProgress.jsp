			...
			<div style="width: 99%; margin: 0 auto;">
				<div id="itemGrid" class="nui-datagrid" style="width: 100%; height: 650px;" showPager="false" url="com.zhonghe.ame.keyTask.company.queryItemListByMainId.biz.ext" dataField="itemDatas"
					...
					<div property="columns">
						...
						<div field="annualTarget" name="annualTarget" width="250" align="left" headerAlign="center">衡量标准</div>
						<div field="taskMonth" width="60" headeralign="center" align="center" renderer="renderMonth">时间节点</div>
						<div field="taskPlanName" width="350" headeralign="center" align="left">分解计划</div>
						<div field="responsiblePerson" width="100" headeralign="center" align="left">责任人</div>
						<div field="taskStatus" width="60" headeralign="center" align="center" renderer="setTaskBackColor">任务状态</div>
						<div field="riskStatus" width="80" headeralign="center" align="center" renderer="setRiskBackColor">是否存在风险</div>
						<div width="40" headeralign="center" align="center" renderer="renderOperate">操作</div>
						<div field="appStatus" width="60" headeralign="center" align="center" renderer="renderTBStatus">填报状态</div>
					</div>
				</div>
			</div>
		</fieldset>
