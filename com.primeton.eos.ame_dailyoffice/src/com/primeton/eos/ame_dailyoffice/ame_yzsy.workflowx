...
<workflowProcess productVersion="6.1" schemaVersion="6.0">
  <processHeader>
    <processBasicInfo>
      <processId>com.primeton.eos.ame_dailyoffice.ame_yzsy</processId>
      <processName>印章使用流程</processName>
    ...
    <dataFields>
      <dataField>
        ...
        <description>部门审批负责人</description>
  ...
  <activities>
    ...
    <activity>
      <activityId>yzsy_fqyzsylc</activityId>
      <activityName>发起印章使用流程</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <customURL>
            ...
            <urlInfo>/ame_dailyoffice/SealGovern/reviewSealUse.jsp</urlInfo>
    ...
    <activity>
      <activityId>yzsy_bmfzrsp</activityId>
      <activityName>部门负责人审批</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <triggerEvents>
            <triggerEvent>
              <applicationInfo>
                <actionType>bizlet</actionType>
                <suppressJoinFailure>suppress</suppressJoinFailure>
                <application>
                  <actionType>bizlet</actionType>
                  <applicationUri>com.primeton.eos.ame_dailyoffice.YzglUtil.sendMessage</applicationUri>
                  <transactionType>join</transactionType>
                  <exceptionStrategy>rollback</exceptionStrategy>
                  <invokePattern>synchronous</invokePattern>
                  <parameters>
                    <parameter>
                      <name>processInst</name>
                      <dataType>
                    ...
                    <parameter>
                      ...
                      <dataType>
                        <typeClass>pojo</typeClass>
                        <typeValue>com.eos.workflow.data.WFWorkItem</typeValue>
                      </dataType>
                      <isArray>false</isArray>
                      <fillBack>false</fillBack>
                      <description></description>
                      <mode>parameter</mode>
                      <value>thisWorkItem</value>
                      <valueType>variable</valueType>
                    </parameter>
                  </parameters>
                </application>
    ...
    <activity>
      <activityId>yzsy_xzbfzrsp</activityId>
      <activityName>行政部负责人审批</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
    ...
    <activity>
      <activityId>fgsyzsy_zl</activityId>
      <activityName>通知营销中心助理</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
          ...
          <triggerEvents>
            <triggerEvent>
              <applicationInfo>
                ...
                <application>
                  <actionType>bizlet</actionType>
                  <applicationUri>com.primeton.eos.ame_dailyoffice.FgsyzglUtil.sendMessage</applicationUri>
                  <transactionType>join</transactionType>
                  <exceptionStrategy>rollback</exceptionStrategy>
                  <invokePattern>synchronous</invokePattern>
                  <parameters>
    ...
    <activity>
      <activityId>fgsyzsy_yxzxfzrsp</activityId>
      <activityName>营销中心负责人审批</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
