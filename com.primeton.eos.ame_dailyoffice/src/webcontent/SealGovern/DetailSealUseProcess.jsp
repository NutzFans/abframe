...
<div class="nui-fit">
	...
	<jsp:include page="/ame_common/ameFlowOperTips/ameFlowOperTipsInfo.jsp"/>
		<div class="nui-toolbar" style="hegiht:300px;">
					...
					<div style="padding:5px;">
						<table style="table-layout:fixed;" id="table_file">
							<tr>
								...
								<td style="width:150px;"><input name="yzgl.dh" class="nui-textbox" style="width:100%" /></td>
							...
							<tr>
								...
								<td style="width:150px;"><input name="yzgl.orgname" class="nui-textbox" style="width:100%" />
														 <input name="yzgl.orgid" class="nui-hidden" /></td>
								<td align="right" style="width:120px">经办人：</td>
								<td style="width:150px;"><input name="yzgl.username" class="nui-textbox" style="width:100%" />
							...
							<tr>	
								...
								<td colspan="5" class = "asLabel"><input name="yzgl.yysyyjwjmc" class="nui-textarea" vtype="rangeChar:0,2000" style="width:100%" /></td>
							</tr>
							<tr>	
...
<script type="text/javascript">
	...
	form.mask("数据加载中...");
	var json = nui.encode({yzsy : {"yzglid" : yzglid,"processinstid":processInstId}});
	nui.ajax({
			url: "com.primeton.eos.ame_dailyoffice.yzglHandle.queryYzsyDataProcess.biz.ext",
			type: "post",
			data: json,
			...
			success: function (o){
				...
				if(o.yzgl.qtz == "true"){
					nui.getbyName("yzgl.qtzmc").show();
				}
				//加载附件设置参数
				nui.get("grid_0").load({"groupid":"yzsy","relationid": o.yzgl.dh},function(){});
				//查询审核意见
				var grid = nui.get("datagrid1");
				if(o.yzgl.processinstid!=null && o.yzgl.processinstid!=""){
						grid.load({processInstID:o.yzgl.processinstid});
