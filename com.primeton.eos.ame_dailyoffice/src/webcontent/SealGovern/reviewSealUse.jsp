...
<script src="<%= request.getContextPath() %>/ame_dailyoffice/SealGovern/js/reviewSealUse.js"></script>
	<style type="text/css">
	    body{
		...
		<div class="nui-toolbar">
			<fieldset id="field1" style="border:solid 1px #aaa;padding:3px;">
				...
				<form id="yzglSealUse">
					...
					<input name="yzgl.processinstid" class="nui-hidden"/>
					<input name="purstatus" class="nui-hidden"/>
					<div style="padding:5px;">
						<table style="table-layout:fixed;" id="table_file">
							<tr>
								<td align="right" style="width:120px;">单号：</td>
								<td style="width:150px;"><input  id="dh" name="yzgl.dh" class="nui-textbox" style="width:100%" /></td>
								<td align="right" style="width:120px;">印章申请日期：</td>
								<td style="width:150px;">
	                    			<input id="date" name="yzgl.yzsqrq" class="nui-datepicker"  style="width:100%" />
	               				</td>	
							</tr>
							<tr>
								<td align="right" style="width:120px;">用印部门：</td>
								<td style="width:150px;"><input id="orgname" name="yzgl.orgname" class="nui-textbox" style="width:100%" />
														 <input name="yzgl.orgid" class="nui-hidden" /></td>
								<td align="right" style="width:120px">经办人：</td>
								<td style="width:150px;"><input id="username" name="yzgl.username" class="nui-textbox" style="width:100%" />
														 <input name="yzgl.userid" class="nui-hidden" /></td>
							</tr>
							<tr id="rentNum_tr">
								<td align="right" style="width:120px;">租赁编号：</td>
								<td style="width:150px;">
								<input name="yzgl.rentNum" id="rentNum" class="nui-textbox" style="width:100%" /></td>
							</tr>
							<tr>	
								...
								<td colspan="4" class = "asLabel">
									<div name="yzgl.yzlx" id="yzlx" class="mini-checkboxlist" repeatItems="4" repeatLayout="table" textField="text" valueField="id">
  									...
  									<div>
  										...
  										<input name="yzgl.qtzmc" class="nui-textbox" style="display:none">
  									</div>
								</td>
							<tr>	
								<td align="right" style="width:120px">用印事由及文件名称：</td>
								<td colspan="5" class = "asLabel"><input  id="yysyyjwjmc" name="yzgl.yysyyjwjmc" class="nui-textarea" vtype="rangeChar:0,2000" style="width:100%" /></td>
							</tr>
							<tr>	
								<td align="right" style="width:120px">备注：</td>
								<td colspan="5" class = "asLabel"><input id="remark" name="yzgl.bz" class="nui-textarea" vtype="rangeChar:0,2000" style="width:100%" /></td>
							</tr>
						</table>
					</div>
				</form>
	        ...
	        <legend>处理意见列表</legend>
	        	<div id="datagrid1" class="nui-datagrid" style="width:100%;height:auto;" dataField="misOpinions"
				    url="com.primeton.eos.ame_dailyoffice.yzglHandle.queryAuditOpinions.biz.ext"  idField="id" allowResize="true" allowAlternating="true" multiSelect="true" showPager="false" allowCellWrap="true">
