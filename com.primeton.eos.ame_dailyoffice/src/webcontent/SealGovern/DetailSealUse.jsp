					...
					<div style="padding:5px;">
						<table style="table-layout:fixed;" id="table_file">
							...
							<tr>
								...
								<td style="width:150px;"><input id="yybmView" name="yzgl.orgname" class="nui-textbox" style="width:100%" allowInput="false"/>
								 						 <input id="yybmEdit"  name="yzgl.orgname" style="width:162px;" class="nui-combobox" url="com.bos.mp.common.SelectManage.queryAllOrg.biz.ext"
								...
								<td style="width:150px;"><input id="jbrView" name="yzgl.username" class="nui-textbox" style="width:100%" allowInput="false"/>
														 <input id="jbrEdit" name="yzgl.username" class="nui-textboxlist" searchField="name" style="width:215px" required="true"
...
<script type="text/javascript">
	...
	function SaveData(){
    	...
    	if(type == "add"){
	    	formData.yzgl.lclx = "YZSY";
	    	formData.yzgl.lclxmc = "印章使用流程";
	    	var nui_userViso = nui.getbyName("yzgl.username");
	    	var nui_orgViso = nui.getbyName("yzgl.orgname");
	    	formData.yzgl.username = strSplit1(nui_userViso.text,"(");
	    	formData.yzgl.userid = nui_userViso.value;
	    	formData.yzgl.orgname = strSplit(nui_orgViso.text,"-");
	    	formData.yzgl.orgid = getOrgid(nui_orgViso);
    	}
        ...
        var json = {yzsyData:formData.yzgl};
	...
	function loadData(){
		...
		nui.ajax({
				...
				//加载附件设置参数
				nui.get("grid_0").load({"groupid":"yzsy","relationid": o.yzgl.dh},function(){});
