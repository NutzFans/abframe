...
<body>
	<div class="mini-panel" title="印章使用管理" width="auto">
				...
				<table style="width:100%;">
					<tr>
		            	...
		            	<td align="left">
						    ...
						    <input class="nui-hidden" name="criteria._expr[0]._property" value="wjsy"/>
						    <input class="nui-hidden" name="criteria._expr[0]._op" value="like"/>
						    <input class="nui-hidden" name="criteria._expr[0]._likeRule" value="all"/>
						</td>
						<td align="right"><span>印章类型：</span></td>
		            	<td align="left">
		            		<input style="width:220px;" id="yzlx" showNullItem="true" class="nui-dictcombobox" value="" name="criteria._expr[1]._value"/>
						    <input class="nui-hidden" name="criteria._expr[1]._property" value="yzlxmc"/>
					...
					<tr>
		            	...
		            	<td align="left">
						    ...
						    <input class="nui-hidden" name="criteria._expr[3]._property" value="yzwjrq"/>
	    ...
	    url="com.primeton.eos.ame_dailyoffice.yzwjHandle.querySealDeliveryList.biz.ext" sizeList="[10,20,50,100,200,500,1000]"  idField="yzglid" multiSelect="true">
			<div property="columns">
				<div type="checkcolumn" width="6"></div>
				<div type="indexcolumn" align="center" headerAlign="center" width="6">编号</div>
				<div field="wjsy" width="12" align="center" headerAlign="center" allowSort="true" renderer="getDetail">名称</div>
				<div field="dh" width="12" align="center" headerAlign="center" allowSort="true">单号</div>	
				<div field="username" width="12" align="center" headerAlign="center" allowSort="true">创建人</div>		
				<div field="yzwjrq" width="12" align="center" headerAlign="center"allowSort="true">申请日期</div>	
				<div field="orgname" width="12" align="center" headerAlign="center" allowSort="true">所属组织</div>	
				<div field="yzlxmc" width="12" align="center" headerAlign="center" allowSort="true">印章类型</div>
	...
	<script type="text/javascript">
		...
		function add() {        	
            nui.open({
                url: "<%=request.getContextPath() %>/ame_dailyoffice/SealDeliveryGovern/DetailSealDelivery.jsp",
                title: "新增印章使用单", 
				width: 1100,
	            height: 600,
                onload: function () {
        ...
        function remove() {
			...
			if (rows.length> 0) {
            	...
            	if (confirm("确定删除选中记录？")) {
	                ...
	                nui.ajax({
		                url: "com.primeton.eos.ame_dailyoffice.yzwjHandle.deleteYzwjData.biz.ext",
		                type: "post",
		                data: json, 
		                cache: false,
        ...
        function edit() {
    		...
    		if(row.length == 1){
	    		...
	    		if(state == "2"){
		 		...
		 		var	executeUrl = "<%=request.getContextPath() %>/ame_dailyoffice/SealDeliveryGovern/DetailSealDelivery.jsp?yzwjid=" + row.yzwjid;
	          		nui.open({
			            url: executeUrl,
			            title: "编辑印章外借信息",
			            width: 1100,
        ...
        function checkDetail(){
			...
			var executeUrl = "<%=request.getContextPath() %>/ame_dailyoffice/SealDeliveryGovern/DetailSealDelivery.jsp?yzwjid=" + selectRow.yzwjid;
			nui.open({
				url: executeUrl,
				title: "详细信息",
				width: "750px",
