...
<!-- 
  - Author(s): zhengquan
  - Date: 2019-03-04 16:48:18
  - Description:
-->
<head>
<title>发起分公司印章流程</title>
<%@include file="/common/common.jsp"%>
<h:script src='<%="/common/scripts/eos-web.js"%>' />
<meta http-equiv="content-type" content="text/html; charset=UTF-8" />
<script src="<%= request.getContextPath() %>/common/nui/nui.js" type="text/javascript"></script>
<script src="<%= request.getContextPath() %>/ame_dailyoffice/FgsSealCovern/js/createSubSealUse.js"></script>
	<style type="text/css">
	    body{
		...
		<div class="nui-toolbar">
			<fieldset id="field1" style="border:solid 1px #aaa;padding:3px;">
				...
				<form id="fgsyzglSealUse">
					<!--隐藏域-->
					<input name="fgsyzsy.ywid" class="nui-hidden" />
					<input name="fgsyzsy.fileids" id="fileids"  class="nui-hidden"/>
					<input name="fgsyzsy.yzglid" class="nui-hidden"/>
					<input name="purstatus" class="nui-hidden"/>
					<div style="padding:5px;">
						<table style="table-layout:fixed;" id="table_file">
							<tr>
								<td align="right" style="width:120px;">单号：</td>
								<td style="width:150px;"><input name="fgsyzsy.dh" class="nui-textbox" allowInput="false" style="width:100%" /></td>
								<td align="right" style="width:120px;">印章申请日期：</td>
								<td style="width:150px;">
	                    			<input name="fgsyzsy.yzsqrq" class="nui-datepicker"  style="width:100%" />
	               				</td>	
							</tr>
							<tr>
								<td align="right" style="width:120px;">用印部门：</td>
								<td style="width:150px;"><input name="fgsyzsy.orgname" class="nui-textbox" allowInput="false" style="width:100%" />
														 <input name="fgsyzsy.orgid" class="nui-hidden" /></td>
								<td align="right" style="width:120px">申请人：</td>
								<td style="width:150px;"><input name="fgsyzsy.username" class="nui-textbox" allowInput="false" style="width:100%" />
														 <input name="fgsyzsy.userid" class="nui-hidden" /></td>
							</tr>
							<tr>	
								<td align="right" style="width:120px">用章类型：</td>
								<td colspan="4" class = "asLabel">
									<div name="fgsyzsy.yzlx" id="yzlx" class="mini-checkboxlist" repeatItems="4" repeatLayout="table" textField="text" valueField="id">
  									</div>
  									<div>
  										<input class="nui-checkbox" text="其他章" name="fgsyzsy.qtz" onvaluechanged="yzlxchange(this)">
  										<input name="fgsyzsy.qtzmc" class="nui-textbox" required="true" requiredErrorText="其他章名称不能为空！" style="display:none">
  									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<input name="fgsyzsy.yzssdw" class="nui-dictcombobox" dictTypeId="FGS_NAME" required="true" requiredErrorText="印章所属单位不能为空！" style="width:100%"/>
								</td>
							</tr>
							<tr>	
								<td align="right" style="width:120px">用印事由及文件名称：</td>
								<td colspan="5" class = "asLabel"><input name="fgsyzsy.yysyyjwjmc" class="nui-textarea" vtype="rangeChar:0,2000" required="true" requiredErrorText="用印事由及文件名称不能为空！" style="width:100%" /></td>
							</tr>
							<tr>	
								<td align="right" style="width:120px">备注：</td>
								<td colspan="5" class = "asLabel"><input name="fgsyzsy.bz" class="nui-textarea" vtype="rangeChar:0,2000" style="width:100%" /></td>
							</tr>
						</table>
					</div>
				</form>
