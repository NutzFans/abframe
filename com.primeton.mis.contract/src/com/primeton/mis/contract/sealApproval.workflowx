...
<workflowProcess productVersion="6.1" schemaVersion="6.0">
  <processHeader>
    <processBasicInfo>
      <processId>com.primeton.mis.contract.sealApproval</processId>
      <processName>用章申请流程</processName>
      <priority>60</priority>
      <author>75241</author>
      <department>Primeton</department>
      <description>用章申请流程</description>
    </processBasicInfo>
    <dataFields>
      <dataField>
  ...
  <transitions>
    ...
    <transition>
      ...
      <complexCondition>
        ...
        <scriptValue>backflag.equals(&quot;3&quot;) || backflag.equals(&quot;2&quot;)</scriptValue>
      </complexCondition>
      <bendPoints/>
    </transition>
    <transition>
    ...
    <transition>
      ...
      <isDefault>false</isDefault>
      <priority>60</priority>
      <displayName>无需业务审核</displayName>
      <type>simpleCondition</type>
      <simpleCondition>
        <leftValueType>variable</leftValueType>
        <leftValue>ischeck</leftValue>
        <compType>EQ</compType>
    ...
    <transition>
      ...
      <complexCondition>
        <scriptGrammar>java</scriptGrammar>
        <scriptValue>backflag.equals(&quot;3&quot;) || backflag.equals(&quot;1&quot;)</scriptValue>
      </complexCondition>
      <bendPoints/>
    </transition>
    <transition>
  ...
  <activities>
    ...
    <activity>
      ...
      <activityName>用章审批</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <customURL>
            ...
            <urlInfo>/ame_common/seal/sealApproval.jsp</urlInfo>
          ...
          <participants>
            ...
            <specialPath>checkman</specialPath>
          </participants>
          <formFields/>
          <timeLimit>
            <isTimeLimitSet>false</isTimeLimitSet>
    ...
    <activity>
      ...
      <activityName>业务部门审批</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <customURL>
            <isSpecifyURL>true</isSpecifyURL>
            <urlInfo>/ame_common/seal/businessApproval.jsp</urlInfo>
            <urlType>webpage</urlType>
          </customURL>
          <resetUrl>
            <isSpecifyURL>false</isSpecifyURL>
    ...
    <activity>
      ...
      <activityName>盖章确认</activityName>
      <description></description>
      <splitType>XOR</splitType>
          ...
          <triggerEvents>
            <triggerEvent>
              <applicationInfo>
                ...
                <application>
                  <actionType>logic-flow</actionType>
                  <applicationUri>com.primeton.eos.ame_common.seal.sendWxToApply</applicationUri>
                  <transactionType>join</transactionType>
                  <exceptionStrategy>ignore</exceptionStrategy>
                  <invokePattern>synchronous</invokePattern>
                  <parameters>
    ...
    <activity>
      ...
      <activityName>发起用章申请</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <customURL>
            <isSpecifyURL>true</isSpecifyURL>
            <urlInfo>/ame_common/seal/editSealApproval.jsp</urlInfo>
            <urlType>webpage</urlType>
          </customURL>
          <resetUrl>
            <isSpecifyURL>false</isSpecifyURL>
    ...
    <activity>
      ...
      <activityName>用章审核</activityName>
      <description></description>
        ...
        <manualActivity>
          ...
          <participants>
            ...
            <regularApp>
              ...
              <application>
                <actionType>logic-flow</actionType>
                <applicationUri>com.primeton.eos.ame_common.seal.getSealExamuser</applicationUri>
                <transactionType>join</transactionType>
                <exceptionStrategy>rollback</exceptionStrategy>
                <invokePattern>synchronous</invokePattern>
                <parameters>
