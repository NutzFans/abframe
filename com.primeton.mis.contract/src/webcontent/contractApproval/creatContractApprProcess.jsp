    ...
    <div id="form1" >
        ...
        <fieldset style="border:solid 1px #aaa;padding:3px;width: 100%;">
            ...
            <table style="table-layout:fixed;" id="table_file">
                <tr>
                    <td style="width:120px;" align="right">合同类型：</td>
                ...
                <tr id="temp2" style="display:">
                    ...
                    <td style="width:150px;">
                    	<input class="nui-dictcombobox"  name="cscontract.ishighrisk" id="ishighrisk" onvaluechanged="changedisforbid(e)" dictTypeId="MIS_YN"/>
                    </td>
                    <td style="width:120px;" align="right">是否允许对外宣传：</td>
                    <td style="width:150px;">
                    	<input class="mini-dictcombobox" name="cscontract.publicity" style="width:135px" id="publicity" dictTypeId="MIS_YN" value="0"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="width:120px;display:none" align="right" id='pt1'>排他合作的条件：</td>
                    <td style="width:150px;display:none" colspan="3" id='pt2'>    
                ...
                <tr>
                	...
                	<td style="width:150px;">
                		<input class="mini-dictcombobox" name="cscontract.isfinreve" style="width:135px" id="isfinreve" dictTypeId="MIS_YN" value="0" required="true"/>
                	</td>
                </tr>
               <!--  <tr id="temp3" style="display:none">
        ...
        <fieldset style="border:solid 1px #aaa;padding:3px;width: 100%;">
            ...
            <div id="csReveForecast_grid" class="nui-datagrid"  frozenStartColumn="0" frozenEndColumn="4"  style="width:1050px;height:auto;" dataField="csReveForecasts"
	            showPager="false" allowCellEdit="true" allowCellSelect="true" multiSelect="true" editNextOnEnterKey="true"
	            ...
	            <div property="columns">
	                ...
	                <div field="fcsum" width="100" dataType="currency" headerAlign="center" align="right" summaryType="sum">预计确认金额</div>
	                <div field="fcreverate" width="80" headerAlign="center" align="right" numberFormat="p1">预计确认比例</div>
        ...
        <fieldset style="border:solid 1px #aaa;padding:3px;width: 100%;">
            ...
            <div id="product_reve_grid" class="nui-datagrid" style="width:1050px;height:auto;" oncellendedit="changeProdReve" showSummaryRow="true" ondrawsummarycell="drawCsReveForecastSum"
            	...
            	<tr id="salesEdit">
                    ...
                    <td style="width: 250px;">
						<input name="misOpinion.auditstatus" id="auditstatus" class="nui-dictradiogroup" style="width: 250px;" 
							required="false" dictTypeId="MIS_AUDITSTATUS" onvaluechanged="show()"/>
                    </td>
                </tr>
                <tr>
...
<div style="text-align: center;padding: 10px;border-width:1px 0px 0px 0px;" class="nui-toolbar">
	...
	<a class="nui-button" onclick="onOk('1')" id="appButton" style="width: 80px;margin-right: 20px;">发起流程</a>
	<a class="nui-button" onclick="onOk('0')" id="saveButton" style="width: 80px;margin-right: 140px;">暂时保存</a>
</div>
</body>     
<script type="text/javascript">
    ...
    function init() {
    	...
    	//设置审批意见
	  	nui.get("auditstatus").setValue("4");//1:通过,0:退回，2:终止流程，3:发起 4:处理
	  	document.getElementById("salesEdit").style.display="none";
	  	//流程操作提示
	  	promptInit({"workItemID": 0,"processDefName": "com.primeton.mis.contract.contractApproval","activityDefID": "manualActivity"});
	}
        	...
        	if(productReves!=null&&productReves!=''){
    			for(var i=0;i<rows.length;i++){
	        		...
	        		for(var k=0;k<productReves.length;k++){
	        			var reveno1 = productReves[k].reveno;
	        			if(reveno1 == reveno){
    ...
    function onOk(e) {
    	...
    	if(!form.validate()){
        	...
        	var datas = sales_grid.getData();
        	var products = product_grid.getData();
        	var isHaveOrg = true;
        	var isProdname=true;
        	for(var i=0;i<datas.length;i++){
				var org = datas[i].org;
			...
			if(products){
    			for(ii = 0;ii<products.length;ii++){
    				var prodname = products[ii].prodname;
    ...
    function submit(json){
        ...
        nui.ajax({
            url: "com.primeton.mis.contract.contractApproval.creatContractAppr.biz.ext",
            data: json,
            type: 'POST',
            cache: false,
            contentType: 'text/json',
