    ...
    <div id="form1" >
        ...
        <fieldset style="border:solid 1px #aaa;padding:3px;width: 100%;">
            ...
            <table style="table-layout:fixed;" id="table_file">
                ...
                <tr>
                    <td style="width:140px" align="right">SOA金额：</td>
                    <td style="width:150px;" id="soamon" class = "asLabel">    
                    </td>
                    <td style="width:140px;" align="right">云计算金额：</td>
                    <td style="width:150px;" id="yjsmon" class = "asLabel">    
                    </td>
                    <td style="width:140px;" align="right">大数据金额：</td>
                    <td style="width:150px;" id="dsjmon" class = "asLabel">    
                    </td>
                </tr>
                <tr>
                	<td style="width:140px;" align="right">移动金额：</td>
                    <td style="width:150px;" id="mobilemon" class = "asLabel">    
                    </td>
                	<td style="width:140px;" align="right">其他金额：</td>
                    <td style="width:150px;" id="qtmon" class = "asLabel">    
                    </td>
                ...
                <tr>
                    <td style="width:140px;font-weight: bold;"align="right">合同总金额：</td>
                    <td style="width:150px;color: red" id="contsum" class = "asLabel">    
                    </td>
                    <td style="width:140px;font-weight: bold;" align="right">产品金额：</td>
                    <td style="width:150px;color: red" id="prodmon" class = "asLabel">    
                    </td>
                    <td style="width:140px;font-weight: bold;" align="right">服务金额：</td>
                    <td style="width:150px;color: red" id="servmon" class = "asLabel">    
                    </td>
                </tr>
                <tr>
                    ...
                    <td></td>
                    <td></td>
                    <!-- <td style="width:140px;" align="right">采购2：</td>
                    <td style="width:150px;" id="othmon" class = "asLabel">    
                    </td> -->
                </tr>
        ...
        <!-- <div id="form_purChaseYesOrNo">
			<table style="table-layout:fixed;">
				<tr>
					<td style="width:87px;" align="right">是否提供预算：</td>
					<td style="width:140px;" id="purChaseYesOrNo">  
						<input id="purChaseYesOrNo" class="nui-dictcombobox" readonly="readonly"  style="width:80px;" required="true" dictTypeId="MIS_YN"/>
					</td>
				</tr>
			</table>
		</div> -->
		<div id="tabs1" class="nui-tabs" activeIndex="0" onactivechanged=changetab style="width:100%;overflow: auto;">
            <div title="合同销售人员" >
    ...
    function init() {
		...
		nui.ajax({
			...
			success:function (o){
                ...
                document.getElementById("soamon").innerHTML = o.cscontract.soamon == null ? "":formatNumber(o.cscontract.soamon.toFixed(2),'#,##.00');
                document.getElementById("yjsmon").innerHTML = o.cscontract.yjsmon == null ? "":formatNumber(o.cscontract.yjsmon.toFixed(2),'#,##.00');
                document.getElementById("mobilemon").innerHTML = o.cscontract.mobilemon == null ? "":formatNumber(o.cscontract.mobilemon.toFixed(2),'#,##.00');
                document.getElementById("dsjmon").innerHTML = o.cscontract.dsjmon == null ? "":formatNumber(o.cscontract.dsjmon.toFixed(2),'#,##.00');
                document.getElementById("qtmon").innerHTML = o.cscontract.qtmon == null ? "":formatNumber(o.cscontract.qtmon.toFixed(2),'#,##.00');
				...
				/*合同项目信息*/
					projectid = o.cscontract.rdproject.projectId;
               		document.getElementById("projectno").innerHTML = o.cscontract.projectno == null ?"":"<a href='#' onclick='javascript: doViewProject();' >" + o.cscontract.projectno + "</a>";
