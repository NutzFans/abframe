...
<div class="nui-fit" style="border:solid 0px #aaa;padding:0px;width:100%;">
	<div class="mini-panel" title="项目预算审核" style="width:100%;">
	<!-- 提示信息展示  -->
    ...
    <div id="form1" >
        ...
        <fieldset style="border:solid 1px #aaa;padding:3px;width: 100%;">
            ...
            <table style="table-layout:fixed;" id="table_file">
                ...
                <tr style="display:">
                    ...
                    <td style="width:150px;display: none;" id="xystart" class = "asLabel">    
                    </td>
                    <td style="width:140px;display: none;" align="right"  id='endtime1'>协议有效期结束：</td>
                    <td style="width:150px;display: none;" id="xyend" class = "asLabel" >    
                    </td>
                </tr>
                <tr>
                    <td style="width:140px;" id="contsum1" align="right">合同总金额：</td>
                    <td style="width:150px;" id="contsum" class = "asLabel">    
                    </td>
                    <td style="width:140px;" id="prodmon1" align="right">产品金额：</td>
                    <td style="width:150px;" id="prodmon" class = "asLabel">    
                    </td>
                    <td style="width:140px;" id="servmon1" align="right">服务金额：</td>
                ...
                <tr id="temp3" style="display:">
                    ...
                    <td style="width:550px;" colspan="3" id="ptcondition" class = "asLabel">    
                    </td>
                </tr>
                <tr>
        	...
        	<div style="padding:5px;">
	        	<table style="table-layout:fixed;" id="table_file1">
		            <tr id="pmo">
						...
						<input name="cscontract.projectno" id="pmoprojectno" style="width:180px" onbuttonclick="selectProject" class="nui-buttonedit" allowInput="false"/>
						</td>
					...
					<tr id="leader" style="display: none;">
						<td align="right" style="width:120px">项目编号：</td>
						<td style="width:width:180px"  colspan="2" id="leadprojectno" class = "asLabel">
						</td>	
						<td align="right" width="120px">对应客户：</td>
						<td id="rdproject.custname1" colspan="2"  style="width:180px" class = "asLabel"></td>
					</tr>
					<tr>
		...
		<div id="tabs1" class="nui-tabs" onactivechanged=changetab activeIndex="0" style="width:100%;overflow: auto;">
            <div title="合同销售人员" >
	        	<div id="sales_grid" class="nui-datagrid" frozenStartColumn="0" frozenEndColumn="0"  style="width:100%;height:auto;" allowResize="true"
			    ...
			    <div id="detailGrid_Form" style="display:none;">
			        <div id="product_grid" class="nui-datagrid" frozenStartColumn="0" frozenEndColumn="3"  style="width:100%;height:auto;"
            ...
            <div title="合同业务分类">
		        <div id="csContType_grid" class="nui-datagrid" style="width:50%;height:auto;" dataField="contTypes" 
	            	showPager="false" showSummaryRow="true" ondrawsummarycell="drawCsReveForecastSum">			            
		            <div property="columns">
        	...
        	<div title="合同收入确认预估" >
	            ...
	            <legend>合同收入确认预估 </legend>
	            	<div style="padding:5px;">
			            <div id="csReveForecast_grid" class="nui-datagrid" frozenStartColumn="0" frozenEndColumn="3" style="width:1035px;height:auto;" dataField="csReveForecasts"
				            showPager="false" allowCellEdit="true" allowCellSelect="true" multiSelect="true" editNextOnEnterKey="true"
	            ...
	            <legend>产品参与分成记录</legend>
		            <div style="padding:5px;">
				        <div id="product_reve_grid" class="nui-datagrid" style="width:1035px;height:auto;" allowCellSelect="true" multiSelect="true" dataField="productReves" 
				            ...
				            ondrawsummarycell="drawCsReveForecastSum">			            
				            <div property="columns">
				                <div field="reveno" width="60" headerAlign="center" >收入次数</div>
				                <div field="prodname" displayField="prodtypename" width="150" headerAlign="center" >产品名称</div>
				                <div field="prodrevetype"  width="70" headerAlign="center" renderer="getReveProdtype">收入产品类型</div>
				                <div field="contsum" dataType="currency" width="60" align="right" headerAlign="center" summaryType="sum">参与分成合同额</div>
				                <div field="tax" dataType="currency" width="60" align="right" headerAlign="center" summaryType="sum">税金</div>
				                <div field="productrate" dataType="currency" width="60" align="right" headerAlign="center">产品税率</div>
				                <div field="contsum2" dataType="currency" width="60" align="right" headerAlign="center" summaryType="sum">不含税合同额</div>
				                <div field="pratio" dataType="currency" width="60" align="right" headerAlign="center">分成比例</div>
				                <div field="pratiomon" dataType="currency" width="60" align="right" headerAlign="center" summaryType="sum">分成金额</div>
				            </div>
				        </div>
		            </div>
		        </fieldset>
	    ...
	    <div id="email" style="width: 970px;display: none;">
	    	<fieldset style="border:solid 1px #aaa;padding:3px;">
	    		<legend>合同审批提示</legend>
	    		<div style="padding:5px;" >
	    			<table style="table-layout:fixed;">
	    				<tr>
	    					<td style="width:150px;"  align="right" >邮件主题：</td>
	    					<td id="subject" class = "asLabel"></td>
	    				</tr>
	    				<tr>
	    					<td style="width:150px;" align="right" valign="top">邮件正文：</td>
	    					<td id="content2" class = "asLabel"  style="font-size:12px" width="auto" height="90%"></td>
	    				</tr>
	    			</table>
	    		</div>
	    	</fieldset>
...
<script type="text/javascript">
    ...
    function init() {
		...
		nui.ajax({
			...
			success:function (o){
				...
				//加载附件设置参数
				isViewDelete = false;//判断附件是否要加删除按钮
                ...
                if(o.workitem.activityDefID=="manualActivity3"){//工作项为合同审批（会签环节）
                	document.getElementById("contsum1").style.fontWeight = "bold";
                	document.getElementById("prodmon1").style.fontWeight = "bold";
                	document.getElementById("servmon1").style.fontWeight = "bold";
                	document.getElementById("contsum").style.color = "red";
                	document.getElementById("prodmon").style.color = "red";
                	document.getElementById("servmon").style.color = "red";
               		email = o.cscontract.email;
                	//合同审批环节展示邮件相关信息
					document.getElementById("email").style.display = "";
                	document.getElementById("content2").innerHTML = email.message == null ?"":email.message;
	                document.getElementById("content2").style.lineHeight="12px";
	                document.getElementById("subject").innerHTML = email.subject == null ?"":email.subject;
              ...
              //判断是否有排他合作
				...
				/*合同项目信息*/
					...
					if(o.workitem.activityDefID=="manualActivity3"){//工作项为合同审批（会签环节）
						...
						document.getElementById("leadprojectno").innerHTML = o.cscontract.projectno == null ?"":"<a href='#' onclick='javascript: doViewProject();' >" + o.cscontract.projectno + "</a>";
               			document.getElementById("rdproject.custname1").innerHTML = o.cscontract.rdproject.custname == null ?"":o.cscontract.rdproject.custname;
						tabs1.addTab(tab_bb,3);
					}else{
						nui.get("pmoprojectno").setText(o.cscontract.projectno);
               			nui.get("pmoprojectno").setValue(o.cscontract.projectno);
						...
						tabs1.activeTab(tabs1.getTab(1));
					}
	...
	function changetab(){
		var tabs1 =nui.get("tabs1");
		var tab = tabs1.getActiveTab();
		if(tab.title == "项目预算损益信息"){
			tabs1.setHeight("650px");
		}else{
			tabs1.setHeight("auto");
		}
	}
	//查看项目详细信息
	function doViewProject(){
   ...
   function onCancel(){
    ...
    function SaveData(){
   		 var o = form.getData();
    	 var data_opioion = opioionform.getData();//审批意见	
    	 var json = nui.encode({"cscontract":o.cscontract,"misOpinion": data_opioion.misOpinion});
    	form.loading("提交中，请稍候...");
        nui.ajax({
            url: "com.primeton.mis.contract.contractApproval.pmoContractAppr.biz.ext",
            data: json,
            type: 'POST',
            cache: false,
            contentType: 'text/json',
	...
	function drawCsReveForecastSum(e){
		if (e.field == "fcsum" ||e.field == "contsum" || e.field == "tax"|| e.field == "contsum2"
		|| e.field == "pratiomon" || e.field == "backdepmon" || e.field == "returnmon"  
