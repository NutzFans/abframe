...
<body> 
	...
	<div class="nui-fit">
		<div id="datagrid1" class="nui-datagrid" style="width:100%;height:295px;" idField="custid" 
    		url="com.primeton.mis.contract.contract.queryContract.biz.ext" dataField="contracts" 
    		sizeList="[5,10,20,50,100]" multiSelect="false" onrowdblclick="onRowDblClick" >
			<div property="columns" >
		        ...
		        <div field="custname" width="180" dateFormat="yyyy-MM-dd" headerAlign="center" allowSort="true">签单公司</div>
