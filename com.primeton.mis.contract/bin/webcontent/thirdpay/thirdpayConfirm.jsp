            ...
            <table style="table-layout:fixed;">
            	<tr>
                    ...
                    <td style="width: 150px;" align="left">    
                        ...
                        id="contractid" value="" text="" onbuttonclick="onButtonEdit1" showClose="true" 
            	...
            	<tr>
                    ...
                    <td style="width:450px;" colspan="3" align="left">    
                        <input class="nui-buttonedit" style="width:240px" name="csContractsalePay.custid" 
	                        id="custid" onbuttonclick="onSelectSupplier" showClose="true" oncloseclick="onCloseClick" required="true" allowInput="false"/>
                    </td>
					<td style="width:120px;" align="right">采购合同编号：</td> 
                    <td style="width:310px;" align="left">    
                        <input name="csContractsalePay.purcontno" id="purcontnum" textField="purcontnum" valueField="purcontid" shownullitem="true" class="nui-combobox" style="width: 150px;"/>
                    </td>    
                </tr>
            	<tr>
                    <td style="width:120px;" align="right">报销单号：</td> 
                    <td style="width:150px;" align="left">    
            ...
            <div style="padding:5px;">
	        	<div id="dept_grid" class="nui-datagrid" style="width: 100%;height:auto;" allowResize="true" oncellendedit="doCal"
			        ...
			        <div property="columns">            
			            ...
			            <div field="thispayedservmon" width="120" headerAlign="center" align="right" >本次支付服务外包1金额
			            ...
			            <div field="thispayedothmon" width="110" headerAlign="center" align="right" >本次支付服务外包2
			            	<input property="editor" class="nui-textbox" style="width:100%;" vtype="float"/>
			            </div>
			    ...
			    <div id="detailGrid_Form" style="display:none;">
			        ...
			        allowCellEdit="true" allowCellSelect="true" editNextOnEnterKey="true" oncellendedit="doSubCal">
			            <div property="columns">
			                ...
			                <div field="thispayedprodmon" width="120" align="right" headerAlign="center">本次支付产品外包1金额
			                ...
			                <div field="thispayedothmon" width="120" align="right" headerAlign="center">本次支付产品外包2
			                	<input property="editor" class="nui-textbox" vtype="float"/>
			                </div>
...
<script type="text/javascript">
    var updateURL = "com.primeton.mis.contract.bill.updateBillApplyFinance.biz.ext";
        ...
        if (data.action == "edit") {
            ...
            nui.ajax({
                ...
                success: function (o) {
                    ...
                    //报销单号
                    nui.get("expno").setValue(o.csContractsalePay.csContract.expno);
                    //总金额
                    ...
                    nui.ajax({
               		...
               		//thispayedservmon thispayedothmon thispayedprodmon thispayedothmon
               		//employee_grid
               		
               		
               		//dept_grid.setEnabled(false);
               		//employee_grid.setEnabled(true);
                }
            });
        }else{
