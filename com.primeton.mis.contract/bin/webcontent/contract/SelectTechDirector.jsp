...
<body>
    ...
    <div class="nui-fit">
        ...
        <div id="grid1" class="nui-datagrid" style="width:100%;height:100%;" 
            idField="id" allowResize="true" dataField="emps" multiSelect="false"
            borderStyle="border-left:0;border-right:0;" onrowdblclick="onRowDblClick"
        >
            <div property="columns">
        		<div type="checkcolumn"></div>
                <div type="indexcolumn" ></div>
                <div field="empname" width="120" headerAlign="center" allowSort="true">姓名</div>    
	...
	<script type="text/javascript">
	    ...
	    //动态设置URL
	    var url="com.primeton.mis.contract.contract.queryTechDirector.biz.ext";
	    grid.setUrl(url);
