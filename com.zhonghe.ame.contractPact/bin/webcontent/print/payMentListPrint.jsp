					...
					<div style="padding: 5px;">
						...
						<tr>
							...
							<td><input name="createUserid" id="createUserid"
								class="nui-hidden" style="width: 230px" /> <input
								id="createUsername" class="nui-textbox" enabled="false"
								style="width: 230px"  /></td>
							<td align="right" style="width: 140px">申请部门：</td>
							<td><input id="orgname" name="orgname" enabled="false"
								class="nui-textbox" style="width: 230px" /></td>
						</tr>
						<tr>
							...
							<td><input id="contractId" name="contractId" enabled="false"
								class="nui-textbox" style="width: 230px" /></td>
						</tr>
						<tr>
							<td align="right" style="width: 140px">合同性质：</td>
							<td><input name="contractNature" class="nui-dictcombobox"
								enabled="false" dictTypeId="CONTRACT_NATURE"
								style="width: 230px" /></td>
							<td align="right" style="width: 140px">合同类型：</td>
							<td><input name="contractType" class="nui-dictcombobox"
								enabled="false" dictTypeId="ZH_CONTRACT_TYPE"
								style="width: 230px" /></td>
						</tr>
						<tr>
							<td align="right" style="width: 140px">付款方：</td>
							<td><input id="payer" name="payer" class="nui-dictcombobox"
								dictTypeId="PAYER" style="width: 230px" 
								enabled="false" /></td>
							<td align="right" style="width: 160px">合同金额(元)：</td>
							<td><input id="contractSum" name="contractSum"
								class="nui-textbox" style="width: 230px" 
								enabled="false" /></td>
						</tr>
						<tr>
							<td align="right" style="width: 140px">累计已付金额(元)：</td>
							<td><input id="paidContractSum" name="paidContractSum"
								class="nui-textbox" style="width: 230px" required="false"
								enabled="false" /></td>
							<td align="right" style="width: 140px">本次支付金额(元)：</td>
							<td><input id="applyPayContractSum"
								name="applyPayContractSum" class="nui-textbox"
								style="width: 230px"  enabled="false"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input id="endTime" name="endTime"
								class="nui-datepicker" style="width: 230px" 
								enabled="false" /></td>
							<td align="right" style="width: 140px">收款单位：</td>
							<td><input id="signatoryname" name="signatoryname"
								enabled="false" class="nui-textbox" style="width: 230px" /></td>
						</tr>
						<tr>
							...
							<td><input id="account" name="account" enabled="false"
								class="nui-textbox" style="width: 230px" /></td>
						</tr>
						<tr>
