	...
	<div class="nui-panel" title="发票管理" style="width: 100%; height: 100%">
			...
			<div class="nui-toolbar" style="border-bottom: 0; padding: 0px;">
				<table align="center" border="0" width="100%" class="form_table">
					<tr>
						...
						<td colspan="1"><input name="critria._expr[1]._value"
							class="nui-textbox" style="width: 65%;" id="createname" /> <input
							class="nui-hidden" name="critria._expr[1]._property"
							value="empname" /> <input class="nui-hidden"
							name="critria._expr[1]._op" value="like" /> <input
							name="critria._expr[2]._value" class="nui-hidden"
							id="createUserid" /> <input class="nui-hidden"
							name="critria._expr[2]._property" value="createUserid" /></td>
						...
						<td colspan="1"><input class="nui-hidden"
							name="critria._expr[5]._op" value="between" /> <input
							class="nui-hidden" name="critria._expr[5]._pattern"
							value="yyyy-MM-dd" /> <input class="nui-hidden"
							name="critria._expr[5]._property" value="createTime" /> <input
							class="nui-datepicker" name="critria._expr[5]._min" /> <span
							style="border-spacing: 0px; padding-left: 0.2em; padding-right: 0.2em;">至</span>
							<input class="nui-datepicker" name="critria._expr[5]._max" /></td>
					</tr>
					<tr>
						...
						<td colspan="1"><input id="orgid2"
							...
							name="critria._expr[7]._property" value="implementOrg" /> <input
							class="nui-hidden" name="critria._expr[7]._op" value="in" /> <input
							class="nui-hidden" name="critria._expr[7]._value" id="orgids2" />
						</td>
						<td class="form_label" align="right">发票抬头:</td>
						<td colspan="1"><input name="critria._expr[8]._value"
							class="nui-dictcombobox" style="width: 65%;"
							dictTypeId="ZH_FLOW_TYPE" nullItemText="全部"
							showNullItem="true" /> <input class="nui-hidden"
							name="critria._expr[8]._property" value="appStatus" /> <input
						...
						<td colspan="1"><input name="critria._expr[9]._value"
							...
							value="payerName" /> <input class="nui-hidden"
							name="critria._expr[9]._op" value="like" /></td>
						
						<td class="form_label" align="right">开票金额（元）:</td>
						<td colspan="1"><input name="critria._expr[10]._value"
							class="nui-textbox" style="width: 65%;" /> <input
							class="nui-hidden" name="critria._expr[10]._property"
							value="invoiceSum" /> <input class="nui-hidden"
							name="critria._expr[10]._op" value="=" /></td>
					</tr>
					<tr>
						<td class="form_label" align="right">账面收入（元）:</td>
						<td colspan="1"><input name="critria._expr[11]._value"
							class="nui-textbox" style="width: 65%;" /> <input
							class="nui-hidden" name="critria._expr[11]._property"
							value="bookIncome" /> <input class="nui-hidden"
							name="critria._expr[11]._op" value="=" /></td>
						<td class="form_label" align="right">回款金额（元）:</td>
						<td colspan="1"><input name="critria._expr[12]._value"
							class="nui-textbox" style="width: 65%;" /> <input
							class="nui-hidden" name="critria._expr[12]._property"
							value="receivableSum" /> <input class="nui-hidden"
							name="critria._expr[12]._op" value="=" /></td>
						<td class="form_label" align="right">专业类别:</td>
						<td colspan="1"><input name="critria._expr[13]._value"
							class="nui-dictcombobox" style="width: 65%;"
							dictTypeId="ZH_MAJOR_TYPE" nullItemText="全部"
							showNullItem="true" /> <input class="nui-hidden"
							name="critria._expr[13]._property" value="major" /> <input
							class="nui-hidden" name="critria._expr[13]._op" value="=" /></td>
						<td class="form_label" align="right">回款日期:</td>
						<td colspan="1"><input class="nui-hidden"
							name="critria._expr[14]._op" value="between" /> <input
							class="nui-hidden" name="critria._expr[14]._pattern"
							value="yyyy-MM-dd" /> <input class="nui-hidden"
							name="critria._expr[14]._property" value="receivableData" /> <input
							class="nui-datepicker" name="critria._expr[14]._min" /> <span
							style="border-spacing: 0px; padding-left: 0.2em; padding-right: 0.2em;">至</span>
							<input class="nui-datepicker" name="critria._expr[14]._max" /></td>
					</tr>
					<tr>
						<td class="form_label" align="right">工程类别:</td>
						<td colspan="1"><input name="critria._expr[15]._value"
							class="nui-dictcombobox" style="width: 65%;"
							dictTypeId="ZH_PROJECT_TYPE" nullItemText="全部"
							showNullItem="true" /> <input class="nui-hidden"
							name="critria._expr[15]._property" value="projectType" /> <input
							class="nui-hidden" name="critria._expr[15]._op" value="=" /></td>
						<td class="form_label" align="right">集团内/外:</td>
						<td colspan="1"><input name="critria._expr[16]._value"
							class="nui-dictcombobox" style="width: 65%;"
							dictTypeId="ZH_GROUP" nullItemText="全部"
							showNullItem="true" /> <input class="nui-hidden"
							name="critria._expr[16]._property" value="headquarterGroup" /> <input
							class="nui-hidden" name="critria._expr[16]._op" value="=" /></td>
						<td class="form_label" align="right">用途:</td>
						<td colspan="1"><input name="critria._expr[17]._value"
							class="nui-dictcombobox" style="width: 65%;"
							dictTypeId="INVOICE_USED" nullItemText="全部"
							showNullItem="true" /> <input class="nui-hidden"
							name="critria._expr[17]._property" value="invoiceUsed" /> <input
							class="nui-hidden" name="critria._expr[17]._op" value="=" /></td>
						<td class="form_label" align="right">发票类型:</td>
						<td colspan="1"><input name="critria._expr[18]._value"
							class="nui-dictcombobox" style="width: 65%;"
							dictTypeId="MIS_MA_INVOICETYPE" nullItemText="全部"
							showNullItem="true" /> <input class="nui-hidden"
							name="critria._expr[18]._property" value="invoiceType" /> <input
		...
		<div id="datagrid1" frozenStartColumn="0" sizeList="[10,20,50,100]"
			...
			<div property="columns">
				...
				<div field="verification" width="100" align="center"
