						...
						<table style="table-layout: fixed;">
							<tr>
								<td align="right" style="width: 140px">合同名称：</td>
									<td colspan="7"><input id="contractName"  name="contractName" enabled="false" class="nui-textbox" style="width: 100%"/></td>
							</tr>
							<tr>
							<td class="form_label" align = "right"> 申请人：</td>
								<td>
									<input name="createUserid"  id="createUserid" class="nui-hidden" style="width: 230px"/>
									<input id="createUsername"  class="nui-textbox" enabled="false" style="width: 230px" required="true"/>
								</td>
							<td align="right" style="width:130px">申请日期：</td>
								<td><input id="createTime" name="createTime"  enabled="false" class="nui-textbox" style="width: 230px"/></td>
							</tr>
							<tr>
							<td align="right" style="width: 140px">签约方：</td>
									<td><input id="signatoryname" name="signatoryname"  enabled="false" class="nui-textbox" style="width: 230px"/></td>
							
								<td align="right" style="width: 140px">付款方：</td>
									<td><input id="payer" name="payer"  class="nui-dictcombobox" dictTypeId="ZH_INVOICE_NAME_TYPE" style="width: 230px" required="true" enabled="false"/></td>
							</tr>
							<tr>
								<td align="right" style="width: 140px">合同类型：</td>
								<td><input name="contractType"  class="nui-dictcombobox" enabled="false" dictTypeId="ZH_CONTRACT_TYPE" style="width: 230px"/></td>
								<td align="right" style="width: 140px">合同编号：</td>
									<td><input id="contractId"   name="contractId" enabled="false" class="nui-textbox" style="width: 230px"/></td>
							</tr>
							<tr>
								<td align="right" style="width: 140px">累计已付金额(元)：</td>
									<td><input id="paidContractSum"  name="paidContractSum" enabled="false" class="nui-textbox" style="width: 230px" required="true"/></td>
								<td align="right" style="width: 140px">合同金额(元)：</td>
									<td><input id="contractSum"  name="contractSum" enabled="false" class="nui-textbox" style="width: 230px" required="true"/></td>
							</tr>
							<tr>
								
								<td align="right" style="width: 140px">累计已付金额大写：</td>
									<td><input id="paidContractSumCapital"  name="paidContractSumCapital" enabled="false" class="nui-textbox" style="width: 230px"/></td>
								<td align="right" style="width: 140px">合同金额大写：</td>
									<td><input id="contractSumCapital"  name="contractSumCapital" enabled="false" class="nui-textbox" style="width: 230px" required="true"/></td>
							</tr>
							<tr>
								<td align="right" style="width:130px">本次支付金额(元)：</td>
									<td><input id="applyPayContractSum"  name="applyPayContractSum" enabled="false" class="nui-textbox" style="width: 230px"/></td>
								<td align="right" style="width: 140px">采购计划编号：</td>
									<td><input id="purchasePlan"  name="purchasePlan" enabled="false" class="nui-textbox" style="width: 230px"/></td>
							</tr>
							<tr>
								<td align="right" style="width:130px">本次支付金额大写：</td>
								<td><input id="applyPayContractSumCapital"  name="applyPayContractSumCapital" enabled="false" class="nui-textbox" style="width: 230px"/></td>
								<td align="right" style="width: 140px">最晚付款日期：</td>
								<td >
									<input name="endTime" id="endTime"  class="nui-textbox" enabled="false" style="width: 230px;" />
								</td>
							</tr>
							<tr>
								<td align="right" style="width: 140px">收款单位开户行名称：</td>
								<td >
									<input name="accountName"  id="accountName" class="nui-textbox" enabled="false" style="width: 230px;" />
								</td>
								<td align="right" style="width: 140px">开户行账号：</td>
								<td >
									<input name="account"  id="account" class="nui-textbox" enabled="false" style="width: 230px;" />
								</td>
							</tr>
						</table>
					</div>
	...
	function setData(){
		...
		nui.ajax({
	            ...
	            success: function (o) {
	            	...
	            	nui.get("applyPayContractSumCapital").setValue(numberParseChina(data.applyPayContractSum));
	            	nui.get("contractSumCapital").setValue(numberParseChina(data.contractSum));
					...
					form.setEnabled(false);
					 ...
					 grid_0.load({"groupid":"PAY_MENT","relationid":id});
