...
<div title="收费合同打印" style="height: auto" >
	<div id="pipi" class="nui-panel" 
			style="font-size: 13px; width: 840px; height: 30px; margin: 0 auto;text-align: center;"  align="left"></div>
	<div class=""  
			style="width: 788px;margin: 0 auto;font-size: 14px;border:1px solid #999999;<!--height: 700px-->">
					...
					<div style="padding: 5px;">
						...
						<tr>
							...
							<td><input name="implementOrg" id="implementOrg"
								...
								class="nui-textbox" style="width: 200px" enabled="false" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input id="contractModel" name="contractModel"
								...
								style="width: 200px" enabled="false" /></td>
						...
						<tr>
							...
							<td><input id="payee" name="payee" class="nui-dictcombobox"
								dictTypeId="ZH_INVOICE_NAME_TYPE" enabled="false"
								style="width: 200px" /></td>
							<td align="right" style="width: 160px">合同文本密级:</td>
							<td><input id="contractSecretLevel" name="contractSecretLevel"
								class="nui-dictcombobox" dictTypeId="CONTRACT_SECRET_LEVEL"
								style="width: 200px" enabled="false" /></td>
						</tr>
						<tr>
							...
							<td><input id="isfb" name="isfb"
								class="nui-dictcombobox" dictTypeId="ABF_YESORNO"
								style="width: 200px" enabled="false" /></td>
						</tr>
						<tr>
							...
							<table style="table-layout: fixed;">
								<tr>
									...
									<td align="right" style="width: 100px">签订日期：</td>
										<td><input id="signingDate" name="signingDate"  class="nui-textbox" style="width: 200px" required="true"/></td>
								</tr>
							</table>
					</div>
				</form>
				<!--  <div title="未来年度收款计划">
			<p style="color: red;font-weight: bold;">未来年度收款计划:</p>
	...
	function setData(){
		...
		nui.ajax({
	            ...
	            success: function (o) {
					...
					grid_0.load({"groupid":"CHARGE_CONTRACT","relationid":id});
