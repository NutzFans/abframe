				...
				<div style="padding: 5px;">
					<table style="table-layout: fixed;">
						<tr>
							...
							<td style="width: 20%;">
								<input name="implementOrg" id="implementOrg" class="nui-combobox" valueField="orgid" textField="orgname" style="width: 200px" shownullitem="false" allowinput="true" required="true"
									enabled="false" />
						...
						<tr>
							...
							<td>
								<input id="originalContractNo" enabled="false" class="nui-textbox" style="width: 200px" required="true" />
							</td>
							<td align="right" style="width: 130px">合同名称：</td>
							<td>
								<input id="originalContractName" name="originalContractName" enabled="false" class="nui-textbox" style="width: 200px" required="true" />
							</td>
						...
						<tr>
							...
							<td>
								<input id="increaseDecreaseSum" name="increaseDecreaseSum" class="nui-textbox" style="width: 200px" required="true" onvaluechanged="onvaluechanged" />
							</td>
							<td align="right" style="width: 120px">合同最终金额(元):</td>
							<td>
								<input name="finalSum" id="finalSum" class="nui-textbox" vtype="float" style="width: 100%" required="true" enabled="false" />
							</td>
						</tr>
						<tr>
