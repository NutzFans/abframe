					...
					<div style="padding: 5px;">
						<table style="table-layout: fixed;">
							<tr>
								...
								<td colspan="7">
									<input name="contractName"  class="nui-textbox" readonly="readonly"  enabled="false"  style="width: 100%" required="true"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
							    ...
							    <td  style="width: 20%;">
									...
									<input name="fDeptCountersignName" id="fDeptCountersignName"  enabled="false" class="nui-textbox" width="100%"/>
								</td>
							    ...
							    <td  style="width: 20%;">
							     	...
							     	<input name="zDeptCountersignName" id="zDeptCountersignName"  enabled="false" class="nui-textbox" width="100%">
								</td> -->
								 <td align="right" style="width: 120px">会签部门领导:</td>
							    <td  colspan="1">
								  	<input id="fDeptCountersignName" name="fDeptCountersignName" enabled="false" class="nui-textbox" style="width: 200px" required="true"/>
