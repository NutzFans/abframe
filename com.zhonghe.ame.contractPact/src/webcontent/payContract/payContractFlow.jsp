					...
					<div style="padding: 5px;">
						...
						<tr>
							...
							<td><input name="contractType" id="contractType"
								class="nui-dictcombobox" dictTypeId="ZH_CONTRACT_TYPE" enabled="false"
						...
						<tr>
							...
							<td><input name="contractSum" id="contractSum"
								class="nui-textbox" vtype="float" style="width: 100%" enabled="false"
						...
						<tr>
							<td align="right" style="width:100px"><nobr>签约方:</nobr></td>
								<td><input name="signatory" id="custId"
									...
									valueFromSelect="true" allowInput="true" style="width: 300px;" enabled="false"/>
								</td>
							...
							<td><input id="contractSubject" name="contractSubject"
								class="nui-dictcombobox" dictTypeId="ZH_INVOICE_NAME_TYPE" enabled="false"
								style="width: 100%" required="true" /></td>
							<td align="right" style="width: 100px">付款方:</td>
							<td><input id="payer" name="payer" class="nui-dictcombobox" enabled="false"
						...
						<tr>
							...
							<td><input id="issm" name="issm" class="nui-dictcombobox"
								dictTypeId="ABF_YESORNO" style="width: 100%" required="true" enabled="false"/></td>
						</tr>
						<tr>
							...
							<td><input name="purchasePlan" id="purchasePlan"
								class="nui-buttonedit" onbuttonclick="onButtonEdit" enabled="false"
						...
						<tr>
							...
							<td><input id="procurementType" name="procurementType"
								...
								style="width: 100%" required="false" enabled="false" /></td>
						...
						<tr>
							...
							<td colspan="5"><input name="remark" class="nui-textarea" enabled="false"
								style="width: 100%" /></td>
						</tr>
						</table>
					</div>
        ...
        function init(){
			...
			nui.ajax({
		        ...
		        success: function (o) {
			            form.setData(o.data);
			            queryPlan(o.data.id);
			           /*  nui.get("userLookup_multiple").setText(o.data.fDeptCountersignName);
						nui.get("userLookup_multiple1").setText(o.data.zDeptCountersignName); */
			            nui.get("backTo").setData(o.data.backList);
						//查询并加载附件
						var grid_0 = nui.get("grid_0");
						if(o.data.issupagreement=="1"){
							grid_0.load({"groupid":"PAY_CONTRACT","relationid":o.data.relateCont});
						}else{
							grid_0.load({"groupid":"PAY_CONTRACT","relationid":o.data.id});
						}
