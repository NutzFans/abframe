...
<div >
    <div id="datagrid1" frozenStartColumn="0"  sizeList="[10,20,50,100]" showPager="true" dataField="proApp" 
    	showSummaryRow="true"  sortMode="client"  ondrawsummarycell="onDrawSummaryCell" onrowdblclick="onRowDblClick"
    	class="nui-datagrid" style="width:100%;height:300px;" url="com.zhonghe.ame.purchase.purchaseProApp.queryProApp.biz.ext" 
