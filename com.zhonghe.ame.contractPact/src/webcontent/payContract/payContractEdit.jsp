						...
						<tr>
							<td align="right" style="width: 120px">合同编号：</td>
								...
								<td align="right" style="width: 100px">签订日期：</td>
									<td><input id="signingDate" name="signingDate"  class="nui-datepicker" style="width: 100%" required="true"/></td>
							<td align="right" style="width: 120px">合同余额(元):</td>
							<td><input name="contractBalance" id="contractBalance"
								class="nui-textbox" vtype="float" style="width: 100%"
								required="true" enabled="true" /></td>
						</tr>
						<tr>
							<td align="right" style="width: 100px">执行状态:</td>
							<td><input id="executeStatus" name="executeStatus"
								class="nui-dictcombobox" dictTypeId="EXECUTE_STATUS"
...
//     			opinion(data);
    			var json = nui.encode({'data':data,"payPlans" : payPlans});
				if(!confirm("是否保存？")){
        				return;
        			}else{	
		    	nui.ajax({
