						...
						<table style="table-layout: fixed;">
							...
							<tr>
								...
								<td><input name="invoiceNameType" id = "invoiceNameType" class="nui-dictcombobox"
									dictTypeId="PAYER" style="width: 300px" required="true" enabled="false"/></td>
								...
								<td><input name="invoiceType" id="invoiceType"
									...
									style="width: 300px" required="true" enabled="false"
								...
								<td><input name="invoiceRate" id="invoiceRate"
									...
									onvaluechanged="editContractSum" value="6" enabled="false"/></td>
							</tr>
							<tr>
								...
								<td colspan="3"><input name="invoiceUsed" id="invoiceUsed"
									...
									style="width: 100%" required="true" enabled="false"/></td>
							...
							<tr>
								...
								<td><input id="invoiceSum" name="invoiceSum" id="invoiceSum"
									...
									required="true" onvaluechanged="editContractSum" enabled="false"/></td>
							...
							<tr>
								...
								<td colspan="8"><input name="payerName" id="payerName"
									class="nui-textbox" style="width: 100%" required="true" enabled="false"
									 /></td>
							</tr>
							<tr>
						...
						<tr>
							...
							<tr>
								...
								<td colspan="8"><input name="invoiceRemark" id="invoiceRemark"
									class="nui-textbox" style="width: 100%" required="false" enabled="false"/></td>
							</tr>
							<tr>
								...
								<td><input id="postFlag" name="postFlag" 
									...
									dictTypeId="ZH_POST" style="width: 300px" required="true" enabled="false"/></td>
								<td align="right" style="width: 160px">发票领取人：</td>
								<td colspan="6"><input name="invoiceUser" id="invoiceUser"
									class="nui-textbox" style="width: 100%" required="true" enabled="false"/></td>
							</tr>
							<tr>
								<td align="right" style="width: 160px">邮寄姓名：</td>
								<td><input name="mailName" id="mailName"
									class="nui-textbox" style="width: 300px" required="true" enabled="false" /></td>
