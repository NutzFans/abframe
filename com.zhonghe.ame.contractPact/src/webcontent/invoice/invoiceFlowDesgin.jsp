...
<body>
	<div style="background-image: url('/default/common/flow/invoiceFlow.png'); width: 1698px; height: 1700px; position: relative;">
		...
		<!-- 分公司领导审批2 -->
		<div id="div5" style="position: absolute; left: 245px; top: 456px; width: 75px; height: 50px; cursor: pointer;"></div>

		<!-- 分公司经营计划部领导审批2 -->
		<div id="div6" style="position: absolute; left: 430px; top: 457px; width: 75px; height: 50px; cursor: pointer;"></div>

		<!-- 承办部门领导项监部审批 -->
		<div id="div7" style="position: absolute; left: 581px; top: 457px; width: 75px; height: 50px; cursor: pointer;"></div>
		...
		<!-- 本部企业发展部领导审批 -->
		<div id="div10" style="position: absolute; left: 119px; top: 885px; width: 75px; height: 50px; cursor: pointer;"></div>

		<!-- 分公司财务开票 -->
		<div id="div11" style="position: absolute; left: 122px; top: 1607px; width: 75px; height: 50px; cursor: pointer;"></div>

		<!-- 分公司财务盖章 -->
		<div id="div12" style="position: absolute; left: 551px; top: 1606px; width: 75px; height: 50px; cursor: pointer;"></div>
		...
		<!-- 企业发展部领导审批 -->
		<div id="div18" style="position: absolute; left: 760px; top: 1017px; width: 75px; height: 50px; cursor: pointer;"></div>

		<!-- 财务部领导审批 -->
		<div id="div19" style="position: absolute; left: 760px; top: 1175px; width: 75px; height: 50px; cursor: pointer;"></div>

		<!-- 财务开票1 -->
		<div id="div20" style="position: absolute; left: 766px; top: 1318px; width: 75px; height: 50px; cursor: pointer;"></div>

		<!-- 财务盖章 -->
		<div id="div21" style="position: absolute; left: 765px; top: 1468px; width: 75px; height: 50px; cursor: pointer;"></div>
	...
	<script type="text/javascript">
		layui.use([ 'jquery', 'layer' ], function() {
			...
			$('#div12').click(function() {
				layer.open({
					title : '分公司财务盖章 - 调整审批人',
					content : '通过【业务字典管理】模块修改类型代码为【KPLC_CWGZ】的字典项数据，修改后【刷新缓存】',
					btn : []
				});
			});
			...
			$('#div21').click(function() {
				layer.open({
					title : '财务盖章 - 调整审批人',
					content : '通过【角色管理】模块修改角色编号为【kpglgz】的角色数据',
					btn : []
				});
			});
