					...
					<div style="padding: 5px;">
						<table style="table-layout: fixed;">
							...
							<tr>
								...
								<td><input name="invoiceNameType" id = "invoiceNameType" class="nui-dictcombobox"
									dictTypeId="PAYER" style="width: 300px" required="true" /></td>
							...
							<tr>
								...
								<td colspan="6"><input name="invoiceUsed" id="invoiceUsed"
						...
						<tr>
							...
							<tr>
								...
								<td><input id="receivableSata" name="receivableSata"
...
//     			opinion(data);
		...
		function finish(appStatus){
			if(appStatus == 2){
				...
				nui.get("receivableSata").enable();
				nui.get("receivableSata").setRequired(true);
				...
				nui.get("receivableSata").setRequired(false);
				nui.get("receivableSata").disable();
			}
		}
