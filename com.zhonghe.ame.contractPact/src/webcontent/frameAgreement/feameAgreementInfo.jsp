						...
						<table style="table-layout: fixed;">
							<tr>
								...
								<td >
									...
									<input id="implementOrgname" class="nui-textbox" enabled="false" style="width: 300px" required="true"/>
								</td>
							...
							<tr>
								<td align="right" style="width: 120px">合同名称：</td>
									<td><input name="contractName"  class="nui-textbox" style="width: 300px" /></td>
									<td align="right" style="width: 100px">协议金额（元）：</td>
									<td><input name="contractSum"  class="nui-textbox" style="width: 300px" /></td>
								<td align="right" style="width: 130px">签约方：</td>
									<td>
									<input
										name="signatory" class="nui-combobox" 
										url="com.zhonghe.ame.chargeContract.chargeContract.queryCusts.biz.ext"
										filterType="like" textField="custname" valueField="custid"
										dataField="custs" valueFromSelect="true"   style="width: 300px;" />
									</td>
							...
							<tr>
								...
								<td align="right" style="width:160px">合同起始日期：</td>
									<td><input name="startTime"  class="nui-datepicker" style="width: 300px" /></td>
								<td align="right" style="width:160px">合同结束日期：</td>
									<td><input name="endTime"  class="nui-datepicker" style="width: 300px" /></td>
							...
							<tr>
								...
								<td>
									<input name="zDeptCountersignName" id="zDeptCountersignName"  class="nui-textbox" style="width: 300px"/>
								</td>
							</tr>
							<tr>
