...
<div class="nui-fit">
	...
	<div id="datagrid1" sizeList="[10,20,50,100]" showPager="true" dataField="data" 
		...
		class="nui-datagrid" style="width:100%;height:90%;" url="standingBookReportForms.standingBookReportForms.queryReportFormsMonthlyPlanAll.biz.ext" 
		multiSelect="true" allowSortColumn=true frozenStartColumn="0" frozenEndColumn="4">
		<div property="columns">
			<div name="temp123" type="checkcolumn"></div>
				...
				<div field="plannedIncome" width="130" align="center" headerAlign="center" allowSort="true" dataType="string" summaryType="sum">计划收入（不含税）</div>
				<div field="january"  align="center" headerAlign="center" allowSort="true" dataType="string" summaryType="sum">1月</div>
				<div field="february"  align="center" headerAlign="center" allowSort="true" dataType="string" summaryType="sum">2月</div>
				<div field="march"  align="center" headerAlign="center" allowSort="true" dataType="string" summaryType="sum">3月</div>
				<div field="april"  align="center" headerAlign="center" allowSort="true" dataType="string" summaryType="sum">4月</div>
				<div field="may"  align="center" headerAlign="center" allowSort="true" dataType="string" summaryType="sum">5月</div>
				<div field="june"  align="center" headerAlign="center" allowSort="true" dataType="string" summaryType="sum">6月</div>
				<div field="july"  align="center" headerAlign="center" allowSort="true" dataType="string" summaryType="sum">7月</div>
				<div field="august"  align="center" headerAlign="center" allowSort="true" dataType="string" summaryType="sum">8月</div>
				<div field="september"  align="center" headerAlign="center" allowSort="true" dataType="string" summaryType="sum">9月</div>
				<div field="october"  align="center" headerAlign="center" allowSort="true" dataType="string" summaryType="sum">10月</div>
				<div field="november"  align="center" headerAlign="center" allowSort="true" dataType="string" summaryType="sum">11月</div>
				<div field="december"  align="center" headerAlign="center" allowSort="true" dataType="string" summaryType="sum">12月</div>
			</div>
		</div>
	</div>
</div>
...
//     		}
	    ...
	    function onDrawSummaryCell(e) {
		    ...
		    if (e.field == "plannedIncome"||e.field == "january"||e.field == "february"||e.field == "march"||e.field == "april"
		    ||e.field == "may"||e.field == "june"||e.field == "july"||e.field == "august"||e.field == "september"
		    ||e.field == "october"||e.field == "november"||e.field == "december") {
		    	e.cellHtml = "<span style='display: block;font-weight: bold;text-align: right;'>" + e.value + "</span>";
		    }
		}
	...
	function exportExcel(){
		if(!confirm("是否确认导出？")){
			...
			nui.ajax({
    			url: "standingBookReportForms.standingBookReportForms.exportMonthlyPlan.biz.ext",
		        type: "post",
		        data: json,
		        cache: false,
		        contentType: 'text/json',
