...
<body>
    <div  id="form1">
        <input class="nui-hidden" name="critria._entity" value="standingBookReportForms.standingBookReportForms.ZhReportFormspayContractEntity"/>
...
<!-- 	        </div> -->
		  <div class="nui-toolbar" style="border-bottom:0;padding:0px;">
		      ...
		      <tr>
		          ...
		          <td colspan="1">
					<input class="nui-dictcombobox" dictTypeId="ZH_CONTRACT_TYPE" name="map.contractType" shownullItem="true" nullItemText="全部" style="width:100%;" />
		          </td>	
		      	 <td class="form_label" align = "right">付款年份:</td>
		          <td colspan="1">
					<input class="nui-textbox" name="map.payYear" id="payYear" style="width:100%;" />
		          </td>	
		      </tr>
			  <tr>
    ...
    <div class="nui-fit">
    <div id="datagrid1" sizeList="[10,20,50,100]" showPager="true" dataField="data" pageSize="15" showSummaryRow="true"  sortMode="client"  ondrawsummarycell="onDrawSummaryCell"
    	class="nui-datagrid" style="width:100%;height:95%;" url="standingBookReportForms.standingBookReportForms.queryReportFormsPayContractAll.biz.ext" 
        ...
        <div type="indexcolumn" width="40" align="center" headerAlign="center">序号</div>
            ...
            <div field="orgname" width="240" align="center" headerAlign="center" allowSort="true" >合同实施部门</div>
            
            <div field="cachet"  align="center" headerAlign="center" allowSort="true" renderer="zhInvoiceNameType">合同专用章</div>
            <div field="payer" align="center" headerAlign="center" allowSort="true" renderer="zhInvoiceNameType">付款方</div>
            <div field="signatoryname" align="center" headerAlign="center" allowSort="true" width="210">签约方</div>
            
            <div field="contractType" align="center" headerAlign="center" allowSort="true" width="150" renderer="zhContractType">合同类型</div>
            ...
            <div header="各月付款记录" headerAlign="center">
	                <div property="columns">
...
<script type="text/javascript">
    	...
    	function init(){
	    	...
	    	nui.get("payYear").setValue(nowYear)
	    	search()
    	} */
    	...
    	function init(){
			...
			var json = {"code":"ffhttzbb","map":{"property":"status","op":"=","value":"running"}};
    		nui.ajax({
...
//     		}
	...
	function exportExcel(){
		if(!confirm("是否确认导出？")){
			...
			nui.ajax({
    			url: "standingBookReportForms.standingBookReportForms.exportPayContract.biz.ext",
		        type: "post",
		        data: json,
		        cache: false,
		        contentType: 'text/json',
