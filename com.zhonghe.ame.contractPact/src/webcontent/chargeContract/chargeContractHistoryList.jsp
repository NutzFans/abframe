...
<body>
	<div class="nui-panel" title="合同协议变更历史" style="width:100%;">
        <div  id="form1">
        <input class="nui-hidden" name="critria._entity" value="com.zhonghe.ame.chargeContract.chargeContract.ZhChargeContractAlterationEnitity"/>
...
<!-- 		      </tr> -->
    ...
    <div id="datagrid1" frozenStartColumn="0"  sizeList="[10,20,50,100]" showPager="true" dataField="data" 
    	...
    	class="nui-datagrid" style="width:100%;height:400px;" url="com.zhonghe.ame.chargeContract.chargeContract.queryChargeContractAlterationAll.biz.ext" 
