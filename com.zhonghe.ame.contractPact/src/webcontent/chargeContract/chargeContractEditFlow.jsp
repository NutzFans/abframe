					...
					<div style="padding: 5px;">
						...
						<tr>
							...
							<td><input id="major" name="major" class="nui-dictcombobox"
								dictTypeId="ZH_MAJOR_TYPE" style="width: 300px" required="true" enabled="false"/></td>
						...
						<tr>
							...
							<td><input name="contractSum" id="contractSum" class="nui-textbox"
								vtype="float" style="width: 300px" required="true" onvaluechanged="editContractSum" enabled="false"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input name="signatory" id="custId" class="nui-combobox"
								...
								pinyinField="custtype" style="width: 100%;" enabled="false"
								 /></td>
							<td align="right" style="width: 100px">合同签约主体：</td>
							<td><input id="contractSubject" name="contractSubject"
								class="nui-dictcombobox" dictTypeId="PAYER" enabled="false"
						...
						<tr>
							...
							<td><input id="payee" name="payee" class="nui-dictcombobox"
								dictTypeId="PAYER" style="width: 100%" required="true" enabled="false"/></td>
