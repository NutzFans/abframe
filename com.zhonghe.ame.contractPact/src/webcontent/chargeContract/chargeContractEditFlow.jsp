					...
					<div style="padding: 5px;">
						<table style="table-layout: fixed;">
							...
							<tr>
								...
								<!-- <td><input id="projectType" name="projectType" enabled="false" class="nui-textbox" style="width: 200px" required="true"/></td> -->
								...
								<td align="right" style="width: 100px">集团内外：</td>
									<td><input id="headquarterGroup" name="headquarterGroup"  class="nui-dictcombobox" enabled="false" dictTypeId="ZH_GROUP" style="width: 200px" required="true"/></td>
							...
							<tr>
								...
								<!-- <td align="right" style="width: 160px">合同增加金额（元）：</td>
									<td><input id="increaseDecreaseSum" name="increaseDecreaseSum" enabled="false" class="nui-textbox" style="width: 200px"/></td> -->
							</tr>
