...
<div  id="form1">
        	...
        	<tr>
                <td style="width:20%;">
		           ...
		           <a class="nui-button" id="sfhtlist_del" iconCls="icon-remove" onclick="deleteInfo()">删除</a>
		            ...
		            <!-- 
		            <a class="nui-button" id="sfhtlist_kpsq" iconCls="icon-add" onclick="invoiceAdd()">发起开票申请</a>
		            <a class="nui-button" id="sfhtlist_kpsq_bc" iconCls="icon-edit" onclick="editInvoiceAdd()">补充开票申请</a>
		            -->
    ...
    <div id="datagrid1" sizeList="[10,20,50,100]" showPager="true" dataField="data" 
    	...
    	multiSelect="true" allowSortColumn=true frozenStartColumn="0" frozenEndColumn="5" ondrawcell="setBackGroundColor">
