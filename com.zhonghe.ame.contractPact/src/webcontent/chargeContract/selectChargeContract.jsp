						...
						<table style="table-layout: fixed;">
							...
							<tr>
								<td align="right" style="width: 100px">专业类别：</td>
									<td><input id="major" name="major" enabled="false" class="nui-dictcombobox" dictTypeId="ZH_MAJOR_TYPE" style="width: 100%" required="true"/></td>
								<td align="right" style="width: 100px">工程类别：</td>
									<td><input id="projectType" name="projectType" enabled="false" class="nui-dictcombobox" dictTypeId="ZH_PROJECT_TYPE" style="width: 100%" required="true"/></td>
								<td align="right" style="width: 100px">集团内外：</td>
									<td><input id="headquarterGroup" enabled="false" name="headquarterGroup"  class="nui-dictcombobox" dictTypeId="ZH_GROUP" style="width: 100%" required="true"/></td>
							</tr>
							<tr>
								<td align="right" style="width: 100px">合同签约主体：</td>
									<td><input id="contractSubject" name="contractSubject"  class="nui-dictcombobox" dictTypeId="ZH_INVOICE_NAME_TYPE" enabled="false" style="width: 100%"  required="true"/></td>
								<td align="right" >实施地点：</td>
								<td>
									<input id="projectLocal" name="projectLocal" enabled="false" class="nui-textbox" style="width: 100%"/>
								</td>
								<td align="right" >标的规模：</td>
								<td>
							...
							<tr>
								...
								<td>
									<input id="startTime" name="startTime" enabled="false" class="nui-datepicker" style="width: 100%"/>
								</td>
								<td align="right" style="width:160px">合同结束日期：</td>
									<td><input id="endTime" name="endTime" enabled="false" class="nui-datepicker" style="width: 100%"/></td>
							...
							<td align="right" style="width: 100px">本部会签部门领导：</td>
								...
								<td align="right" style="width: 100px">执行状态：</td>
									<td><input id="executeStatus" name="executeStatus" enabled="false" class="nui-dictcombobox" dictTypeId="ZH_EXECUTESTATUS" style="width: 100%"/></td>
								<td align="right" style="width: 100px">收款方：</td>
									<td><input id="payee" name="payee"  class="nui-dictcombobox" dictTypeId="ZH_INVOICE_NAME_TYPE" enabled="false" style="width: 100%"/></td>
								<td align="right" style="width: 100px">签订日期：</td>
									<td><input id="signingDate" name="signingDate" enabled="false" class="nui-datepicker" style="width: 100%"/></td>
							</tr>
							<tr>
								<td align="right" style="width: 100px">合同期限：</td>
									<td><input id="contractPeriod" name="contractPeriod" enabled="false" class="nui-textbox" style="width: 100%"/></td>
								<td align="right" style="width: 100px">完成时间：</td>
									<td><input id="finishTime" name="finishTime" enabled="false" class="nui-datepicker" style="width: 100%"/></td>
							<td align="right" style="width: 100px">合同专用章：</td>
									<td><input id="cachet" name="cachet" enabled="false" class="nui-dictcombobox" dictTypeId="ZH_INVOICE_NAME_TYPE" style="width: 100%"/></td>
