...
<body>
			...
			<div style="padding: 5px;">
				<table style="table-layout: fixed;">
					<tr>
						...
						<td>
							<input name="years" id="years" class="nui-textbox" vtype="int" style="width: 250px" required="true" enabled="false" emptyText="格式：YYYY" />
						</td>
					</tr>
					<tr>
						<td align="right" style="width: 130px">单位：</td>
						<td>
							<input name="secOrg" id="secOrg" class="nui-dictcombobox" dictTypeId="ZH_OPERATION_INCOME_ORG" style="width: 250px" required="true" enabled="false" />
						</td>
					</tr>
					<tr>
	...
	<script type="text/javascript">
		...
		function onOk() {
			...
			ajaxCommon({
				"url" : "com.zhonghe.ame.contractPact.statisticalReport.editOrgDimThreshold.biz.ext",
				"data" : json,
				"success" : function(o) {
					if (o.result == "1") {
						showTips("编辑成功");
