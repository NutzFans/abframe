...
<body>
			...
			<div style="padding: 5px;">
				<table style="table-layout: fixed;">
					...
					<tr>
						...
						<td>
							<input name="major" id="major" class="nui-dictcombobox" dictTypeId="ZH_OPERATION_INCOME_MAJOR" style="width: 250px" required="true" />
						</td>
					</tr>
					<tr>
	...
	<script type="text/javascript">
		...
		function onOk() {
			...
			ajaxCommon({
				"url" : "com.zhonghe.ame.contractPact.statisticalReport.addMajorDimThreshold.biz.ext",
				"data" : json,
				"success" : function(data) {
					if (data.result == "0") {
						...
						showTips("该专业类别在该年度已配置门槛值及期望值！", "danger");
					} else {
