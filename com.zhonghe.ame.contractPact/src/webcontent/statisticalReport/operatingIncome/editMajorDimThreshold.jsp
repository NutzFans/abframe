...
<body>
			...
			<div style="padding: 5px;">
				<table style="table-layout: fixed;">
					...
					<tr>
						...
						<td>
							<input name="major" id="major" class="nui-dictcombobox" dictTypeId="ZH_OPERATION_INCOME_MAJOR" style="width: 250px" required="true" enabled="false" />
						</td>
					</tr>
					<tr>
	...
	<script type="text/javascript">
		...
		function onOk() {
			...
			ajaxCommon({
				"url" : "com.zhonghe.ame.contractPact.statisticalReport.editMajorDimThreshold.biz.ext",
				"data" : json,
				"success" : function(o) {
					if (o.result == "1") {
						showTips("编辑成功");
