...
<body>
			...
			<div class="nui-toolbar" style="border-bottom: 0; padding: 5px;">
				<table>
					<tr>
						...
						<td style="width: 155px">
							<input name="criteria._expr[5]._value" class="nui-combobox" url="com.zhonghe.ame.chargeContract.chargeContract.queryCusts.biz.ext" filterType="like" textField="custname"
	...
	<div id="invoiceInfo" style="display: none;">
		<div id="invoiceGrid" sizeList="[5]" dataField="invoiceInfos" pageSize="5" class="nui-datagrid" url="com.zhonghe.ame.annualPlan.annualPlan.queryInvoiceByNo.biz.ext" style="width: 710px; height: 203px;">
			<div property="columns">
				<div field="id" headerAlign="center" visible="false">id</div>
