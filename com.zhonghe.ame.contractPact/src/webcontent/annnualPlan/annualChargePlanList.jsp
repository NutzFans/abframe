		...
		<div class="nui-fit">
			<div id="datagrid1" sizeList="[10,20,50,100]" showPager="true" dataField="data" sortMode="client" class="nui-datagrid" style="width: 100%; height: 100%;"
				...
				<div property="columns">
					...
					<div field="signatoryname" width="180" align="center" headerAlign="center" allowSort="true">付款单位</div>
					<div field="payee" width="120" align="center" headerAlign="center" allowSort="true" renderer="PAYER">收款方</div>
					<div field="contractSum" width="120" align="center" headerAlign="center" allowSort="true" summaryType="sum">合同金额（元）</div>
					<div field="income" width="130" align="center" headerAlign="center" allowSort="true" summaryType="sum">计划收入（元）</div>
					<div field="sum" width="130" align="center" headerAlign="center" allowSort="true" summaryType="sum">计划收款金额（元）</div>
