					...
					<div style="padding: 5px;">
						<table style="table-layout: fixed;">
							...
							<tr>
								...
								<td align="right" style="width: 160px">是否由总部审批：</td>
									<td><input id="headQuartersFlag" name="headQuartersFlag"  class="nui-dictcombobox" dictTypeId="ZH_LABOR_DISPATCHING_FLAG" style="width: 200px" required="true" /></td>
							</tr>
						</table>
					</div>
				</form>
        ...
        function init(){
			...
			nui.ajax({
		        ...
		        success: function (o) {
				        ...
				        if(null != data.headQuartersFlag){
							nui.get("headQuartersFlag").setValue(data.headQuartersFlag);
						}
						payMentId = o.data.id;
...
// 					        nui.get("payername").setValue(o.data.orgname);
    ...
    function submitProcess(title){
		...
		function saveRow(){
    	var headQuartersFlag = nui.get("headQuartersFlag").value;
    	if(headQuartersFlag == undefined){
    		nui.alert("请填写是否由总部审批");
    		return;
    	}
    	var form1 = new nui.Form("form1");
    	var json = form1.getData();
    	var payMentObject = {'id':payMentId,'headQuartersFlag':headQuartersFlag}
    		nui.ajax({
