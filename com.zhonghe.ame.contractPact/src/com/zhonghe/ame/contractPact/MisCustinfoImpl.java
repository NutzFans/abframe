...
import com.zhonghe.ame.chargeContract.chargeContract.MisCustinfo;
 ...
 * <ul>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getCustid <em>Custid</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getCustname <em>Custname</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getCustnum <em>Custnum</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getCusttype <em>Custtype</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getIsoem <em>Isoem</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getPostcode <em>Postcode</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getTelephone <em>Telephone</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getFax <em>Fax</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getWebsite <em>Website</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getGrade <em>Grade</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getComments <em>Comments</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getCreateDate <em>CreateDate</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getCreateUserid <em>CreateUserid</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getCustmanager <em>Custmanager</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getAccoutbank <em>Accoutbank</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getAccoutname <em>Accoutname</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getTaxnumb <em>Taxnumb</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getAccountid <em>Accountid</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getCustnature <em>Custnature</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getLicense <em>License</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getLicenseenddate <em>Licenseenddate</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getLegalperson <em>Legalperson</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getOrgnum <em>Orgnum</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getRegistercap <em>Registercap</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getServphone <em>Servphone</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getCompnum <em>Compnum</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getServnum <em>Servnum</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getBusiscope <em>Busiscope</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getSuborg <em>Suborg</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getCompdesc <em>Compdesc</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getThreeago <em>Threeago</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getThreeagoincome <em>Threeagoincome</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getThreeagoprofit <em>Threeagoprofit</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getTwoago <em>Twoago</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getTwoagoincome <em>Twoagoincome</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getTwoagoprofit <em>Twoagoprofit</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getLastyear <em>Lastyear</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getLastyearincome <em>Lastyearincome</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getLastyearprofit <em>Lastyearprofit</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getLastproperty <em>Lastproperty</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getLastpropertynet <em>Lastpropertynet</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getLastfloat <em>Lastfloat</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getLastlongdebt <em>Lastlongdebt</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getLastshortdebt <em>Lastshortdebt</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getLastnetprofit <em>Lastnetprofit</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getMainprod <em>Mainprod</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getAgentprod <em>Agentprod</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getQualify1 <em>Qualify1</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getQualify1exp <em>Qualify1exp</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getQualify2 <em>Qualify2</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getQualify2exp <em>Qualify2exp</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getQualify3 <em>Qualify3</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getQualify3exp <em>Qualify3exp</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getQualifycomm <em>Qualifycomm</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getIssupplier <em>Issupplier</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getCustjc <em>Custjc</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getGroupno <em>Groupno</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getLedgercustid <em>Ledgercustid</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getLedgercustname <em>Ledgercustname</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getEnglishName <em>EnglishName</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getContacts <em>Contacts</em>}</li>
 *   <li>{@link com.zhonghe.ame.chargeContract.chargeContract.impl.MisCustinfoImpl#getCustomertype <em>Customertype</em>}</li>
 * </ul>
 * </p>
 *
 * @extends ExtendedDataObjectImpl;
 *
 * @implements MisCustinfo;
 */

public class MisCustinfoImpl extends ExtendedDataObjectImpl implements com.zhonghe.ame.contractPact.MisCustinfo {
	/**
	 ...
	 * <!-- end-user-doc -->
	 */
	public MisCustinfoImpl(Type type) {
		super(type);
	}
