...
public class WrapChargePlanInfo {
	...
	public DataObject[] wrap(DataObject[] dataObjects) {
		...
		for (int i = 0; i < dataObjects.length; i++) {
			...
			if (StrUtil.isNotBlank(contractNo)) {
				DataObject[] invoices = this.queryInvoiceByNo(contractNo);
	...
	private DataObject[] queryInvoiceByNo(String contractNo) {
		HashMap<String, Object> map = new HashMap<String, Object>();
		map.put("contractNo", contractNo);
		Object[] objects = DatabaseExt.queryByNamedSql("default", "com.zhonghe.ame.annualPlan.annualPlan.queryInvoiceByNo", map);
