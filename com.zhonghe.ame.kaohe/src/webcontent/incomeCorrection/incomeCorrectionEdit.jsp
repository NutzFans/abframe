...
<head>
<title>考核收入修正 - 编辑</title>
</head>
<body>
	<div class="nui-fit" style="padding: 5px;">
		<fieldset id="field1" style="border: solid 1px #aaa;">
			<legend>考核收入修正 - 编辑</legend>
	...
	<script type="text/javascript">
		...
		function setEditData(data){
			...
			initSecOrgCombobox();
			form.setData(data);
			nui.get("secondaryOrg").setValue(data.secondaryOrg);
			nui.get("secondaryOrg").setText(data.secondaryOrgname);
		}
			...
			nui.confirm("确定保存数据吗？", "系统提示", function(action) {
				if (action == "ok") {
					...
					setTimeout(function() {
						...
						ajaxCommon({
							"url" : "com.zhonghe.ame.kaohe.incomeCorrection.editIncomeCorrection.biz.ext",
							data : json,
							contentType : 'text/json',
