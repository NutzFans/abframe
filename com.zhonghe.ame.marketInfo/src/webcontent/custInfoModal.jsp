			...
			<div id='form1'>
				...
				<table style="table-layout:fixed;">
					<tr>
						...
						<td align="left">
		            		<input class="nui-dictcombobox" required="true" name="custinfo.customertype" dictTypeId="ZH_GROUP"  showNullItem="true" nullItemText=""  style="width: 260px;"/>
					    </td>
					    <td align="right">
							公司网址：
						</td>
