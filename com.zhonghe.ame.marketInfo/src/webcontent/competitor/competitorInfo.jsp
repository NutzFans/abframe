...
<body>
	<div class="nui-panel" title="竞争对手信息管理" style="width:100%;height:100%">
		<div id="form1">
			<input class="nui-hidden" name="criteria._entity" value="com.zhonghe.ame.marketInfo.marketInfo.ZhCompetitor"/>
		...
		<div id="datagrid1" class="nui-datagrid" style="width:100%;height:88%" 
			...
			<div property="columns" >
				...
				<div field="custname" width="110"  renderer="lookInfo" allowSort="true"  align='left' headerAlign="center" >竞争对手名称</div>
				<div field="customertype" width="50" allowSort="true" headerAlign="center" align='left' renderer="custtype">竞争对手类型</div>
				<div field="address" width="110" allowSort="true" headerAlign="center" align='left'>联系地址</div>
				<div field="telephone" width="50" allowSort="true" headerAlign="center" align='left'>联系电话</div>
				<div field="website" width="70" allowSort="true" headerAlign="center" align='left'>公司网址</div>
				<div field="contacts" width="70" allowSort="true" headerAlign="center" align='left'>联系人</div>
