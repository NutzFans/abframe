		...
		<div style="padding:5px;">
			<div id="formcust">
				...
				<tr>
						...
						<td align="right" style="width: 130px;">竞争对手类型：</td>
						<!-- <td >
...
<script type="text/javascript">
    ...
    function SetData(data) {
		...
		//竞争对手基本信息
        nui.ajax({
            url: "com.zhonghe.ame.marketInfo.marketinfo.khxx.commpetior.competionview.biz.ext",
			type: 'POST',
			data: json,	
            ...
            success: function (o) {
             ...
             /* document.getElementById("custname").innerHTML = o.custname== null ? "":o.custname;   
				...
				grid_0.load({"groupid":"ZH_COMPETITOR","relationid":o.custid});
