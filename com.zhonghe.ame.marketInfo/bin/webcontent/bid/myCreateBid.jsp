...
<div  id="form1">
			...
			<table align="center" border="0" width="100%" class="form_table">
				...
				<tr>
					...
					<td colspan="1" style="width: 7%"><input
						...
						style="width: 200px;" dictTypeId="ZH_PROJECT_TYPE" nullItemText="全部"
						showNullItem="true" /> <input class="nui-hidden"
					...
					<td colspan="1" style="width: 7%"><input
						...
						style="width: 200px;" dictTypeId="ZH_MAJOR_TYPE" nullItemText="全部"
						showNullItem="true" /> <input class="nui-hidden"
    ...
    <div class="nui-fit">
	    <div id="datagrid1"  sizeList="[10,20,50,100]" showPager="true" dataField="data"   sortMode="client"  pageSize="50"
	        ...
	        <div property="columns">
	        	...
	        	<div field="serviceType" width="120" align="left" headerAlign="center" allowSort="true" renderer="ZH_PROJECT_TYPE">工程类型</div>
	        	<div field="major" width="120" align="left" headerAlign="center" allowSort="true" renderer="ZH_MAJOR_TYPE">专业类型</div>
