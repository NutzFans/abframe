...
<body>
	<div class="nui-panel" title="竞争对手信息管理" style="width:100%;height:100%">
		<div id="form1">
			<input class="nui-hidden" name="criteria._entity" value="com.zhonghe.ame.marketInfo.marketInfo.queryCompetitor"/>
			<div class="nui-toolbar" style="border-bottom:0;padding:0px;">
				<table style="width:100%;" class="table">
					<tr>
						<td align="right" style="width: 100px;">竞争对手名称：</td>
		            	<td align="left">
						...
						<!-- <td align="right" style="width: 100px;">竞争对手编号：</td>
		            	<td align="left">
						...
						<!--<td align="right" style="width: 100px;">竞争对手类型：</td>
						<td align="left">
		...
		<div id="datagrid1" class="nui-datagrid" style="width:100%;height:88%" 
	    	url="com.zhonghe.ame.marketInfo.marketinfo.khxx.commpetior.querycompetitorinfo.biz.ext" dataField="custinfo" 
			...
			<div property="columns" >
				...
				<div field="custname" width="80"  renderer="lookInfo" allowSort="true"  align='left' headerAlign="center" >竞争对手名称</div>
				<div field="busiscope" width="150" allowSort="true" headerAlign="center" align='left'>简介</div>
				<div field="num" width="20" allowSort="true" headerAlign="center" align='left'>同标项目数</div>
				<div field="comments" width="50" allowSort="true" headerAlign="center" align='left'>备注</div>
	...
	<div id="detailGrid_Form" style="display:none;width:55%">
	    <div id="reve_grid" class="nui-datagrid" dataField="bidCom" showSummaryRow="true"
	    	url="com.zhonghe.ame.marketInfo.marketinfo.khxx.commpetior.getConmpetitor.biz.ext" showPager="false" allowCellEdit="true" allowCellSelect="true" multiSelect="true" editNextOnEnterKey="true">			            
	        <div property="columns">
	            <div field="name"  width="80" headerAlign="center" align="center">项目名称</div>    
	            <div field="price" width="60" headerAlign="center" align="center" >报价/合同价/万元/%</div> 
	        </div>
	    </div>    
	</div>
</body>
<script type="text/javascript">
		...
		function addCustInfo(){
			var addUrl = "<%=request.getContextPath() %>/marketInfo/competitor/addCompetitorInfo.jsp";
			nui.open({
	            url: addUrl,
	            title: "新增竞争对手信息", 
	            width: 1100, 
		...
		function edifCustInfo(){
			...
			var editUrl = '<%=request.getContextPath() %>/marketInfo/competitor/competitorInfoModal.jsp?custid='+selectRow.custid;
			nui.open({
	            url: editUrl,
	            title: "修改竞争对手信息", 
	            width: 1121, 
		...
		function deleteCustInfo(){
			...
			if (row) {
				...
				var c=confirm("该竞争对手信息可以删除，您确认吗？");
				if(c==true){ 
				nui.ajax({
					    url: "com.zhonghe.ame.marketInfo.marketinfo.khxx.commpetior.deleteCompetitorInfo.biz.ext",
						type: 'POST',
						data: data,	
		...
		function doView(){
			...
			var custInfoUrl = "<%=request.getContextPath() %>/marketInfo/competitor/competitorInfoView.jsp?custid=" + selectRow.custid;
