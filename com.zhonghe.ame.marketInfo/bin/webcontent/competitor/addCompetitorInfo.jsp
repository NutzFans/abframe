			...
			<div style="text-align: center" id='form1'>
				...
				<table style="table-layout:fixed;">
					<tr>
						...
						<td>
							<input class="nui-textbox" name="custinfo.custname"  required="true" style="width:750px"/>
						</td>
					</tr>
					<tr>
						...
						<td colspan="7">
							<input name="custinfo.busiscope" id="" class="nui-textarea" style="width:100%;height: 100px;"/>
						</td>
					</tr>
					<tr>
						<td align="right" style="width: 100px">
						...
						<td colspan="7">
							<input name="custinfo.comments" id="" class="nui-textarea" style="width:100%;height: 60px;"/>
						</td>
					</tr>
					<!-- <tr>
		...
		nui.ajax({
            ...
            success: function (o) {
            	if(o.result==1&&cs.custid==''){
            		nui.alert("新增竞争对手信息成功",null,function(){
            			CloseWindow('save');
            		});
            	}else if(o.result==1){
            		nui.alert("修改竞争对手信息成功",null,function(){
            			CloseWindow("save");
			        });
            	}else if(cs.custid==''){
