...
<div class="nui-fit">
	<div class="mini-panel" title="发起资产采购申请" style="width: 100%;">
		...
		<div id="form1">
			<fieldset id="field1" style="border:solid 1px #aaa;padding:3px;">
				...
				<input name="machineApply.applyemp" id="applyemp" class="nui-hidden"/>
	...
	<div style="text-align: center;padding: 10px;" class="nui-toolbar">
		...
		<a class="nui-button" onclick="onOk('2')" id="endProcess" iconCls="icon-no" style="width: 100px;">终止流程</a>
	</div>
</div>
<script type="text/javascript">
		...
		promptInit({workItemID: <%=workItemID %>});//流程提示信息
  		...
  		nui.ajax({//获取资产采购申请信息
      		...
      		success: function (o){
				...
				nui.get("usingemp").setValue(o.machineApply.usingemp);
				nui.get("deptname").setValue(o.machineApply.dept);
				nui.get("projectno").setValue(o.machineApply.projectno);
				...
				onNameFilterChanged(nui.get("storageType").getValue());
			...
			nui.confirm("确定终止流程吗？", "操作提示",
	            function (action) {            
	                if (action == "ok") {
						...
						json = {machineApply:mis.machineApply,misOpinion:misOpinion};
						save(json);
						return;
					}else{
						return;
	...
	function SaveData2(){
		...
		var json ={machineApply:mis.machineApply,misOpinion:misOpinion};
        save(json);
	}
	function  save(data){
		var content;
    	...
    	nui.ajax({
            url: "com.primeton.eos.machine.machineProcess.editMachineApply.biz.ext",
            data: data,
            type: 'POST',
            cache: false,
