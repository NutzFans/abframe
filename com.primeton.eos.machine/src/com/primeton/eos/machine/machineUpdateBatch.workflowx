...
<workflowProcess productVersion="6.1" schemaVersion="6.0">
  <processHeader>
    <processBasicInfo>
      <processId>com.primeton.eos.machine.machineUpdateBatch</processId>
      <processName>资产变更审批流程</processName>
  ...
  <activities>
    ...
    <activity>
      ...
      <activityName>员工发起申请</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <customURL>
            ...
            <urlInfo>/machine/machineModifyBatch2.jsp</urlInfo>
    ...
    <activity>
      ...
      <activityName>接收人确认</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <customURL>
            <isSpecifyURL>true</isSpecifyURL>
            <urlInfo>/machine/accepterAgree.jsp</urlInfo>
            <urlType>webpage</urlType>
          </customURL>
          <resetUrl>
            <isSpecifyURL>false</isSpecifyURL>
          ...
          <triggerEvents>
            <triggerEvent>
              <applicationInfo>
                ...
                <application>
                  <actionType>logic-flow</actionType>
                  <applicationUri>com.primeton.eos.machine.machine.sendAcceptMail</applicationUri>
                  <transactionType>join</transactionType>
                  <exceptionStrategy>rollback</exceptionStrategy>
                  <invokePattern>synchronous</invokePattern>
                  <parameters>
    ...
    <activity>
      ...
      <activityName>行政更改机器信息</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <customURL>
            <isSpecifyURL>true</isSpecifyURL>
            <urlInfo>/machine/adminMachineChange.jsp</urlInfo>
            <urlType>webpage</urlType>
          </customURL>
          <resetUrl>
            <isSpecifyURL>false</isSpecifyURL>
          ...
          <triggerEvents>
            <triggerEvent>
              <applicationInfo>
                ...
                <application>
                  <actionType>logic-flow</actionType>
                  <applicationUri>com.primeton.eos.machine.machine.SendAdminMail</applicationUri>
                  <transactionType>join</transactionType>
                  <exceptionStrategy>rollback</exceptionStrategy>
                  <invokePattern>synchronous</invokePattern>
                  <parameters>
    ...
    <activity>
      ...
      <activityName>自动活动</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
        ...
        <autoActivity>
          ...
          <taskApplication>
            <applicationInfo>
              ...
              <application>
                <actionType>logic-flow</actionType>
                <applicationUri>com.primeton.eos.machine.machine.checkIsAllAgree</applicationUri>
                <transactionType>join</transactionType>
                <exceptionStrategy>rollback</exceptionStrategy>
                <invokePattern>synchronous</invokePattern>
                <parameters>
  ...
  <resource>
    <businessVariables>
      <businessVariable>
        <variableName>是否同意</variableName>
        <xpath>isAgree</xpath>
        <variableUUID>PROCESS:801f2189487047f2b0373799a7298455</variableUUID>
        <description></description>
      </businessVariable>
    </businessVariables>
  </resource>
