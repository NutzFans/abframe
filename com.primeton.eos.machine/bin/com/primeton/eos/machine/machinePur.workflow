...
<workflowProcess productVersion="6.1" schemaVersion="6.0">
  <processHeader>
    <processBasicInfo>
      <processId>com.primeton.eos.machine.machinePur</processId>
      <processName>资产采购申请流程</processName>
    ...
    <dataFields>
      <dataField>
        ...
        <description>是否需要申请借款</description>
      ...
      <dataField>
        ...
        <initialValue></initialValue>
        <description>行政、财务审批</description>
        <isArray>true</isArray>
      </dataField>
      <dataField>
      ...
      <dataField>
        ...
        <dataType>
          <typeClass>sdo</typeClass>
          <typeValue>com.primeton.eos.machine.machine.MisMachineApply</typeValue>
        </dataType>
        <initialValue></initialValue>
        <description>资产申请</description>
        <isArray>false</isArray>
      </dataField>
      <dataField>
        <name>adminPur</name>
  ...
  <transitions>
    ...
    <transition>
      ...
      <priority>60</priority>
      <displayName>区域资产</displayName>
      <type>simpleCondition</type>
      <simpleCondition>
        <leftValueType>variable</leftValueType>
        <leftValue>machineApply/storagetype</leftValue>
    ...
    <transition>
      ...
      <isDefault>false</isDefault>
      <priority>60</priority>
      <displayName>需要借款</displayName>
      <type>simpleCondition</type>
      <simpleCondition>
        <leftValueType>variable</leftValueType>
        <leftValue>isNeedPay</leftValue>
        <compType>EQ</compType>
  ...
  <activities>
    ...
    <activity>
      ...
      <activityName>发起资产采购申请</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <customURL>
            ...
            <urlInfo>/machine/machineProcess/editMachineApply.jsp</urlInfo>
          ...
          <timeLimit>
            ...
            <calendarSet>
              ...
              <calendarInfo>
                ...
                <resourceName>系统初始化日历(5×8小时)</resourceName>
                <parameters/>
              </calendarInfo>
            </calendarSet>
            <timeLimitInfo>
          ...
          <triggerEvents>
            <triggerEvent>
              <applicationInfo>
                ...
                <application>
                  <actionType>logic-flow</actionType>
                  <applicationUri>com.primeton.eos.machine.machineProcess.setWXToAdmin</applicationUri>
                  <transactionType>join</transactionType>
    ...
    <activity>
      ...
      <activityName>行政、财务审批</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <customURL>
            <isSpecifyURL>true</isSpecifyURL>
            <urlInfo>/machine/machineProcess/leaderMachineApply.jsp</urlInfo>
            <urlType>webpage</urlType>
          </customURL>
          <resetUrl>
            <isSpecifyURL>false</isSpecifyURL>
          ...
          <participants>
            ...
            <regularApp>
              ...
              <application>
                <actionType>logic-flow</actionType>
                <applicationUri>com.primeton.eos.machine.machineProcess.setAdminFinace</applicationUri>
                <transactionType>join</transactionType>
                <exceptionStrategy>rollback</exceptionStrategy>
                <invokePattern>synchronous</invokePattern>
                <parameters>
                  ...
                  <parameters>
                    <parameter>
                      ...
                      <variableName>
                        ...
                        <resourceID>8dc553da1ee5452ebc9641965701647d</resourceID>
                    ...
                    <parameter>
                      ...
                      <variableName>
                        <resourceType>business-variable</resourceType>
                        <resourceID>4c9a895afa5b4b7e92b79be18817e96a</resourceID>
                    ...
                    <parameter>
                      ...
                      <variableName>
                        <resourceType>business-variable</resourceType>
                        <resourceID>796f2e4128754289a59e415ac0923d01</resourceID>
    ...
    <activity>
      ...
      <activityName>行政采购</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
        ...
        <manualActivity>
          ...
          <participants>
            ...
            <regularApp>
              ...
              <application>
                <actionType>logic-flow</actionType>
                <applicationUri>com.primeton.eos.machine.machineProcess.setAdmin</applicationUri>
                <transactionType>join</transactionType>
                <exceptionStrategy>rollback</exceptionStrategy>
                <invokePattern>synchronous</invokePattern>
                <parameters>
    ...
    <activity>
      <activityId>manualActivity52</activityId>
      <activityName>财务出款</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <customURL>
            <isSpecifyURL>true</isSpecifyURL>
            <urlInfo>/ame_fee/PaymentApply/finSpApply.jsp</urlInfo>
            <urlType>webpage</urlType>
          </customURL>
          <resetUrl>
            <isSpecifyURL>false</isSpecifyURL>
    ...
    <activity>
      ...
      <activityName>资产交付与入库</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <customURL>
            <isSpecifyURL>true</isSpecifyURL>
            <urlInfo>/machine/machineProcess/adminPurMachineApply.jsp</urlInfo>
            <urlType>webpage</urlType>
          </customURL>
          <resetUrl>
            <isSpecifyURL>false</isSpecifyURL>
          ...
          <participants>
            ...
            <specialActivityID></specialActivityID>
            <specialPath>StorageAdmin</specialPath>
          </participants>
          <formFields/>
          <timeLimit>
            <isTimeLimitSet>false</isTimeLimitSet>
    ...
    <activity>
      ...
      <activityName>使用部门审批</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
