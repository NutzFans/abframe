...
<body>
	...
	<script type="text/javascript">
		...
		function setEditData(data) {
			initSecOrgCombobox();
			form.setData(data);
			nui.get("fillingInOrg").setValue(data.fillingInOrg);
			nui.get("fillingInOrg").setText(data.fillingInOrgName);
		}
			...
			nui.confirm("确定保存数据吗？", "系统提示", function(action) {
				if (action == "ok") {
					...
					setTimeout(function() {
						...
						ajaxCommon({
							"url" : "com.zhonghe.ame.finance.budgetAccount.editBudgetAccount.biz.ext",
							data : json,
							contentType : 'text/json',
