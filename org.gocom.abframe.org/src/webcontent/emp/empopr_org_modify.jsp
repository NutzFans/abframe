...
<script>
    ...
    function initComboEmpParam(){
    	return "<oEmp><orgid>"+$name("oEmporg/omOrganization/orgid").value+"</orgid></oEmp>" ;
    }
...
<h:form name="dataform1" action="org.gocom.abframe.org.employee.EmpOprOrgModify.flow" checkType="blur" target="_self" method="post" onsubmit="return checkForm(this);">
  <input type="hidden" name="_eosFlowAction" value="mdf"/>
    ...
    <table align="center" border="0" width="100%" class="form_table">
      ...
      <tr>
        ...
        <td colspan="1">
          <h:text property="oEmp/cardno" validateAttr="maxLength=20"/>
        </td>        
      </tr>
      <tr>
        <td class="form_label">
      ...
      <tr>
        ...
        <td colspan="1">
          <r:comboSelect id="empList" property="oEmp/major"  
			queryAction="org.gocom.abframe.org.employee.EmpManager.queryEmpByTemplate.biz" nullText="<%=pleaseSelect%>" 
      ...
      <tr>        
        ...
        <td colspan="3">
          <%-- 	
          <h:textarea property="oEmp/orgidlist" cols="50" rows="2" validateAttr="maxLength=128"/>
          --%> 
	...
	<div id="tableDiv">
		...
		<table align="center" border="0" width="100%" class="form_table">
			...
			<tr>
				...
				<td colspan="3"><h:password property="oOpr/password" validateAttr="maxLength=100"/></td>
			</tr>
			<tr>
				<td class="form_label">
				  <!--密码失效日-->
  ...
  <table align="center" border="0" width="100%" class="form_table">  
      <tr class="form_bottom">
        <td colspan="6">
          <input type="button" class="button" value="<b:message key='l_save' />" onclick="javascript:mdfEmpOpr();">
