...
<script>
    ...
    function addEmpOpr() {
        var ajax = new Ajax("org.gocom.abframe.org.employee.EmpManager.addEmpOprPosi.biz");
        ...
        ajax.addParam("oEmp/operatorid", $name("oOpr/operatorid").value );        
        ajax.addParam("oEmp/userid", $name("oOpr/userid").value );
        if( $id("checkOpr").checked ) {
        	ajax.addParam("oOpr/hasopr", "y" );
        }else{
        	ajax.addParam("oOpr/hasopr", "n" );
        }
...
<h:form name="dataform1" action="" checkType="blur" target="_self" onsubmit="return checkForm(this);">
  <h:hidden property="oEmpposi/omPosition/positionid" />
  <h:hidden property="oEmporg/omOrganization/orgid" />
  ...
  <w:panel id="panel1" width="100%" title="<%=empInfo %>">
    <table align="center" border="0" width="100%" class="form_table">
      ...
      <tr>        
        ...
        <td colspan="3">
          <w:lookup property="oEmp/orgidlist" disabled="true" validateAttr="allowNull=true;message=可管理机构可以为空" readonly="true" displayProperty="oEmp/orgidlistname" lookupUrl="/org.gocom.abframe.org.emplyee.MngorgAssign.flow" dialogTitle="<%=selectMngOrg %>" width="350" height="430">
          </w:lookup>
        </td>        
      </tr>
      <tr>
  ...
  <table align="center" border="0" width="100%" class="form_table">  
      <tr class="form_bottom">
        <td colspan="6">
          <input type="button" class="button" value="<b:message key='l_save' />" onclick="javascript:addEmpOpr();">
