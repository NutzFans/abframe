...
<%
	//获取标签中使用的国际化资源信息
	String emp_query = com.eos.foundation.eoscommon.ResourcesMessageUtil.getI18nResourceMessage("workgroupManager_l_title_EmpQuery");
...
%>
  ...
  <body class="eos-panel-table">
    <h:form name="query_form" action="org.gocom.abframe.org.workgroup.GroupEmpAdd.flow" method="post">
      <input type="hidden" name="_eosFlowAction" value="pageQuery"/>
        <table align="center" border="0" width="100%" class="form_table">
          <tr>
	        <td class="form_label">  <!--  登陆名 -->
	           <b:message key="workgroupManager_l_omEmployee.userid"></b:message><b:message key="l_colon"></b:message>
	        </td>
            <td colspan="1">
              <h:text property="empGroup/omEmployee/userid" scope="flow"/>  
            </td>
	        <td class="form_label">  
	          <b:message key="workgroupManager_l_omEmployee.empname"></b:message><b:message key="l_colon"></b:message><!-- 操作员姓名 -->
	        </td>
            <td colspan="1">
              <h:text property="empGroup/omEmployee/empname" scope="flow"/> 
            </td>
          </tr>
          <tr class="form_bottom">
            <td colspan="6" class="form_bottom">
              ...
              <input type="submit" class="button" value="查询">&nbsp;<input type="button" class="button" value='<b:message key="l_reset"></b:message>' onclick="javascript:$name('query_form').reset();">
            </td>
          </tr>
        </table>
    </h:form>
    <h:form name="page_form" action="org.gocom.abframe.org.workgroup.GroupEmpAdd.flow" method="post">
      <input type="hidden" name="_eosFlowAction" value="pageQuery"/>
	  <h:hiddendata property="page" scope="flow"/>
        <table align="center" border="0" width="100%" class="EOS_table">
          <tr>
	       <td colspan="4" class="eos-panel-title">&nbsp;<%=emp_list %></td><!--员工列表 -->
	      </tr>
          <tr>
	        <th align="center">
            ...
            <th>
              <b:message key="workgroupManager_l_omEmployee.userid"></b:message> <!--  登陆名 -->
            </th>
            <th>   <!-- 人员代码 -->
          ...
          <tr>
            <td colspan="5" class="command_sort_area">
              ...
              <l:notEqual property="page/count" targetValue="0" scope="flow">
              		<!--  增加  关闭-->
                  <input type="button" class="button" value="<b:message key='l_add'/>" onclick="addEmpPosition();" id="deleteButton"> <input type="button" class="button" value="<b:message key='l_close'/>" onclick="window.close()">   
          ...
          <div style="float:right">
	            ...
	            <!--首页 上页 下页 尾页 -->
	            <input type="button" class="button" onclick="firstPage('page', 'pageQuery', null, null, 'page_form');" value="<b:message key = 'l_firstPage'/>"  <l:equal property="page/isFirst" targetValue="true" scope="flow" >disabled</l:equal> >
	            <input type="button" class="button" onclick="prevPage('page', 'pageQuery', null, null, 'page_form');" value="<b:message key = 'l_upPage'/>" <l:equal property="page/isFirst" targetValue="true" scope="flow" >disabled</l:equal> >
	            <input type="button" class="button" onclick="nextPage('page', 'pageQuery', null, null, 'page_form');" value="<b:message key = 'l_nextPage'/>" <l:equal property="page/isLast" targetValue="true" scope="flow" >disabled</l:equal> >
	            <l:equal property="page/isCount" targetValue="true" scope="flow" >
	              <input type="button" class="button" onclick="lastPage('page', 'pageQuery', null, null, 'page_form');" value="<b:message key = 'l_lastPage'/>" <l:equal property="page/isLast" targetValue="true" scope="flow" >disabled</l:equal> >
	            </l:equal>
	          </div>
            </td>
          </tr>
