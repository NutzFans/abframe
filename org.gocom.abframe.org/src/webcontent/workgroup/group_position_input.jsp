  ...
  <input type="hidden" name="_eosFlowAction" value="insertSubmit"/>
    <table align="center" border="0" width="100%" class="form_table">
      ...
      <tr>
        ...
        <td colspan="1">																				<!--  选择职务 -->
          <w:lookup property="position/omDuty/dutyid"  readonly="true" displayProperty="position/omDuty/dutyname"  dialogTitle="<%=selectDuty %>"  width="350" height="430" lookupUrl="/abframe/org/duty/duty_tree.jsp" onReturnFunc="lookupRetFun"></w:lookup>
        </td>
      </tr>
      <tr>
        <td class="form_label">
      ...
      <tr class="form_bottom">
        <td colspan="6">
              <input type="button" class="button" value="<b:message key='l_save' />" onclick="savePosition()">
