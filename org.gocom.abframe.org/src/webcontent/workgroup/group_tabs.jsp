...
<%
	...
	String basePosition=com.eos.foundation.eoscommon.ResourcesMessageUtil.getI18nResourceMessage("workgroupManager_l_basePosition");
 %>
...
<l:equal value="<%=defaultTab%>"  targetValue="queryGroup" compareType="string"  >  
		<w:tabPage cache="false" id="queryGroup" tabType="iframe" title="<%=groupQuery%>" url="org.gocom.abframe.org.workgroup.WorkgroupManager.flow">
