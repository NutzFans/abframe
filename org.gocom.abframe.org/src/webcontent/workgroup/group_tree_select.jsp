	...
	<TR>
		...
		<r:rtree id="groupTree" width="346" height="370">
			...
			<r:treeNode
				...
				icon='<%=SkinUtil.getStyleFileForTag("images/abf/group.png",request)%>' submitXpath="group">
			</r:treeNode>
			...
			<r:treeNode
				...
				icon='<%=SkinUtil.getStyleFileForTag("images/abf/position.png",request)%>' submitXpath="position">
			</r:treeNode>

			<r:treeNode childEntities="" nodeType="empList" showField="empname" preload="true" 
				icon='<%=SkinUtil.getStyleFileForTag("images/abf/emp.png",request)%>' submitXpath="emp"> 
			</r:treeNode>

			<r:treeNode childEntities="" nodeType="empOfPositionList" preload="true" 
				showField="empname" icon='<%=SkinUtil.getStyleFileForTag("images/abf/emp.png",request)%>'
				submitXpath="emp">
			</r:treeNode>
		</r:rtree></TD>
	</TR>
