  ...
  <w:panel id="panel1" width="100%" title="<%=title%>"><!--工作组录入 -->
    <table align="center" border="0" width="100%" class="form_table">
      ...
      <tr>
        ...
        <td colspan="1">																										<!--选择隶属机构 -->
          <w:lookup property="group/omOrganization/orgid"   readonly="true" displayProperty="group/omOrganization/orgname"  dialogTitle="<%=selectOrg%>"  width="300" height="450" lookupUrl="/abframe/org/organization/org_tree_select.jsp" ></w:lookup>
        </td>
        <td class="form_label">
