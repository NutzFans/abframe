...
<body scroll="no" onload="init();" leftmargin="0px;" topmargin="0px;" rightmargin="0px;" bottommargin="0px;">
	...
	<TABLE class="form_table" width="100%" height="100%">
	   ...
	   <tr>
			...
			<input type="button" class="button" value='<b:message key="l_cofirm" />' onclick="ok()" /> <!--确定 -->
			</td>
	   </tr>
	</table>
