...
<html>
  ...
  <body leftmargin="0" topmargin="0">
    ...
    <e:datasource name="ompositions" type="entity" path="org.gocom.abframe.dataset.organization.OmPosition" />
   <queryform id="07742845-780d-4774-875c-51359801f278">
  <h:form  name="form1" action="org.gocom.abframe.org.party.PositionQuery.flow" checkType="blur" target="_self" method="post" onsubmit="return checkForm(this);">
  	<h:hidden name="_eosFlowAction" value="pageQuery"/>
    <w:panel id="panel1" width="100%" title="岗位查询条件">
      <table align="center" border="0" width="100%" class="form_table">
        <tr>
          ...
          <td colspan="1">
            <h:text property="criteria/_expr[1]/posicode"/>
          ...
          <td colspan="1">
            <h:text property="criteria/_expr[2]/posiname"/>
        ...
        <tr class="form_bottom">
          <td colspan="4" class="form_bottom">
            <input type="hidden" name="criteria/_entity" value="org.gocom.abframe.dataset.organization.OmPosition">
            每页显示
    ...
    <h:hidden property="criteria/_orderby[1]/_property" value="posiname"/>
  </h:form>
</queryform>
 
    <br/>
    <viewlist id= "80feac2c-5c6d-45e4-8a45-34a99553cf46">
      <h:form name="page_form" action="org.gocom.abframe.org.party.PositionQuery.flow" method="post">
        ...
        <w:panel id="list_panel" width="100%" title="岗位查询结果">
          <table align="center" border="0" width="100%" class="EOS_table">
            ...
            <w:checkGroup id="group1">
              <l:iterate property="ompositions" id="id1">
                <tr class="<l:output evenOutput='EOS_table_row' />">
                  <td align="center">
                    <w:rowCheckbox onSelectFunc="insertSelected">
                      <h:param name='select_objs/positionid' iterateId='id1' property='positionid' indexed='true' />
                      <h:param name="positionid" iterateId='id1' property='positionid'  />
                      <h:param name="posicode" iterateId='id1' property='posicode'  />
                      <h:param name="posiname" iterateId='id1' property='posiname'  />
                    </w:rowCheckbox>
                  </td>
                  <td>
    ...
    <script>
      ...
      function insertSelected(row){
      	...
      	arrTmp[0] = row.getParam("positionid");
      	arrTmp[1] = row.getParam("posicode");
      	arrTmp[2] = row.getParam("posiname");
