...
<html>
  ...
  <body leftmargin="0" topmargin="0">
    ...
    <e:datasource name="omemployees" type="entity" path="org.gocom.abframe.dataset.organization.OmEmployee" />
   <queryform id="07742845-780d-4774-875c-51359801f278">
  <h:form  name="form1" action="org.gocom.abframe.org.party.EmpQuery.flow" checkType="blur" target="_self" method="post" onsubmit="return checkForm(this);">
  	<h:hidden name="_eosFlowAction" value="pageQuery"/>
    <w:panel id="panel1" width="100%" title="人员查询条件">
      <table align="center" border="0" width="100%" class="form_table">
        <tr>
          ...
          <td colspan="1">
            <h:text property="criteria/_expr[1]/empcode"/>
          ...
          <td colspan="1">
            <h:text property="criteria/_expr[2]/empname"/>
    ...
    <h:hidden property="criteria/_orderby[1]/_property" value="empname"/>
  </h:form>
</queryform>
 
    <br/>
    <viewlist id= "80feac2c-5c6d-45e4-8a45-34a99553cf46">
      <h:form name="page_form" action="org.gocom.abframe.org.party.EmpQuery.flow" method="post">
        ...
        <w:panel id="list_panel" width="100%" title="人员查询结果">
          <table align="center" border="0" width="100%" class="EOS_table">
            ...
            <w:checkGroup id="group1">
              <l:iterate property="omemployees" id="id1">
                <tr class="<l:output evenOutput='EOS_table_row' />">
                  <td align="center">
                    <w:rowCheckbox onSelectFunc="insertSelected">
                      ...
                      <h:param name="empcode" iterateId='id1' property='empcode'  />
                      <h:param name="empname" iterateId='id1' property='empname'  />
                    </w:rowCheckbox>
                  </td>
                  <td>
    ...
    <script>
      ...
      function insertSelected(row){
      	...
      	arrTmp[0] = row.getParam("empid");
      	arrTmp[1] = row.getParam("empcode");
      	arrTmp[2] = row.getParam("empname");
