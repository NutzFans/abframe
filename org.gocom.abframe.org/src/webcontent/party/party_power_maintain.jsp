...
<body topmargin="0" leftmargin="0">
    ...
    <TABLE border="0" width="100%" >
		<TR>
		    ...
		    <td>
         	    <input type="button" class="button" value="&nbsp;&gt;&gt;&nbsp;" style="width:30" title="删除" onclick="deleteRecord();"/><br><br>
         	    <input type="button" class="button" value="&nbsp;&lt;&lt;&nbsp;" style="width:30" title="增加" onclick="addRecord();"/>
         	</td>
	...
	<form id="datacellForm">
		        	<h:hidden property="rolefunc/_entity" value="org.gocom.abframe.dataset.organization.AcRolefuncView" />	      
