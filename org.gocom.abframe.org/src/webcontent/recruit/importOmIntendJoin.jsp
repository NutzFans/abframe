...
<body>
	<form id="form2" action="org.gocom.abframe.org.employee.importOmIntendJoin.flow" target="hidden_frame" method="post" enctype="multipart/form-data">
            ...
            <table style="width:100%;">
                ...
                <tr>
			        ...
			        <td style="width:12%;" align="left">
			        	...
			        	<div style="color: red;">（2）手机号码、身份证号等字段单元格格式为文本，标注业务字典的字段格式请和拟入职新增页面下拉框里的内容保持一致，日期的格式为YYYY/MM/DD。</div>
			       	</td>
		        </tr>
		        <tr>
		        	<td style="width:13%;"colspan="5"><a href="/default/abframe/import-template/importOmIntendJoin.xls">点击下载Excel 模板文件</a></td>
		        </tr>
            </table>           
        </div>
        </form>
...
<script type="text/javascript">
	...
	function test(data){
		...
		if(msg =='0'){
			if(succcount>0){
				if(errcount>0){
					alert("导入成功："+succcount+"条,导入失败："+errcount+"条,其中拟入职人员名为："+errormsg+",请确认！");
				}else{
