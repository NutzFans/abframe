    	...
    	<table style="width:100%;">
    		...
    		<tr>
    			<td align="center" colspan="8">
                    ...
                    <a class="nui-button" id="exportPage" iconCls="icon-download" onclick="exportPage()">导出当前页</a>
                    <a class="nui-button" id="exportALL" iconCls="icon-download" onclick="exportALL()">导出所有数据</a>
