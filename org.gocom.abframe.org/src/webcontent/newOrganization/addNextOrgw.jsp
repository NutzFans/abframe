...
<script type="text/javascript">
	...
	function setData(data){
		if(status == '0'){
			...
			//nui.get("acFuncgroup").setValue(data[0].acFuncgroup);
		}
	}
	...
	function save(data){
		if(status=='0'){
			//新增
			nui.ajax({
				url: "org.gocom.abframe.rights.application.FuncGroupManager.addFuncGroup.biz.ext",
				type: 'POST',
				data:data,	
	            ...
	            success: function (result) {
	            	if(result.retCode==1){
	            		...
	            		nui.alert("新增功能组失败啦，请联系信息技术部。");
	            	}
	            }
			})
		}else if(status=='1'){
			//修改
		    var json = {funcGroupUpdate:{funcgroupname:data.funcGroup.funcgroupname,funcgroupid:data.funcgroupid,acFuncgroup:data.funcGroup.acFuncgroup}};
			nui.ajax({
