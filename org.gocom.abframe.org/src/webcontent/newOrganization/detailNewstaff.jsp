...
<div style="height: auto">
	<div class="mini-panel" style="width: 940px;height: auto">
...
<div style="text-align:center;padding:10px;" class="nui-toolbar" id="temp11" style="display:">
		<a class="nui-button" onclick="javascript:doPrint();" iconCls="icon-print" style="width:130px;margin-right:20px;" id="print" >打印试用期目标</a>
		<a class="nui-button"onclick="onCancel" iconCls="icon-close" style="width:60px;" id="close">关闭</a>
</div>
</div>
</div>
</body>
