...
<workflowProcess productVersion="6.1" schemaVersion="6.0">
  <processHeader>
    <processBasicInfo>
      <processId>org.gocom.abframe.org.recruitApproval.recruit_approval</processId>
      <processName>招聘需求审批流程</processName>
      <priority>60</priority>
      <author>JYW</author>
      <department>信息中心</department>
      <description></description>
    </processBasicInfo>
    <dataFields>
      <dataField>
        <name>continueApproval</name>
        <dataType>
          <typeClass>primitive</typeClass>
          <typeValue>Int</typeValue>
        </dataType>
        <initialValue>0</initialValue>
        <description>是否需要继续审批</description>
      ...
      <dataField>
        ...
        <initialValue>0</initialValue>
        <description>部门审批层级</description>
        <isArray>false</isArray>
      </dataField>
      <dataField>
        <name>approvalPersons</name>
        <dataType>
      ...
      <dataField>
        <name>approvalChains</name>
        <dataType>
          <typeClass>sdo</typeClass>
          <typeValue>org.gocom.abframe.org.custom.RecruitInterviewSchedule</typeValue>
        </dataType>
        <initialValue></initialValue>
        <description>审批层级设置的数据</description>
        <isArray>true</isArray>
      </dataField>
    </dataFields>
    <triggerEvents/>
  ...
  <transitions>
    ...
    <transition>
      ...
      <simpleCondition>
        ...
        <leftValue>continueApproval</leftValue>
  ...
  <activities>
    ...
    <activity>
      ...
      <activityName>发起招聘需求审批</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <customURL>
            ...
            <urlInfo>/abframe/org/recruit/editRecruitApproval.jsp</urlInfo>
    ...
    <activity>
      ...
      <activityName>招聘需求审批HR信息确认</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <customURL>
            <isSpecifyURL>true</isSpecifyURL>
            <urlInfo>/abframe/org/recruit/recrutiApprovalByHRConfirm.jsp</urlInfo>
            <urlType>webpage</urlType>
          </customURL>
          <resetUrl>
            <isSpecifyURL>false</isSpecifyURL>
    ...
    <activity>
      ...
      <activityName>招聘需求部门审批</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
      ...
      <implementation>
        <manualActivity>
          ...
          <customURL>
            <isSpecifyURL>true</isSpecifyURL>
            <urlInfo>/abframe/org/recruit/recrutiDepartApproval.jsp</urlInfo>
            <urlType>webpage</urlType>
          </customURL>
          <resetUrl>
            <isSpecifyURL>false</isSpecifyURL>
          ...
          <participants>
            ...
            <specialActivityID></specialActivityID>
            <specialPath>approvalPersons</specialPath>
          </participants>
          <formFields/>
          <timeLimit>
            <isTimeLimitSet>false</isTimeLimitSet>
          ...
          <triggerEvents>
            <triggerEvent>
              <applicationInfo>
                ...
                <application>
                  <actionType>logic-flow</actionType>
                  <applicationUri>org.gocom.abframe.org.recruitApproval.recruitApproval.getCurrentApprovalPerson</applicationUri>
                  <transactionType>join</transactionType>
                  <exceptionStrategy>rollback</exceptionStrategy>
                  <invokePattern>synchronous</invokePattern>
                  <parameters>
            ...
            <triggerEvent>
              <applicationInfo>
                ...
                <application>
                  <actionType>logic-flow</actionType>
                  <applicationUri>org.gocom.abframe.org.recruitApproval.recruitApproval.setApprovalLevel</applicationUri>
                  <transactionType>join</transactionType>
                  <exceptionStrategy>rollback</exceptionStrategy>
                  <invokePattern>synchronous</invokePattern>
                  <parameters>
    ...
    <activity>
      ...
      <activityName>审批结果通知</activityName>
      <description></description>
      <splitType>XOR</splitType>
      <joinType>XOR</joinType>
      <priority>60</priority>
        ...
        <autoActivity>
          ...
          <taskApplication>
            <applicationInfo>
              ...
              <application>
                <actionType>logic-flow</actionType>
                <applicationUri>org.gocom.abframe.org.recruitApproval.recruitApproval.recruitApprovalResultInform</applicationUri>
                <transactionType>join</transactionType>
                <exceptionStrategy>rollback</exceptionStrategy>
                <invokePattern>synchronous</invokePattern>
                <parameters>
          ...
          <triggerEvents>
            <triggerEvent>
              <applicationInfo>
                ...
                <application>
                  <actionType>logic-flow</actionType>
                  <applicationUri>org.gocom.abframe.org.recruitApproval.recruitApproval.updateApprovalStatus</applicationUri>
                  <transactionType>join</transactionType>
                  <exceptionStrategy>rollback</exceptionStrategy>
                  <invokePattern>synchronous</invokePattern>
                  <parameters>
              ...
              <description>更新招聘状态以及招聘需求审批状态</description>
            </triggerEvent>
          </triggerEvents>
          <rollBack>
            <applicationInfo>
  ...
  <notes>
    <note>
      <content>审批通过则更改招聘需求状态，审批不通过则终止流程</content>
      <title>JYW	19-11-4 下午4:22</title>
      <location>
        <x>428</x>
        <y>295</y>
      </location>
    ...
    <note>
      <content>确认需求的同时，明确审批层级及每一级审核人</content>
      <title>JYW	19-11-4 下午4:21</title>
      <location>
        <x>252</x>
        <y>295</y>
      </location>
