...
<div class="nui-fit" style="border:solid 0px #aaa;padding:0px;width:auto">
	<div class="mini-panel" title="招聘需求审批部门审批" style="width: 100%">
		<jsp:include page="/ame_common/ameFlowOperTips/ameFlowOperTipsInfo.jsp"/>
		<div id="form1" >
			<fieldset id="field1" style="border:solid 1px #aaa;">
				<legend>招聘需求审批部门审批</legend>
		...
		promptInit({workItemID: <%=workItemID %>});//流程提示信息
  		...
  		nui.ajax({//获取资产采购申请信息
      		...
      		success: function (o){
            	...
            	nui.get("isreferrer1").setReadOnly(true);
            	if(o.omRecruit.isreferrer ==1){
            	        nui.get("refferexpmouldno").setReadOnly(true);
	            ...
	            }else if(o.omRecruit.isreferrer == null || o.omRecruit.isreferrer == ''){
