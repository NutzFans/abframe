    ...
    <h:form name="form1" action="org.gocom.abframe.org.position.PositionEmp.flow" method="post">
         ...
         <tr>
          ...
          <div style="float:right">
                ...
                <input type="button" class="button" onclick="firstPage('page', 'query', null, null, 'form1');" value='<b:message key="l_firstPage"></b:message>'  <l:equal property="page/isFirst"  targetValue="true">disabled</l:equal> >
