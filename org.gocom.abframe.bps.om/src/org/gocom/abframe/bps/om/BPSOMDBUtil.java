/*******************************************************************************
 * $Header: /cvsroot/MIS10/src/NEWERP/org.gocom.abframe.bps.om/src/org/gocom/abframe/bps/om/BPSOMDBUtil.java,v 1.1 2013/06/02 19:53:40 huangqj Exp $
 * $Revision: 1.1 $
 * $Date: 2013/06/02 19:53:40 $
 *
 *==============================================================================
 *
...
public class BPSOMDBUtil {
	...
	private static String getDsPackage() {
		return ConfigurationUtil.getContributionConfig(
				"org.gocom.abframe.bps.om", "abframe", "DataSource",
				"contribution");
	}
	...
	private static String getDsName() {
		return ConfigurationUtil.getContributionConfig(
				"org.gocom.abframe.bps.om", "abframe", "DataSource", "dsname");
	}
