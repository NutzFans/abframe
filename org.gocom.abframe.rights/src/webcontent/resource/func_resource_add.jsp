...
<%--dataform configurationID:20080814204408 --%>
<h:form name="funcResourceAdd_dataform" action="org.gocom.abframe.rights.application.ResourceAdd.flow" method="post">
  ...
  <input type="hidden" name="_eosFlowAction" value="addExcute"/>
    ...
    <table align="center" border="0" width="100%" class="form_table">      
      <tr>
        ...
        <td colspan="1">
          <h:text property="acfuncresource/resname"/>
        </td>
        <td class="form_label">
          <b:message key="applicationManager_AcFuncresource.restype"></b:message><b:message key="l_colon"></b:message>
        </td>
        <td colspan="1">
          <d:select property="acfuncresource/restype" dictTypeId="ABF_RESOURCETYPE" style="width:133"/>
        </td>
      </tr>      
      <tr>
        <td class="form_label" nowrap="nowrap">
        ...
        <td colspan="3">
          <h:text property="acfuncresource/respath" style="width:92%"/>
        </td>
      </tr>
...
<l:equal property="funcResource_result" targetValue="1" compareType="number" scope="request" >
<script>
  window['returnValue'] = $id("function_code").value;
  alert('<b:message key="applicationManager_m_addfuncResource_success"></b:message>');
  window.close();
</script>
</l:equal>

<l:lessThan property="funcResource_result" targetValue="0" compareType="number" scope="request">
