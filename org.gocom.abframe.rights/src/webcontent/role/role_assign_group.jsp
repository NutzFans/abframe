...
<script>
   ...
   */
  function addRecord() {
        var url = "org.gocom.abframe.rights.role.AddWorkGroup.flow";
        url += "?_eosFlowAction=start";
        url += "&acRole/roleid=";
        url += '<b:write property="acRoleVar/roleid"/>';
        url += '&_ts='+(new Date()).getTime();   //防止IE缓存，在每次打开时加个时间差的参数
	    showModalCenter(url, "", callBack, 700, 400, '<b:message key="roleManager_l_addWorkGroup"/>');
    }
  /*
   * 刪除工作組
   */
  function delRecord() {
    ...
    if( !confirm('<b:message key="roleManager_l_m_alert_confirmDeleteGroup"/>') ) {
      return;
    }
    var frm = $name("viewlist1");
  ...
  <h:hidden property="page/count"/>
    <table align="center" border="0" width="100%" class="EOS_table">
      ...
      <w:checkGroup id="group1">
        <l:iterate property="workGroupList" id="id1">
      ...
      <tr>
        ...
        <div style="float:left">
          ...
          <l:greaterThan property="page/size" targetValue="0" compareType="number">
            ...
            <input type="button" class="button" onclick="firstPage('page', 'pageQuery2', null, null, 'viewlist1');" value="<b:message key="l_firstPage"/>"  <l:equal property="page/isFirst" targetValue="true">disabled</l:equal> >
            <input type="button" class="button" onclick="prevPage('page', 'pageQuery2', null, null, 'viewlist1');" value="<b:message key="l_upPage"/>" <l:equal property="page/isFirst" targetValue="true">disabled</l:equal> >
            <input type="button" class="button" onclick="nextPage('page', 'pageQuery2', null, null, 'viewlist1');" value="<b:message key="l_nextPage"/>" <l:equal property="page/isLast" targetValue="true">disabled</l:equal> >
            <l:equal property="page/isCount" targetValue="true">
              <input type="button" class="button" onclick="lastPage('page', 'pageQuery2', null, null, 'viewlist1');" value="<b:message key="l_lastPage"/>" <l:equal property="page/isLast" targetValue="true">disabled</l:equal> >
            </l:equal>
            <div>
        </td>
      </tr>
