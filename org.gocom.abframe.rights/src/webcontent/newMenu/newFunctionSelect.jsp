...
<body>
	    ...
	    <div id="datagrid1" class="nui-datagrid" style="width:100%;height:290px;"  pageSize="10" sizeList="[10,20,50,100,200]" showPager="true"
	    	url="org.gocom.abframe.rights.menu.newMenu.newFunctionSelect.biz.ext" dataField="functions"  allowSortColumn="true" multiSelect="false">
			<div property="columns">
				...
				<div field="funcaction" width="140" align="left"  headerAlign="center" allowSort="true">功能调用入口</div>
			</div>
	   </div>
