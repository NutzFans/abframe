...
<html>
  ...
  <body>
    ...
    <h:form name="query_form" action="org.gocom.abframe.rights.application.FunctionExtendSelectMy.flow" method="post" onsubmit="return checkForm(this);">
        ...
        <table align="center" border="0" width="100%" class="form_table">
          <tr>
            ...
            <td colspan="3">
              ...
              <h:hidden property="criteria/_expr[4]/operator"/>
            </td>
            <td class="form_label">
              功能组名称：
            </td>
    ...
    <h:form name="page_form" action="org.gocom.abframe.rights.application.FunctionExtendSelectMy.flow" method="post" onsubmit="return checkForm(this);">
      <input type="hidden" name="_eosFlowAction" value="query"/>
