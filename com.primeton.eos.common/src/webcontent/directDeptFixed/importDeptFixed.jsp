...
<div class="nui-fit">
	<fieldset id="importCash">
		<legend>导入</legend>
		<form id="form2" class="" action="com.primeton.eos.common.importDepFixed.flow" target="hidden_frame" method="post" enctype="multipart/form-data">
