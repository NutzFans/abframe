...
<!-- 
  - Author(s): huangyq
  - Date: 2018-09-12 14:14:55
  - Description:
-->
<head>
<title>导入工资福利分摊</title>
...
<div class="nui-fit">
	<fieldset id="importCash">
		<legend>导入</legend>
		<form id="form2" class="" action="com.primeton.eos.common.importDeptCost.flow" target="hidden_frame" method="post" enctype="multipart/form-data">
	        ...
	        <div class="nui-toolbar" style="padding:0px;">
	            <table style="width:100%;">
	                ...
	                <tr>
			            ...
			            <td>
		       	  			<div style="color: red;">上传用的 Excel 文件版本为 97-2003版本，即 .xls 为后缀的版本，数据全部放在第一个工作表内，数据要从第4行开始填写。</div>
		       	  		</td>
			        </tr>
	            </table>           
	        </div>
