...
<body>
	<h:form name="query_form" action="com.primeton.eos.common.AdjustCommBudget.flow" checkType="blur" target="_self" method="post" onsubmit="return checkForm(this);">
        <input type="hidden" name="_eosFlowAction" value="query"/>
        <h:hidden property="temp/companyid"/>
        <w:panel id="panel1" width="100%" title="公共费用查询条件：">
          <table align="center" border="0" width="100%" class="form_table">
            <tr>
              <td class="form_label">区域</td>
              <td colspan="1">
				<d:select dictTypeId="EXP_REGION" property="temp/region" filterField="dictid" filterOp="!=" filterStr="0"></d:select>
              </td>
      ...
      <h:form name="adjustForm" action="com.primeton.eos.common.AdjustCommBudget.flow" checkType="blur" target="_self" method="post" onsubmit="return checkForm(this);">
      	<h:hidden property="temp/region"/>
          ...
          <table align="center" border="0" width="100%" class="form_table">
            <tr>
              ...
              <td colspan="1">
                <r:comboSelect id="com11" property="temp/comgrouptypeid" queryAction="com.primeton.eos.common.expDeal.getAllCommGroupType.biz" textField="comgrouptypename" valueField="comgrouptypeid" xpath="listCommGroup" submitXpath="commGroup">
				</r:comboSelect>
			  	<r:comboSelect linkId="com11" id="com12" property="temp/comexptypeid" queryAction="com.primeton.eos.common.expDeal.getCommExpTypeByCommGroupType.biz" textField="comexptypename" valueField="comexptypeid" xpath="listCommExpType">
				</r:comboSelect>
              </td>
      ...
      <h:form name="page_form" action="com.primeton.eos.common.AdjustCommBudget.flow" method="post">
      	<w:panel id="list_panel" width="100%" title="公共费用数据">
      		<table align="center" border="0" width="100%" class="form_table">
      			<tr><td align="center" class="form_label" colspan="15"><b:write property="temp/year"/>年公共费用执行表</th></tr>
      			<tr>
        		...
        		<script>
      			...
      			<l:iterate id="empnum" property="listComm">
      			<%
      			...
      			<tr>
	            	<td class="form_label" align="center">
	            		<script>
	            			var expgroupname = "<b:write iterateId='empnum' property='comGroupTypeName'/>";
      				...
      				<td class="form_label" align="center"><b:write iterateId="empnum" property="comExpTypeName"/></td>
      				...
      				<td align="right" id="sum<b:write iterateId='empnum' property='comExpTypeID'/>"></td>
      			</tr>
	          	<%i++; %>
      			</l:iterate>
	          	<tr align="center">
      ...
      <h:form name="deleteForm" action="com.primeton.eos.common.AdjustCommBudget.flow" target="_self" method="post">
      	<h:hidden property="temp/region"/>
      	<h:hidden property="temp/year"/>
      	<h:hidden property="temp/companyid"/>
          ...
          <table align="center" border="0" width="100%" class="EOS_table">
            <tr>
              ...
              <l:iterate property="listCommChange" id="id1">
                <tr class="<l:output evenOutput='EOS_table_row' />">
                  ...
                  <td>
                    <b:write iterateId="id1" property="erprptTCommexptype/erprptTCommgrouptype/comgrouptypename"/>
                  </td>
                  <td>
                  	<b:write iterateId="id1" property="erprptTCommexptype/comexptypename"/>
                  </td>
                  <td>
...
function cal_subTotal(){
	...
	var empNum=0;	
    <l:iterate id="empnum" property="listComm" > 
		deptno[empNum++]='<b:write iterateId="empnum" property="comExpTypeID"/>';
	</l:iterate>
	//计算明细部分的小计
	for(var j=0;j<=12;j++){
		daytotal[j]=0;
