...
<div class="nui-fit">
	<div class="nui-panel" title="请假申请" style="width: 100%;">
				...
				<div style="padding: 5px;">
					<table style="table-layout: fixed;">
						...
						<tr>
							...
							<td>
								<input id="confirdate" name="confirdate" class="nui-datepicker"style="width: 110px" required="true"/>
							</td>
						</tr>
						<tr>
		...
		<fieldset style="border: solid 1px #aaa;padding: 3px;width: 60%;display:none" id="sprlists">
		...
		<div id = "cl" style="display:none"><span size='5' style="color: red"><b>是否需要申请人补充材料:</b></span><input id ="isneedcl" class="nui-checkbox"></div>
    ...
    function onOk(e){
    	...
    	if(auditstatus=="2"){//审批意见为终止时不做任何校验
	    	...
	    	if(auditstatus=="1"){//审批意见为通过时校验
				...
				if(activityDefID=="manualActivity111"){//复核环节不校验部门审批人
				}else{
					if(sprdata.length==0){
