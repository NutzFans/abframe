...
<div class="nui-fit">
	...
	<form id="form1" method="post">
		...
		<fieldset id="field1" style="border:solid 1px #aaa;padding:3px;display:true">
			...
			<div style="padding:5px;">
				<input name="omAppraiseByMyself.appraiseid" id="appraiseid"  class="nui-hidden"/>
				<input name="omAppraiseByMyself.appraisertype" id="appraisertype"  class="nui-hidden"/>
				<input name="omAppraiseByMyself.appraiser" id="appraiser"  class="nui-hidden"/>
				<input name="omAppraiseByTutor.appraiseid" id="appraiseid1"  class="nui-hidden"/>
				<input name="omAppraiseByTutor.appraisertype" id="appraisertype1"  class="nui-hidden"/>
				<input name="omAppraiseByTutor.appraiser" id="appraiser1"  class="nui-hidden"/>
				<table style="table-layout:fixed;" >	
					<tr>
						...
						<td  style="width:60px">
							...
							<input class="nui-hidden" name="omAppraiseByMyself.appraisestatus" id="appraisestatus"/>
						</td>
					...
					<tr>
						...
						<td colspan="2">
							<input name="omAppraiseByMyself.appraise" id="appraise" class="nui-textarea" style = "width: 500px;height:50px" maxLength="200" required="true">
						</td>
					</tr>
				</table>
			</div>
...
<div style="text-align:center;padding:10px;" class="nui-toolbar">
	...
	<a class="nui-button" onclick="onOk('0')" iconCls="icon-undo" style="width:60px;margin-right:10px;display:none" id="appButton1">退回</a>
  		...
  		nui.ajax({
            ...
            success: function (o) {
            	...
            	if(data.ver){
            		...
            		form1.setData(data);
            		nui.get("appraisertype").setValue("2");
