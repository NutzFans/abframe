...
<!-- 
  - Author(s): 许青倩
  - Date: 2020-03-02 14:48:28
  - Description:
-->
<head>
<title>背景调查审批确认</title>
	            ...
	            <table style="table-layout:fixed;">
	            	<tr id="salesEdit">
	                    ...
	                    <td style="width:250px;">  
							<input name="backCheckOpinion.auditstatus" id="auditstatus1" class="mini-dictradiogroup" value="1" style="width:250px;" required="true" dictTypeId="MIS_AUDITSTATUS" onValueChanged="changebackopnion"/>
	                    </td>
	                </tr>
	                <tr>
	                    <td style="width:150px;height:auto;" align="right" id="auditopinion1">审核意见：</td>
	                    <td colspan="3">
	                        <input name="backCheckOpinion.auditopinion" id="auditopinion1" class="nui-textarea" required="true" style="width:600px;height: 40px;"/>
	                    </td>
	                </tr>
	            </table>
	        </div>
...
<script type="text/javascript">
	...
	function changebackopnion(){
		var auditstatus1 = nui.get("auditstatus1").getValue();
		if(auditstatus1 == '1'){
			nui.get("auditopinion1").setValue("通过");
		}else{
			nui.get("auditopinion1").setValue("");
		}
	}
</script>
</html>