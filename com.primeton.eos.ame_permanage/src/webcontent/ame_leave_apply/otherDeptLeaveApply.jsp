...
<script type="text/javascript">
	...
	function initMisOpinion(data){
		//初始化处理意见
		if(data.type=="1"){
			var dataStatus=[{"dictID": 1,"dictName": "通过"}];
		}else{
		...
		promptInit({workItemID: <%=workItemID %>});//流程提示信息
  		...
  		nui.ajax({//获取资产采购申请信息
      		...
      		success: function (o){
                ...
                document.getElementById("mobileno").innerHTML = o.omLeaveApply.mobileno == null ?"": o.omLeaveApply.mobileno;
                document.getElementById("dirleadername").innerHTML = o.omLeaveApply.dirleadername == null ?"": o.omLeaveApply.dirleadername;
                document.getElementById("gender").innerHTML = o.omLeaveApply.gender == null ?"": nui.getDictText('ABF_GENDER',o.omLeaveApply.gender); 
		        document.getElementById("orgid").innerHTML = o.omLeaveApply.orgname == null ?"": o.omLeaveApply.orgname;
					    document.getElementById("emptype").innerHTML = o.omLeaveApply.emptype == null ?"": nui.getDictText('EMP_TYPE',o.omLeaveApply.emptype);		
						...
						rdProject_grid.load({userid: userid},function(e){//合同
							...
							csContract_grid.load({userid: userid},function(e){//代办
								...
								taskList_grid.load({userid: userid,type:"PRIVATE"},function(){//资产
									misMachine_grid.sortBy("assetid","desc");
                ...
                if(outtype =="2"){
  				...
  				if("manualActivity4" == activityDefID){//财务确认
  					...
  					if("manualActivity14" == activityDefID){
		                ...
		                document.getElementById("orgid1").innerHTML = o.omLeaveApply.orgname == null ?"": o.omLeaveApply.orgname;
		                document.getElementById("userid1").innerHTML = o.omLeaveApply.empname == null ?"": o.omLeaveApply.empname;
		                document.getElementById("outdate1").innerHTML = o.omLeaveApply.outdate == null ?"": o.omLeaveApply.outdate;
		                document.getElementById("outplace1").innerHTML = o.omLeaveApply.outplace == null ?"":  nui.getDictText('EXP_REGION',o.omLeaveApply.outplace);
		                document.getElementById("hopedealoutdate1").innerHTML = o.omLeaveApply.dealoutdate == null ?"": o.omLeaveApply.dealoutdate;
		                document.getElementById("handuserid1").innerHTML = o.omLeaveApply.handusername == null ?"": o.omLeaveApply.handusername;
		                document.getElementById("empcode1").innerHTML = o.omLeaveApply.empcode == null ?"": o.omLeaveApply.empcode;
		                document.getElementById("indate1").innerHTML = o.omLeaveApply.indate == null ?"": o.omLeaveApply.indate;
		                document.getElementById("positionname1").innerHTML = o.omLeaveApply.positionname == null ?"": nui.getDictText('AME_POSITION_MEMO',o.omLeaveApply.positionname); 
					    ...
					    document.getElementById("remark").innerHTML = o.omLeaveApply.remark == null ? "":o.omLeaveApply.remark;				
	  					...
	  					document.getElementById("baomi").style.display="";
  					}
	  				document.getElementById("exprei").style.display="none";
	  				document.getElementById("expbei").style.display="none";
	  				document.getElementById("project").style.display="none";
	  				...
	  				document.getElementById("mail").style.display="none";
	  				document.getElementById("emp").style.display="none";
  				}else if("manualActivity13" == activityDefID || "manualActivity15" == activityDefID){//离职回访
  					if("manualActivity13" == activityDefID){
		  				setLeaveReason("revisitreason");
		  				setLeaveReason("revisitothreason");
		  				nui.get("recempname1").setValue(o.omLeaveApply.recempname);
	  					document.getElementById("leaveReturn").style.display="";
  					}else{
	  					document.getElementById("leaveIntern").style.display="";
  					}
					...
					if(leaderOp){
						for(var i=0;i<leaderOp.length;i++){
							if(i==0){
								...
								sybname1 = leaderOp[i].operatorname;
								syborgname1 = leaderOp[i].orgname;
							}else if(i == 3){
					...
					pdfjson = ({"filename":"","emp":{
								...
								"deptop":deptname == null || deptname =="" ? "":ops,
								"sybname":sybname,
								"syborgname":syborgname,
								"sybop":sybname == null || sybname =="" ? "":ops,
								"sybname1":sybname1,
								"syborgname1":syborgname1,
								"sybop1":sybname1 == null || sybname1 =="" ? "":ops,
								"vpname":vpname,
								"vporgname":vporgname,
								"vpop":vpname == null || vpname =="" ? "":ops,
								}});
				...
				//审核结果设置
				if("manualActivity14" == activityDefID){
					initMisOpinion({auditstatus: "1",type:"2"});
				}else{
					initMisOpinion({auditstatus: "1",type:"1"});
				}
				if("manualActivity13" == activityDefID){
    ...
    function onOk(e){
    	...
    	var isbaomi = nui.get("isbaomi").getValue();
    	if(auditstatus == "2"){	//终止流程
        	...
        	if("manualActivity9" == activityDefID && "0" == isbaomi){
	    	}else if ("manualActivity15" == activityDefID){
	    		var isthird = nui.get("isthird").getValue();
	    		if("1" == isthird){
	    			if(nui.get("issolve").getValue() == "false"){
		        		nui.alert("请在解决三方问题后勾选“已解决”并提交流程，以便员工办理离职手续！");
		        		return;
		        	}
	    		}
	    	}else{
