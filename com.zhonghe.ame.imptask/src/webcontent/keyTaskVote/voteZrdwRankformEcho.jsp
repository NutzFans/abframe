	        	...
	        	<table style="table-layout:fixed;" id="table_file1">
						...
						<tr>			
							...
							<td style="width: 130px"><input
									name="voteFinshtime" id="voteFinshtime" class="nui-datepicker" readOnly="readOnly"
									style="width: 890px"/></td>
						</tr>
						...
						<tr>
							...
							<td colspan="6"><input field="remark" class="nui-textarea" name="remark"
									 shownullItem="true"
									style="width: 890px;" required="false" readOnly="readOnly" /> 
						</tr>
	        	</table>
	        </form>
