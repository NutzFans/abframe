...
<body>
	<div class="nui-fit">
		<fieldset style="border: solid 1px #aaa; padding: 3px;">
			<legend>责任单位投票</legend>
			<form id="form1" method="post">

				<table style="table-layout: fixed;" id="table_file1">
					<tr>
						<td align="right" style="width: 160px">名称:</td>
						<td><input readOnly="readOnly" class="nui-textbox"
							name="voteCode" id="voteCode" style="width: 425px" required="true">
						</td>
					</tr>
					<tr>	
						...
						<td style="width: 130px"><input name="voteFinshtime"
							id="voteFinshtime" class="nui-datepicker" style="width: 150px"
					...
					<tr>
						...
						<td colspan="6"><input class="nui-textarea"
							dictTypeId="ZH_TASK_STATUS" name="remark" id="remark"
		...
		<fieldset style="border: solid 1px #aaa; padding: 3px; width: 99%;height:255px"
			align="center">
			<legend>被投票单位</legend>
			<div id="grid_traveldetail" class="nui-datagrid"
				style="width: 100%; height: 70%;" allowCellSelect="true"
				url="com.zhonghe.ame.imptask.keyTaskVote.queryZrdwVoteDetail.biz.ext"
				dataField="taskVote" showPager="false" allowCellEdit="true"
				multiSelect="true">
				<div property="columns" name="temp123"  valueField="keytaskIds">
					<div field="keytaskIds" width="832" align="center"
						headerAlign="center">单位--名称</div>
					<div field="custName" displayField="custName" width="100"
						align="center" headerAlign="center" renderer="getValue">
						排名 <input id="activityid" property="editor"
							name="criteria._expr[1]._value" changeOnMousewheel="false"
	...
	function queryJob() {  //根据id查询投票人职位
		nui.ajax({
			url:"com.zhonghe.ame.imptask.keytask.queryJob.biz.ext",
			type:"get",
			data:json,
    			...
    			//console.log(combo);  
		  		...
		  		if(b==0){
					if(!confirm("确认提交")){
			    		 ...
			    		 nui.ajax({
			                url: "com.zhonghe.ame.imptask.keyTaskVote.addzrdwDetails.biz.ext",
			                data: json,
			                type: 'POST',
			                cache: false,
			                contentType: 'text/json',
