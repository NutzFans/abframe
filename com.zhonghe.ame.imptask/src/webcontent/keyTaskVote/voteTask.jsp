...
<body>
	<div class="nui-fit">
		 	...
		 	<form id="form1" method="post" >
	        	...
	        	<table style="table-layout:fixed;" id="table_file1">
	        			<tr>		
							...
							<td>
								<input class="nui-textbox" name="voteCode" id="voteCode" style="width:300px" required="true">
							</td>
						...
						<td colspan="6"><input class="nui-textarea"
									...
									style="width: 900px;" required="true" /> 
						</tr>
        ...
        <fieldset style="border: solid 1px #aaa;padding: 3px;width: 100%;" align="center">
	        ...
	        <div id="grid_traveldetail" class="nui-datagrid"  style="width: 100%;height: auto;" allowCellSelect="true" 
	    		url="com.zhonghe.ame.imptask.keyTaskVote.queryKeyTask.biz.ext" dataField="taskMng"
	            ...
	            <div property="columns">
	               ...
	               <div field="orgname" width="100" align="center" headerAlign="center" renderer="onViewL" >责任单位</div> 
	...
	function submit(){
    			...
    			/* 计算得分 第一名为1.2分 最后一名为0.8 中间的为区间 (1.2-0.8=0.4)
    			中间的计算公式 (按照排名正序)  得分=1.2-(0.4/(总数-1))*(排名名次-1)  */
    			var qj=0.4;
    			/* arr[0].ids='1' */
    			 for(var i=0;i<arr.length;i++){
    				if(arr[i].custName=='1'){
    					arr[i].score='1.2'
    				}else if (arr[i].custName==arr.length){
    					arr[i].score='0.8' 
    				}else {
    					arr[i].score=(1.2-(0.4/(arr.length-1))*(arr[i].custName-1)).toFixed(2)
    				}
    			}
    			...
    			var json = nui.encode({"data":arr,"id":id});
		  		...
		  		if(b==0){
					if(!confirm("确认提交")){
			    		 ...
			    		 nui.ajax({
			                url: "com.zhonghe.ame.imptask.keyTaskVote.addVoteDetail.biz.ext",
			                data: json,
			                type: 'POST',
			                cache: false,
			                contentType: 'text/json',
