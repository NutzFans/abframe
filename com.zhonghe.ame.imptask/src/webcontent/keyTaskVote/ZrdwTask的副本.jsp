...
<body>
		 	...
		 	<form id="form1" method="post" >
	        	...
	        	<table style="table-layout:fixed;" id="table_file1">
	        			<tr>		
							...
							<td>
								<input readOnly="readOnly" class="nui-textbox" name="voteCode" id="voteCode" style="width:300px" required="true">
							</td>
									
							<td align="right" style="width:160px">投票结束时间：</td>
							<td style="width: 130px"><input
									name="voteFinshtime" id="voteFinshtime"
									class="nui-datepicker"  style="width: 300px" required="true" readOnly="readOnly"/></td>
						...
						<td colspan="6"><input class="nui-textarea"
									dictTypeId="ZH_TASK_STATUS"  name="remark" id="remark" shownullItem="true"
									style="width: 900px;" required="true" readOnly="readOnly"/> 
						</tr>

	        	</table>
	        </form>
    	</fieldset>
        <fieldset style="border: solid 1px #aaa;padding: 3px;width: 99%;" align="center">
			    <legend>被投票单位</legend>
	        
	        <div id="grid_traveldetail" class="nui-datagrid"  style="width: 100%;height: auto;" allowCellSelect="true" 
	    		url="com.zhonghe.ame.imptask.keyTaskVote.queryOrgVote.biz.ext" dataField="orgList"
	    		showPager="false" allowCellEdit="true" multiSelect="true">
	            <div property="columns">
	               <div name="temp123" type="checkcolumn" valueField="competId"></div>
	               
	                <div field="orgname" width="100" align="center" headerAlign="center">单位名称
	                </div>
					<div field="custName" displayField="custName" width="130" align="center" headerAlign="center" renderer="getValue">排名
						<input id="activityid" property="editor" name="criteria._expr[1]._value" changeOnMousewheel="false" class="nui-spinner"  minValue="1" onvaluechanged="check"/>
	                	<!-- <input   property="editor"  name="criteria._expr[1]._value" 
	                	data="monthData" 
	                	id="activityid" valueField="activityid" textField="activityname" class="nui-combobox" style="width:150px;" shownullItem="true" onvaluechanged="changeActplace"/> -->
	                </div>
	            </div>
	        </div>
			</fieldset>
    ...
    <script type="text/javascript">
		...
		function init(){
			...
			nui.ajax({
		        url: "com.zhonghe.ame.imptask.keyTaskVote.queryZrdwVoteDetail.biz.ext",
		        type: "post",
		        data: json ,
		        contentType:'text/json',
		        success: function (o) {
		        		console.log(o.taskVote[0]);
		        		
						var a=o.taskVote[0].keytaskIds.split(",")
						size=a.length;
			            form.setData(o.taskVote[0]);
			            var keyTask = o.taskVote[0];
			            nui.get("voteCode").setValue(keyTask.voteCode);
				        nui.get("voteFinshtime").setValue(keyTask.voteFinshtime);
				        nui.get("remark").setValue(keyTask.remark);
				        grid_traveldetail.load({"ids":o.taskVote[0].keytaskIds})
				        for(var i=1;i<=size;i++){
							   monthData.add ({activityid: i,activityname: i},)		
						 }
   ...
   //判断数组是否有重复值
	...
	function submit(){
    			...
    			var json = nui.encode({"data":arr,"id":id});  
		  		console.log(arr);
		  		if(b==0){
					if(!confirm("确认提交")){
	        				return;
			    		 ...
			    		 nui.ajax({
			                url: "com.zhonghe.ame.imptask.keyTaskVote.addzrdwDetail.biz.ext",
			                data: json,
			                type: 'POST',
			                cache: false,
			                contentType: 'text/json',
	...
	/* var monthData = [{activityid: '1',activityname: '1'},{activityid:'2',activityname: '2'},{activityid:'3',activityname: '3'},{activityid:'4',activityname: '4'},{activityid:'5',activityname: '5'},{activityid:'6',activityname: '6'},
    					{activityid:'7',activityname: '7'},{activityid:'8',activityname: '8'},{activityid:'9',activityname: '9'},{activityid:'10',activityname: '10'},{activityid:'11',activityname: '11'},{activityid:'12',activityname: '12'}];
 */	
