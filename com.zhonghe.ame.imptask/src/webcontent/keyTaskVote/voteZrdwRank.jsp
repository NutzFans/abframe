...
<body>
	<div class="nui-fit">
		 	...
		 	<form id="form1" method="post" >
	        	...
	        	<table style="table-layout:fixed;" id="table_file1">
	        			<tr>		
							...
							<td>
								<input class="nui-textbox" name="voteCode" id="voteCode" style="width:250px" required="true">
							</td>
									
							<td align="right" style="width:160px">投票结束时间：</td>
							<td style="width: 130px"><input
									name="voteFinshtime" id="voteFinshtime"
									class="nui-datepicker"  style="width: 250px" required="true"/></td>
        ...
        <fieldset style="border: solid 1px #aaa;padding: 3px;width: 99%;" align="center">
			    <legend>参与责任单位投票任务</legend>
	        
	        <div id="grid_traveldetail" class="nui-datagrid"  style="width: 100%;height: auto;" allowCellSelect="true" 
	    		url="com.zhonghe.ame.imptask.keyTaskVote.queryzrdwking.biz.ext" dataField="dos"
	            ...
	            <div property="columns">
	               ...
	               <div field="ORGNAME" width="100" align="center" headerAlign="center" allowSort="true" >责任单位名称</div>
	                <div field="avgRank" width="100" align="center" headerAlign="center" renderer="onViewL" >排名
	                </div> 
	            </div>
	        </div>
		...
		function init(){
			...
			nui.ajax({
		        ...
		        success: function (o) {
				        ...
				        grid_traveldetail.load({"id":o.taskVote[0].id})
	...
	function submit(){
    			...
    			for(j = 0,len=arr.length; j < len; j++) {
    				if(arr[j].keytaskId!=undefined){
    					if(ids==""){
    					ids = arr[j].keytaskId;
    					}else{
    					ids = ids+","+arr[j].keytaskId;
    					}
    				}else{
    					nui.alert("参与投票重点任务不能为空");
    				}
