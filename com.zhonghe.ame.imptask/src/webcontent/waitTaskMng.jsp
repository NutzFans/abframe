...
<div class="nui-panel" title="月度计划审核" style="width:100%;height: 100%">
    ...
    <div class="nui-fit">
        <div id="datagrid1" frozenStartColumn="0"  sizeList="[10,20,50,100]" showPager="true" dataField="waitTask"
             ...
             class="nui-datagrid" style="width:100%;height:100%;" url="com.zhonghe.ame.imptask.keytask.queryWaitMngList.biz.ext"
...
<div id="detailGrid_Form" style="display:none;width:75%">
    <div id="reve_grid" class="nui-datagrid" dataField="bidCom" showSummaryRow="true"
         url="com.zhonghe.ame.marketInfo.marketinfo.khxx.commpetior.getBidComInfo.biz.ext" showPager="false" allowCellEdit="true" allowCellSelect="true" multiSelect="false" editNextOnEnterKey="true">
        <div property="columns">
	...
	function onActionRenderer1(e) {
       ...
       /*  if (taskType == "finishedSelf") {
		...
		function editTaskMng(){
			...
			if (row) {
				nui.open({
				//http://127.0.0.1:8080/default/imptask/orgWriteMonyear.jsp
				//http://127.0.0.1:8080/default/imptask/mngUpdateMonyear.jsp
