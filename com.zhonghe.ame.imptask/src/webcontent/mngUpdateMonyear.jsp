		 	...
		 	<form id="form1" method="post" >
	        	<table style="table-layout:fixed;" id="table_file1">
						...
						<tr>
							...
							<td  colspan="8";>
								<input class="nui-textarea"  name="problemMeasures" id="problemMeasures" style="width:950px;height: 40px" shownullItem="true" readOnly="readOnly">
							</td>
						</tr>
						<tr>
							<td align="right" style="width:128px">备注：</td>
							<td  colspan="8";>
								<input class="nui-textarea" name="remark" id="remark" onvaluechanged="changeexpcontsum" style="width:950px;height: 40px" readOnly="readOnly">
							</td>
						</tr>
