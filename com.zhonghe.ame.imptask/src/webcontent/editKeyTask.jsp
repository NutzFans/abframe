...
<body>
	<div class="nui-fit">
		...
		<legend>重点任务基本信息</legend>
		 	<form id="form1" method="post" >
	        	<table style="table-layout:fixed; border-spacing:5px " style="width:100%;"  id="table_file1"  >
			            <tr>
						...
						<tr>
							...
							<td colspan="2"style="width: 210px;">
								<input name="orgid" id="orgid" class="nui-combobox" url="com.primeton.rdmgr.labor.labormgr.getAllOrgs.biz.ext"
							...
							<td  colspan="2" style="width: 130px"><input
								...
								class="nui-datepicker"  style="width: 107px"  required="true"/>
							</td>
						</tr>
						<tr>
    ...
    <script type="text/javascript">
    	...
    	function init(){
			...
			ajaxCommon({
				"url": "com.zhonghe.ame.imptask.keytask.queryTaskList.biz.ext",
				"data": json,
				"success": function(data) {
					form.setData(data.keyTaskList[0]);
		            var keyTask = data.keyTaskList[0];
	...
	function submit(){
		...
		clog(editData)
		editData.ischange = "1";
		var editDataJson = {"keyTaskMng":editData,"id":id};
    	ajaxCommon({
