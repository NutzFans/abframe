...
<body>
	...
	<!-- 	<fieldset style="border:solid 1px #aaa;padding:3px;"> -->
		<fieldset style="border:solid 1px #aaa;padding:10px 5px 15px; width:1200px;height: 400px;">
		<legend>重点任务自评</legend>
		 	<!-- <form id="form1" method="post" > -->
		 	<form id="form1" method="post"  style="width:1200px;height:400px" >
	        	...
	        	<table style="table-layout:fixed;  " id="table_file1"  >
	        			<tr>
							...
							<td style="width: 20%;"><input
									name="keytaskId" id="keytaskId" readOnly="readOnly"
							...
							<td style="width: 10%;">
								<input class="nui-spinner" maxValue="999999999"  readOnly="readOnly" name="annualFractionForecast" id="annualFractionForecast" style="width:100%" required="true">
							</td>
									
							<td align="right" style="width:15%">完成率：</td>
							<td style="width: 10%;">
								<input align="right" class="nui-spinner" name="completeRate" id="completeRate" readOnly="readOnly" style="width:100%" required="true">
								<td>%</td>
							</td>
						...
						<td align="right" style="width:15%">进展情况：</td>
							<td style="width:20%" colspan="5"><input
									name="progress" id="progress" readOnly="readOnly"
			            ...
			            <td align="right" style="width:15%" > 年度完成情况预测：</td>
							<td style="width:20%" colspan="5"><input
									name="annualCompeteForecast" id="annualCompeteForecast" readOnly="readOnly"
									class="nui-textarea"    style="width: 100% " /></td>
						</tr>
						<tr>
						<td align="right" style="width:15%">备注：</td>
						<td style="width:20%" colspan="5" ><input class="nui-textarea" readOnly="readOnly"
									dictTypeId="ZH_TASK_STATUS"  name="remark" shownullItem="true" id="remark" 
									style="width:100%"/> 
						</tr>
