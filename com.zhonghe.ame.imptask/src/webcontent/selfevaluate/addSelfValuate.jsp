...
<body>
		...
		<legend>重点任务自评</legend>
		 	<form id="form2" method="post" >
	        	...
	        	<table style="width: 100%">
        			<tr>
        				<td align="right" style="width: 12%">重点任务名称：</td>
						...
						<td align="right" style="width: 10%;">年度得分预测(分)：</td>
						<td style="width: 15%">
							<input class="nui-spinner" maxValue="999999999" name="annualFractionForecast" id="annualFractionForecast" required="true">
						</td>
								
						<td align="right" style="width: 8%;">完成率：</td>
						<td style="width: 15%"> 
							<input align="right" class="nui-spinner" name="completeRate" id="completeRate" required="true">
							  <span style="border-spacing: 0px; padding-left: 0.2em;padding-right: 0.2em;">%</span>
						</td>
					</tr>
					<tr>
					<td align="right" >进展情况：</td>
						<td colspan="5"><input
								name="progress" id="progress"
								class="nui-textbox" required="true" style="width: 100%"/></td>
					</tr>
		            <tr>
		            <td align="right" > 年度完成情况预测：</td>
						<td colspan="5"><input
								name="annualCompeteForecast" id="openTime"
								class="nui-textarea"   required="true" style="width: 100%" /></td>
					</tr>
					<tr>
					<td align="right" >备注：</td>
					<td colspan="5"><input class="nui-textarea" name="remark" shownullItem="true" required="true" style="width: 100%" /> 
					</tr>
	        	</table>
	        </form>
    	</fieldset>
		 	...
		 	<form id="form1" method="post" >
	        	<table style="table-layout:fixed; width: 100% ">
		            <tr>
						<td align="right" style="width: 12%">重点任务名称:</td>
						<td style="width: 40%">
							<input class="nui-textbox" name="taskName" id="taskNameforjbxx" style="width: 100%" readOnly="readOnly">
						</td>
						<td align="right" style="width: 10%">重点任务方向:</td>
						<td style="width: 35%">
							<input class="nui-textbox" name="taskDirection" id="taskDirectionforjbxx"  required="true" onblur="checkProjectno" style="width: 100%" readOnly="readOnly">
						</td>	
						<td align="right" style="width: 8%">责任单位:</td>
						<td style="width: 35%"><input
								...
								onvaluechanged="changeOrgForm"  readOnly="readOnly"  style="width: 100%"/></td>	
					</tr>
					<tr>
						<td align="right" >申报年度:</td>
						<td>
							<input class="nui-textbox"  name="declareYear" id="declareYearforjbxx"  shownullItem="true" style="width: 100%" readOnly="readOnly">
						</td>
					
						<td align="right" > 计划完成时间:</td>
						<td><input
								name="planCompleteTime" id="planCompleteTimeforjbxx"
								class="nui-datepicker" required="true" readOnly="readOnly" style="width: 100%"/></td>
					</tr>
					<tr>
						<td align="right">决策情况:</td>
						<td  colspan="5">
							<input class="nui-textarea" name="decisionSituation" id="decisionSituationforjbxx" shownullItem="true" style="width: 100%" required="true" readOnly="readOnly">
						</td>
					</tr>
					<tr>
						<td align="right" >完成情况:</td>
						<td  colspan="5">
							<input class="nui-textarea" dictTypeId="zh_keytaskstatus" name="completion" id="completionforjbxx" style="width: 100%" shownullItem="true" readOnly="readOnly">
						</td>
					</tr>
					<tr>
						<td align="right" >年度目标:</td>
						<td  colspan="5">
							<input name="yearTarget" id="yearTargetforjbxx" class="nui-textarea" showClose="false" style="width: 100%" allowInput="true" required="true" readOnly="readOnly"/>
						</td>
					</tr>
					<tr>
						<td align="right">总体目标:</td>
						<td  colspan="5">
							<input class="nui-textarea"  name="populationTarget" id="populationTargetforjbxx" style="width: 100%" required="true" readOnly="readOnly">
						</td>
					</tr>
					<tr>
						<td align="right" > 问题及纠偏措施:</td>
						<td  colspan="5">
							<input class="nui-textarea"  name="problemMeasures" id="problemMeasuresforjbxx" style="width: 100%" shownullItem="true" readOnly="readOnly">
						</td>
					</tr>
					<tr>
						<td align="right">备注:</td>
						<td  colspan="5">
							<input class="nui-textarea" name="remark" id="remarkforjbxx" style="width: 100%" onvaluechanged="changeexpcontsum" readOnly="readOnly">
						</td>
					</tr>
	        	</table>
	        </form>
 ...
 allowResize="true" pageSize="20" allowCellEdit="true" allowCellSelect="true" multiSelect="true" editNextOnEnterKey="true">
	...
	function submit(){
    			...
    			var json = nui.encode({"selfValuate":data}); 
    			
    			var name = nui.get("keytaskId").text;
		  		
				if(!confirm("是否提交重点任务"+name+"的自评")){
        				return;
        			}else{	
        				
		    		 nui.ajax({
		                url: "com.zhonghe.ame.imptask.selfValuater.addSelfValuate.biz.ext",
		                data: json,
		                type: 'POST',
		                cache: false,
		                contentType: 'text/json',
		                success: function (text) {
		                	 ...
		                	 if(text.result==1){
		                	 nui.alert("重点任务自评提交成功","系统提示",function(){
