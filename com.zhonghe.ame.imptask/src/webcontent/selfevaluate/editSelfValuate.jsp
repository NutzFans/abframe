...
<body>
	<div class="nui-fit">
		<fieldset style="border:solid 1px #aaa;padding:3px; width:99%;height:27%; ">
		 	...
		 	<form id="form2" method="post" >
	        	...
	        	<table style="table-layout:fixed; border-spacing:1px " id="table_file1"  >
	        			<tr>
							...
							<td>
								<input class="nui-spinner"  maxValue="999999999" name="annualFractionForecast" id="annualFractionForecast" style="width:310px" required="true">
							</td>
									
							<td align="right" style="width:160px">完成率：</td>
							<td>
								<input class="nui-spinner" name="completeRate" id="completeRate" style="width:310px" required="true">
						...
						<td align="right" style="width:160px">进展情况：</td>
							<td style="width: 130px" colspan="7"><input
									name="progress" id="progress"
									class="nui-textbox"  style="width: 1300px" required="true" /></td>
						</tr>
			            ...
			            <td align="right" style="width:160px" > 年度完成情况预测：</td>
							<td style="width: 130px" colspan="5"><input
									name="annualCompeteForecast" id="annualCompeteForecast"
									class="nui-textarea" required="true" style="width: 1300px " /></td>
						</tr>
						<tr></tr>
						<tr></tr>
						<tr></tr>
						...
						<td colspan="7"><input class="nui-textarea"
									dictTypeId="ZH_TASK_STATUS"  name="remark" shownullItem="true"
									style="width: 1300px;" required="true" id="remark" /> 
						</tr>
		 	...
		 	<form id="form1" method="post" >
	        	<table style="table-layout:fixed; border-spacing:10px " id="table_file1">
						...
						<tr>
							...
							<td align="right" style="width:160px">申报年度:</td>
							<td  colspan="2";>
						...
						<tr>
							...
							<td  colspan="8";>
								<input class="nui-textarea" name="decisionSituation" id="decisionSituationforjbxx" style="width:1300px;height: 40px" shownullItem="true" required="true" readOnly="readOnly">
							</td>
						</tr>
						<tr>
