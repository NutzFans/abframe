...
<body>
		 	...
		 	<form id="form1" method="post" >
	        	<table style="table-layout:fixed;" id="table_file1">
			            <tr>
							...
							<td  colspan="2">
								<input class="nui-textbox" name="taskName" id="taskName" style="width:88%; height:100% " readOnly="readOnly">
							</td>
						</tr>
						<tr>	
							<td align="right" style="width:128px">重点任务方向：</td>
							<td  colspan="2">
								<input class="nui-textbox" name="taskDirection" id="taskDirection" style="width:88%" required="true" onblur="checkProjectno" readOnly="readOnly">
							</td>
						</tr>
						<tr>	
							...
							<td  colspan="7" >
									...
									<span>实际完成时间:</span>
									<input name="actualCompleteTime" id="actualCompleteTime"  readOnly="readOnly" class="nui-datepicker" style="width: 20%"/>
							</td>	
						...
						<tr>
							...
							<td  colspan="8">
								<input name="yearTarget" id="yearTarget" class="nui-textarea" style="width:1033px;height: 40px" showClose="false" allowInput="true"  readOnly="readOnly"/>
							</td>
						<tr>
							<td align="right" style="width:128px">总体目标：</td>
							<td  colspan="8";>
								<input class="nui-textarea"  name="populationTarget" id="populationTarget" style="width:1033px;height: 40px"  readOnly="readOnly">
							</td>
						</tr>
						...
						<tr>
							...
							<td  colspan="8">
								<input class="nui-textarea" name="decisionSituation" id="decisionSituation" style="width:1033px;height: 40px" shownullItem="true"  readOnly="readOnly">
							</td>
						</tr>
    ...
    <script type="text/javascript">
    	...
    	function init(){ 
			...
			ajaxCommon({
				"url": "com.zhonghe.ame.imptask.newKeytask.getKeytaskById.biz.ext",
				"data": json,
				"success": function(data) {
					form.setData(data.data);
		            nui.get("declareYear").setValue(data.data.declareYear.substr(0,4));
