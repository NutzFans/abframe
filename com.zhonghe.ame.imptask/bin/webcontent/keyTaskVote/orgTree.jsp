...
<body>
    ...
    <div class="nui-fit">
        ...
        <ul id="tree1" class="nui-tree" style="width:100%;height:100%;" url="com.zhonghe.ame.imptask.keytask.getAllRunOrgsforzdrw.biz.ext"
            showTreeIcon="true" textField="orgname" dataField="orgname" idField="orgid" parentField="omOrganization.orgid" resultAsTree="false"  
...
/*     tree.load("com.zhonghe.ame.purchase.purchaseItems.queryAllPurItem.biz.ext");*/
