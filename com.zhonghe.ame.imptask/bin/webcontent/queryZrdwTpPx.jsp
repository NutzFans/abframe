...
<body>
<div class="nui-panel" title="责任单位投票排序报表" style="width:100%;height: 100%">
    <div id="form1">
        <div class="nui-toolbar" style="border-bottom: 0; padding: 0px;">
            <table align="center" border="0" width="100%" class="form_table">
                <tr>
                    <td class="form_label" align="center">投票名称 
                        <input id="combo1" class="nui-combobox" textField="vote_code" valueField="id" required="true" />
                    </td>
                    <td> 年度: 
    ...
    <div class="nui-fit" >
        <div id="datagrid1" dataField="votes" 
             sizeList="[10,20,50,100]" showPager="true"  sortMode="client"
             class="nui-datagrid" style="width: 100%; height: 100%;"
             url="com.zhonghe.ame.imptask.keyTaskVote.orderByVote.biz.ext">
            <div property="columns">
                <div field="ranking2" align="center" headerAlign="center">排行</div>
                <div field="vote_code" align="center" headerAlign="center">投票名称</div>
                <div field="by_voting_name" align="center" headerAlign="center">责任单位名称</div>
...
<script type="text/javascript">
    ...
    function jw() {
        ...
        nui.ajax({
            url:"com.zhonghe.ame.imptask.keyTaskVote.queryVoteCode.biz.ext",
            type:"post",
    ...
    function exportExcel() {
        ...
        nui.ajax({
            url : "com.zhonghe.ame.imptask.keyTaskVote.exportOrgVote.biz.ext",
            type : "post",
            data : json,
            cache : false,
