...
<body background='<%=SkinUtil.getStyleFile("images/abf/topback.gif",request)%>' leftmargin="0" topmargin="0" >
<div >
<%if(LogonUtil.isLogon(request)){%>
   <ul>
	...
	<li><a href="#" onclick="doBackFirst()"><b:message key="l_front" /></a></li>
	<li><a href="/default/sso.login?SSOLOGOUT=true" target="_top"><b:message key="l_logout" /></a></li>
...
<script>
	function doBackFirst(){
	  var target = 'bodyFrame';
	  parent.frames[target].location.href = "<%=request.getContextPath() %>/common/skins/layouts/default/body.jsp";
	}
</script>
</body>
</html>
