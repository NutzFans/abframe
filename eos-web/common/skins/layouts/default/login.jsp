...
<table border="0" cellpadding="0" cellspacing="0" class="centertable">
	...
	<tr>
	    <td colspan="3" align="center" style="font-size: 15">温馨提示：<br/>请尽量使用IE内核的浏览器！高版本浏览器请使用兼容性视图！<br/>如果登录后左侧的菜单树不显示；或者新增报销单时，无法添加解释。<br/>请使用浏览器的兼容模式访问！</td>
	</tr>	
	<tr>
	    <td colspan="3" align="center" style="font-size: 15"><font color="green"><a href="/default/other/maintain.htm">2016年标准产品售后服务指南</a></font></td>
	</tr>	
	<tr>
	    <td colspan="3" align="center" style="font-size: 15"><font color="green"><a href="/default/other/train.htm">2016年标准产品培训服务指南</a></font></td>
	</tr>
</table>
</div>
</body>
