...
<%if(LogonUtil.isLogon(request)){%>
   <ul>
	...
	<li><a href="<%=request.getContextPath() %>/org.gocom.abframe.auth.Login.flow" target="_top"><b:message key="l_front" /></a></li>
	<li><a href="/sso-server/logout" target="_top"><b:message key="l_logout" /></a></li>
