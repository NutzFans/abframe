...
function drawStates (states,participants,context,imgTemplate,participantsListTemplate) {
	...
	for (prop in states) {
		...
		var activityInfos = [];
		activityInfos.push("<table id='activity_info' style='white-space:nowrap;text-align:center;border-collapse:collapse;width:400px;' cellspacing='0px' border='1px'>");
		//活动类型
		activityInfos.push("<tr>");
		activityInfos.push("<td width='215px'>");
		activityInfos.push(context.activityType);
		activityInfos.push("</td>");
		activityInfos.push("<td width='185px'>");
		...
		var content = "<table style='white-space:nowrap;text-align:center;border-collapse:collapse;width:400px;' cellspacing='0px' border='1px'>";
		content += "<tr><td width='70px'>" + context.partiName + "</td><td width='145px'>" + 
					context.startTime + "</td><td width='145px'>" + context.endTime + "</td><td width='40px'>" + context.timeOut + "</td></tr>";
