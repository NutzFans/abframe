...
<script>
	$.ajax({
			...
			async:false,
  			url:"com.primeton.report.getMenuAndCode.getMenuCode.biz.ext",
...
<%
	...
	if(paramNames!=null){
		...
		if (paramFile.equals("ame_DepositReceived_arg.rpx") || paramFile.equals("ame_AccountsReceivable_arg.rpx") || 
			paramFile.equals("csContractRecognisedIncomeByProduct_arg.rpx")|| paramFile.equals("csContractRecognisedIncomeByYear_arg.rpx") ||
			paramFile.equals("csContractDepartmentRecord_arg.rpx")|| paramFile.equals("csGatherFc_arg.rpx")){
			//登录名加入参数	
