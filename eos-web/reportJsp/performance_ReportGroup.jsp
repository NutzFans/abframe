...
<%	//如果参数模板存在，则显示参数模板
	if( f.exists() ) {
	%>
	<table height="60px" align="center" width="536px"><tr><td align="center"  style="font-weight:bold;font-size:22px;">绩效报表</td></tr></table>
	<table id=param_tbl  bgcolor="#F3F3F5"><tr><td>
