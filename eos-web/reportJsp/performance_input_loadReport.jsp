...
<report:group groupFileName="rpt_test_unit.rpg" needPrint='yes' needSaveAsExcel='yes' needSaveAsPdf='yes'  needSaveAsWord='yes'/>
 ...
 <button onclick="loadPage('testLoadReport_report.jsp?info=5')" ><img src="../images/search.gif" border=no style="vertical-align:middle"></button>
<button onclick="loadPage('testLoadReport_report.jsp?info=haha')" >haha</button>
<button onclick="loadPage('testLoadReport_report.jsp?info=6')" >6</button>
<button onclick="loadPage('testLoadReport_report.jsp?info=abc')" >abc</button>
 -->
...
function doPerformance(orgid,orgname,orgseq){
	...
	//$("img.lazy").show();
	// $("img.lazy").css("display","");
	loadPage("testLoadReport_report.jsp?unitno="+orgseq+"&year=2013&startmonth=1&endmonth=5");
