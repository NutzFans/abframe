...
<div>
<%=java.net.URLEncoder.encode("中文", "ISO-8859-1")%>
</div>
	<div id='bodyDiv' style='width:100%;height:100%;display:none;'>
		...
		<div class='mainPanel' style="border:0px;width:100%;height:100%;overflow:hidden;position:;">
			<div class='ui-layout-toolbar' style="overflow:hidden;font-size:14px;position:absolute;top:0;border:0px;height:50px;z-index:30001;background-color:#41455A;width:100%;">
				...
				<a title="分析数据" href="javascript:submitAnalyse()" style="color:#DFDFE3;vertical-align:20px;text-decoration: none;"><img src="<%=guideDir %>img/guide/15.png" style="vertical-align:-7px;margin:0 10px;"/></a>
				<a title="查询数据" href="javascript:submitQuery()" style="color:#DFDFE3;vertical-align:20px;text-decoration: none;"><img src="<%=guideDir %>img/guide/3.png" style="vertical-align:-7px;margin:0 10px;"/></a>
				<a title="撤销" href="javascript:operations.undo()" style="color:#DFDFE3;vertical-align:20px;text-decoration: none;"><img src="<%=guideDir %>img/guide/4.png" style="vertical-align:-7px;margin:0 10px;"/></a>
				<a title="重做" href="javascript:operations.redo()" style="color:#DFDFE3;vertical-align:20px;text-decoration: none;"><img src="<%=guideDir %>img/guide/32.png" style="vertical-align:-7px;margin:0 10px;"/></a>
...
<div id="analyseView" style="display:none;">
	...
	<div id="confFieldFloat" style="display:none;background-color:#F3F3F3;border: 1px solid #CCC;">
		...
		<div seq="16" style="margin:2px 5px;" onclick="aly.confField.where(1)"><img src="<%=guideDir %>img/guide/7.png" style="vertical-align:-3px;" />数据过滤</div>
		<div seq="19" style="margin:2px 5px;" onclick="aly.confField.where(2)"><img src="<%=guideDir %>img/guide/49.png" style="vertical-align:-3px;" />组后过滤</div>
		<div seq="20" style="margin:2px 5px;" onclick="aly.confField.rela()"><img src="<%=guideDir %>img/guide/16.png" style="vertical-align:-3px;" />维源字段</div>
	...
	<div class='ui-layout-north' style="font-size:14px;position:absolute;top:0;border:0px;height:50px;z-index:30001;background-color:#41455A;width:100%;">
		...
		<a id="analyseBut1" href="javascript:saveOlap()" style="visibility:hidden;color:#DFDFE3;vertical-align:20px;text-decoration: none;margin-right:10px;"><img src="<%=guideDir %>img/guide/save.png" style="vertical-align:-7px;margin:0 5px;"/>保存</a>
		<a id="analyseBut2" href="javascript:openOlap()" style="visibility:hidden;color:#DFDFE3;vertical-align:20px;text-decoration: none;margin-right:10px;"><img src="<%=guideDir %>img/guide/2.png" style="vertical-align:-7px;margin:0 5px;"/>打开</a>
		<a id="analyseBut3" href="javascript:openDataFile()" style="visibility:hidden;color:#DFDFE3;vertical-align:20px;text-decoration: none;margin-right:10px;"><img src="<%=guideDir %>img/guide/2.png" style="vertical-align:-7px;margin:0 5px;"/>数据文件</a>
		<a id="analyseBut4" href="javascript:relocalReports(1)" style="visibility:hidden;color:#DFDFE3;vertical-align:20px;text-decoration: none;margin-right:10px;"><img src="<%=guideDir %>img/guide/8.png" style="vertical-align:-7px;margin:0 5px;"/>横向平铺</a>
		<a id="analyseBut5" href="javascript:relocalReports(2)" style="visibility:hidden;color:#DFDFE3;vertical-align:20px;text-decoration: none;margin-right:10px;"><img src="<%=guideDir %>img/guide/34.png" style="vertical-align:-7px;margin:0 5px;"/>纵向平铺</a>
		<a id="analyseBut6" href="javascript:relocalReports(3)" style="visibility:hidden;color:#DFDFE3;vertical-align:20px;text-decoration: none;margin-right:10px;"><img src="<%=guideDir %>img/guide/5.png" style="vertical-align:-7px;margin:0 5px;"/>重叠显示</a>
		<a id="analyseBut7" href="javascript:downloadData('txt')" style="visibility:hidden;color:#DFDFE3;vertical-align:20px;text-decoration: none;margin-right:10px;"><img src="<%=guideDir %>img/guide/txt.png" style="vertical-align:-7px;margin:0 5px;"/>下载TXT</a>
		<a id="analyseBut8" href="javascript:downloadData('csv')" style="visibility:hidden;color:#DFDFE3;vertical-align:20px;text-decoration: none;margin-right:10px;"><img src="<%=guideDir %>img/guide/txt.png" style="vertical-align:-7px;margin:0 5px;"/>下载CSV</a>
	...
	<div id="analyseConf1" style="width: 762px;display:none;top: 60px; position: absolute; z-index: 20000; right: 20px;">
		<div id="analyseConf2" style="width:752px;height:22px;background-color:#FCA323;padding:4px 0 0 8px;">数据分析设置器<img src="<%=guideDir %>img/guide/45.png" style="cursor:pointer;padding:0 4px;vertical-align:-2px;"/><img src="<%=guideDir %>img/guide/20.png" style="cursor:pointer;padding:0 4px 4px;float:right;"/><div style="clear:both;"></div></div>
