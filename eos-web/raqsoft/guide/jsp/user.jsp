...
<body style="margin:0;padding:0;">
	...
	<br/><br/>
	<form id="form1" action="<%=cp %>/raqsoft/guide/jsp/userQuery.jsp" target="frame2" method="post" accept-charset="UTF-8">
		<input type='text' name='fixedTable' placeholder='表' value='市'/><br/>
		<input id='outerCondition' type='text' name='outerCondition' placeholder='外部条件' value=''/><br/>
		<script language=javascript>
