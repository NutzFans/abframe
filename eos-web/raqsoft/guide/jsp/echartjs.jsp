...
%>
<script type="text/javascript" src="<%=appmap%><%=ReportConfig.raqsoftDir%>/echarts3/dist/echarts.js"></script>
...
<script type="text/javascript" src="<%=appmap%><%=ReportConfig.raqsoftDir%>/echarts3/map/js/province/hainan.js"></script>
