...
<script>
	...
	queryApi.event = {
		init : function() {
			...
			guideConf.queryTableMargin = "40px 25px 0";
		}
	}
	queryApi.event.init();
	...
	*/
	$(document).ready(function(){
		...
		$('body').append('<a href="javascript:queryApi.submitQuery();" style="position:absolute;top:10px;left:500px;z-index:50000;">查询</a>');
		//$('body').append('<a href="javascript:queryApi.saveQyx();" style="position:absolute;top:10px;left:550px;z-index:50000;">保存</a>');
		//$('body').append('<a href="javascript:queryApi.openQyx();" style="position:absolute;top:10px;left:600px;z-index:50000;">打开</a>');
	});
