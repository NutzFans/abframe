...
if (queryType == null) queryType = "mix";
...
<script>
	...
	*/
	...
	guideConf.queryType = "<%=queryType%>";
	guideConf.treeStatus = "close";
	guideConf.reSort = "yes";
	guideConf.dimAreaWidth = guideConf.queryType!='detail'?100:1;
	guideConf.fixedTable = "<%=fixedTable%>";
	guideConf.treeStatus = guideConf.fixedTable.split(",").length>5?"close":"open";
	
	guideConf.analysePage = "raqsoft/guide/jsp/centerAnalyse.jsp";//分析界面，用来显示查询结果
	
	guideConf.detectLevel = 4;
	guideConf.dimDataOnServer = "WEB-INF/files/data/dimData.json";
	guideConf.maxDimSize = 1000;
