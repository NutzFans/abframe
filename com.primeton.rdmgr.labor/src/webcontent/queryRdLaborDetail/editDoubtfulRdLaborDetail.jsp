			...
			<div style="padding:5px;"> 
				<table>
					...
					<tr>
						...
						<td style="width:200px;" >    
	                       <input property="editor" class="nui-dictcombobox" name="rdlabordetail.status" id="status" required="true" dictTypeId="AME_LABOR_STATUS" style="width:80%;" readOnly="readOnly"/>
	                    </td>
						...
						<td style="width:200px;">    
	                       <input property="editor" class="nui-combobox" name="rdlabordetail.otwHours" id="otwHours"  data="otwHoursdata"  required="true"  style="width:80%;" />
	                    </td>
					</tr>
					...
					<tr>
						<td align="right" style="width:120px;display:none;">工时转换成本：</td>
					...
					<tr>
	                    <td align="right" style="width:120px;">工时疑问信息：</td>
	                    <td style="width:200px;" colspan="3">  
	                    	<input class="nui-textarea" vtype="rangeLength:0,100" name="rdlabordetail.benefconfq" id="benefconfq" required="true" style="width:95%;" readOnly="readOnly"/>
						</td>
					</tr>
					<tr>
	                    <td align="right" style="width:120px;">工时疑问反馈：</td>
	                    <td style="width:200px;" colspan="3">  
	                    	<input class="nui-textarea" vtype="rangeLength:0,100" name="rdlabordetail.benefconfr" id="benefconfr" required="false" style="width:95%;"/>
						</td>
					</tr>
				</table>
			</div>
	...
	<script type="text/javascript">
        ...
        init();
       	function init(){
			...
			nui.ajax({
	            ...
	            success: function (o) {
	            	...
	            	syorgid=o.rdlabordetail.syorgid;
                    ...
                    if(ispmos == "true"){
                    	...
                    	statusdata.push({"dictID": '2',"dictName": "受益部门疑问"});
                    	statusdata.push({"dictID": '3',"dictName": "PMO审核确认"});
                    	statusdata.push({"dictID": '4',"dictName": "财务已核算"});
                    }
       	...
       	function watchactHours(){
            ...
            var standcost = price/8*actHours;
	    ...
	    //保存
     	function onOk(e) {
     		if(form.validate()){
     			...
     			if(data.rdlabordetail.syorgid != syorgid){
     				data.rdlabordetail.status='1';
     				data.rdlabordetail.benefconfq = '';
     				data.rdlabordetail.syorgidOld = syorgid;
     			}
     			nui.ajax({
                    type:'get',
                    data:data,
