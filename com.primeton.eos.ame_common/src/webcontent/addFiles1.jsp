...
<div>
	<fieldset id="field2" style="border:solid 1px #aaa;padding:3px;">
			<form id="form4" class="" action="com.primeton.eos.ame_common.ame_fileupload1.flow" target="hidden_frame1" method="post" enctype="multipart/form-data">
				<!--附件存放目录-->
				...
				<table id="filetable1" width="100%" style="border-collapse:collapse" bordercolor="#A8A8A8" border="1" cellspacing="0" cellpadding="1"  align="center">
					<tr><!-- 保持一致限制必须上传文件时，比如收入预估流程编辑页面要读取这个table的data.length -->
						<input type="button" value="增加附件" onclick="addFile1()"/>
