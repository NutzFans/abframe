...
<div class="nui-fit" style="border:solid 1px #aaa;padding:0px;width:auto">
    ...
    <div title="日志">
		<jsp:include page="/ame_common/operatLog.jsp?groupid=NOTICE">
			<jsp:param name="relationid" value="<%=request.getParameter("id")%>"/>
			<jsp:param name="mes" value="评论"/>
		</jsp:include>
	</div>
    <!--body-->
    ...
    var editor1 = null;
 	...
 	function SetData(data){
    	...
    	nui.ajax({
            ...
            success: function (o) {
                obj = nui.decode(o);
                nui.get("grid_001").load({"groupid":groupid,"relationid":noticeid});
