...
<div style="width:auto;height:380px;" id="form1">
	...
	<table style="width:100%;">
            <tr>
				...
				<td align="left" colspan="5"><input name="ameNotice.noticetitle" id="noticeTitle" class="nui-textbox" required="true" style="width:771px"/></td>
            </tr>
            <tr>
...
<script type="text/javascript">
	...
	function onOk(){
	 ...
	 function SaveData(){
	    ...
	    if(form.isValid()){
	    	nui.ajax({
	        url: "com.primeton.eos.ame_common.ameNotice.addNotice.biz.ext",
			type: 'POST',
			data: json,	
