...
<body>
	...
	<div id="grid_3" class="nui-datagrid" style="width:100%;height:auto;" showPager="false" sortMode="client" url="com.primeton.eos.ame_common.file.getFiles.biz.ext" dataField="files" allowCellEdit="true" allowCellSelect="true" multiSelect="true" editNextOnEnterKey="true">
		<div property="columns">
			...
			<div renderer="deleteContractFile3" width="80" headerAlign="center" align="center">操作</div>
			<div field="fileName"width="200" headerAlign="center" align="left" renderer="getdetail3">附件名称</div>
	...
	<script>
    	...
    	var isViewDelete3 = true;//判断是否要展示删除按钮
        //附件下载
        ...
        function deleteContractFile3(e){
	        var record = e.record;
	        var uid = record._uid;
	        var groupId = record.groupId;
	        var s;
	        if(isViewDelete3){
	        	s = ' <a class="Edit_Button" uid="'+uid+'" grid="grid_3" onclick="preview(this)" href="javascript:void(0)" >预览</a>'
                    + " <a href='javascript:void(0)' onclick='deleteFile3(" + uid + ")'>删除</a>";
            }else{
            	s = ' <a class="Edit_Button" uid="'+uid+'" grid="grid_3" onclick="preview(this)" href="javascript:void(0)" >预览</a>';
            }
            return s;
