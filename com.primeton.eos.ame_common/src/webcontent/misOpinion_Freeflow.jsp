...
<body>
	<form id="opioionform" method="post">
		...
		<fieldset style="border: solid 1px #aaa;">
			...
			<div id="datagrid1" class="nui-datagrid" style="width: 100%; height: auto;" dataField="misOpinions" url="com.primeton.eos.ame_pur.purContractProcess.queryAuditOpinions.biz.ext" idField="id"
				...
				<table style="table-layout: fixed;">
					...
					<tr id="choosehide">
						...
						<td style="width: 250px;" colspan="3">
							...
							<input name="misOpinion.isNode" id="isNode" class="nui-checkbox" checked="true" />
							<span>驳回的节点通过后直接返回本节点</span>
						</td>
					</tr>
					<tr id="auditop">
