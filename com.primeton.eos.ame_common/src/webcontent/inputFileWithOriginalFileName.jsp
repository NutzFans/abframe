...
<div>
  <div class="nui-toolbar" id="filedetail" style="border-bottom:0;padding:0px;">
	...
	<fieldset id="field2" style="border:solid 1px #aaa;padding:3px;">
		<form id="form2" class="" action="com.primeton.eos.ame_common.ame_fileupload_withOriginalFileName.flow" target="hidden_frame" method="post" enctype="multipart/form-data">
			<!--附件存放目录-->
