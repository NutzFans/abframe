...
<body>
	<div>
		<div class="nui-toolbar" id="filedetail" style="border-bottom: 0; padding: 0px;">
			<table style="width: 100%;">
				<tr>
					<td id="fileTd">相关附件</td>
				</tr>
			</table>
		</div>
		<div id="grid_0" class="nui-datagrid" style="width: 100%; height: auto;" showPager="false" sortMode="client" url="com.primeton.eos.ame_common.file.getFiles.biz.ext" dataField="files"
	...
	<script type="text/javascript">
		...
		function onActionRenderer(e) {
			...
			var s = ' <a class="Edit_Button" uid="' + uid + '" grid="grid_0" onclick="openFile()" href="javascript:void(0)" >预览</a>' + ' <a class="Delete_Button" href="javascript:remove(\'' + uid
					+ '\')">删除</a>';
			return s;
		}
