...
<script type="text/javascript">		    	   	   
	...
	function saveData(){
        ...
        nui.ajax({
	          url:"com.primeton.eos.ame_common.ameWhitelist.updateWhitelist.biz.ext",
	          type:'POST',
	          data:json,
	          cache:false,
	          	...
	          	var returnJson = nui.decode(text);
		            if(returnJson.exception == null){
		            	if(returnJson.result == "1"){
		            		...
		            		nui.alert("已存在对应有效的白名单记录，本次修改未生效，请检查！", "系统提示", function(action){
			            		return;			                            
			            	});
		            	}else{
	...
	function setFormData(data){
    	//跨页面传递的数据对象，克隆后才可以安全使用
      	...
      	//保存list页面传递过来的页面类型：add表示新增、edit表示编辑
        	...
        	form.setData(json);
        	nui.get("username").setText(json.whitelist.username);
