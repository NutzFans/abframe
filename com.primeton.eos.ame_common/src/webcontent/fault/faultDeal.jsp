...
<div class="nui-fit">
        ...
        <fieldset id="field1" style="border:solid 1px #aaa;padding:3px;">
            ...
            <table id="table_file">
                ...
                <tr>
                    ...
                    <td sytle="width:150px;" align="left" colspan="5">
    ...
    <form id="form2" method="post" >
		<input name="probinfodeal.probdealid" id="probdealid" class="nui-hidden" />     
        <fieldset style="border:solid 1px #aaa;padding:3px;">
            <legend>故障处理信息</legend>           
            <div style="padding:5px;">
            <table>
                <tr>
                    <td style="width:120px;" align="right">故障处理人：</td>
                    <td style="width:150px;">    
						<input property="editor" name="probinfodeal.probdealer" id="probdealer" class="nui-buttonedit" onbuttonclick="showEmployee" showClose="false" required="true" allowInput="false"  />
                    </td>
                    <td style="width:120px;" align="right">故障处理日期：</td>
                    <td style="width:150px;">    
                        <input name="probinfodeal.probdealdate" id="probdealdate" class="nui-datepicker" required="true"/>
                    </td>
                </tr>
                <tr>
					<td style="width:120px;" align="right">故障处理描述：</td>
	                <td style="width:150px;" colspan="5">    
                        <input name="probinfodeal.probdealinfo" id="probdealinfo" class="nui-textarea" required="true" style="width:400px;"/>
                    </td>                
                </tr>
				<tr>
                	<td style="width:120px;" align="right">备注：</td>
                	<td style="width:150px;" colspan="5">    
                        <input name="probinfodeal.probdealremark" id="probdealremark" class="nui-textarea" required="false" style="width:400px;"/>
                    </td>
                </tr>
	            <tr>
...
<script type="text/javascript">
	...
	function SetData(data){	
		...
		nui.get("probdealresult").disable();
		nui.get("remark").disable();
            ...
            dealprobid = data.probid;
            
            <!-- 查找故障处理历史记录 -->
            var probinfodeal = {};

/*	            nui.ajax({
                url: "com.primeton.eos.fault.fault.getFaultDeal.biz.ext",
				type: 'POST',
				data: json2,	
				contentType: 'text/json',
                success: function (o) {
                   	alert("datagrid loaded");
                },
                error: function () {
                	alert("Ajax call error");
               }                
...
*/                          
	...
	function SaveData() {		
		...
		data.probinfodeal.probid = dealprobid;
        var json = nui.encode(data);
        nui.ajax({
            url: "com.primeton.eos.ame_common.fault.addFaultDeal.biz.ext",
            data: json,
            type: 'POST',
            cache: false,
            contentType: 'text/json',
