		       ...
		       <legend>基本信息</legend>
		       		<table style="table-layout:fixed;">
						...
						<tr>
							...
							<td>
								<input name="seal.subject" class="nui-dictcombobox" dictTypeId="company" style="width:150px" />
							</td>
						</tr>
						<tr>
							<td align="right" style="width:120px;">用章事由：</td>
							<td colspan="5">
								<input name="seal.memo" id="memo" class="nui-textarea" required="true" style="width: 100%;height: 140px;" maxLength="500"/>
							</td>
						</tr>
					</table>
		     </fieldset>
