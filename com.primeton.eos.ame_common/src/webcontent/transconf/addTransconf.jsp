...
<body>
        	...
        	<div style="padding:5px;">   		
            	<table>
					...
					<tr>
	                    <td>财务核算成本:</td>
						<td style="width:160px;">
							<input name="AmeTransconf.sybjtcb" id="sybjtcb" class="nui-spinner" onblur="changetransconf" changeOnMousewheel="false" style="width:100%" required="true" format="n2" showbutton="false"  minValue="-100000000" maxValue="100000000"/>
						</td>
						<td>工时总成本:</td>
						<td style="width:160px;">
							<input name="AmeTransconf.laborcost" id="laborcost" class="nui-spinner" onblur="changetransconf" changeOnMousewheel="false" style="width:100%" required="true" format="n2" showbutton="false"  minValue="-100000000" maxValue="100000000"/>
						</td>
					</tr>
					<tr>
						<td>不含加班工时总成本:</td>
						<td style="width:160px;">							
							<input name="AmeTransconf.laborncost" id="laborncost" class="nui-spinner" changeOnMousewheel="false" style="width:100%" required="true" format="n2" showbutton="false"  minValue="-100000000" maxValue="100000000" value="0.0"/>
						</td>
	                    <td>系数：</td>
	                    <td style="width:160px;">    
	                       <input name="AmeTransconf.transconf" id="transconf" class="nui-textbox" style="width:100%" required="true" onblur="checkNum(3)" onclick="clear()"  value="财务核算成本/工时总成本">
	                    </td>
					</tr>
				</table>
			</div>  
	...
	<script type="text/javascript">
    	var saveURL = "com.primeton.eos.ame_common.ameTransconf.addTransconf.biz.ext";
        nui.parse();
        <%
        ...
        function checkdatein(){
            ...
            var json = {checkstartdate:startdate,checkenddate:enddate,checkorg:orgdata};
        ...
        function onOk(e) {
			...
			var getOrg = nui.get("org").getValue();
			if(getOrg == "" || getOrg == null){
				alert("请选择事业部!");
				return;
			}
			var getLabor = nui.get("laborcost").getValue();
