...
<body>
	...
	<div id="grid_1" class="nui-datagrid" style="width:100%;height:auto;" showPager="false" sortMode="client" url="com.primeton.eos.ame_common.file.getFiles.biz.ext" dataField="files" allowCellEdit="true" allowCellSelect="true" multiSelect="true" editNextOnEnterKey="true">
		<div property="columns">
			...
			<div renderer="deleteContractFile1" width="70" headerAlign="center" align="center">操作</div>
			<div field="fileName"width="200" headerAlign="center" align="left" renderer="getdetail1">附件名称</div>
	...
	<script>
        ...
        function deleteContractFile1(e){
	        var record = e.record;
	        var uid = record._uid;
	        var s;
	        if(isViewDelete){
	        	s = ' <a class="Edit_Button" uid="'+uid+'" grid="grid_1" onclick="openFile(this)" href="javascript:void(0)" >预览</a>'
