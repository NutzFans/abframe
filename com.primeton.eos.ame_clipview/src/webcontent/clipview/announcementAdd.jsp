...
<body>
	...
	<div style="text-align: center; position: relative; bottom: 10px" class="nui-toolbar">
		<a class="nui-button" onclick="onOk()" iconCls="icon-ok" style="width: 80px; margin-right: 20px;">发布</a>
	...
	<script type="text/javascript">
		...
		function SaveData() {
			...
			ajaxCommon({
				"url" : "com.primeton.eos.ame_newlook.newlook.addAnnouncement.biz.ext",
				"data" : json,
