	...
	<div class="nui-fit">
		...
		<form id="form1" method="post">
				...
				<div style="padding:5px;">
					<table style="table-layout:fixed;" id="table_file">
						...
						<tr>
							...
							<td colspan="3"><input name="purSettle.contnum" id="contnum" showButton="false" readOnly="readOnly" class="nui-buttonedit" style="width:100px" /></td>
						</tr>
						<tr>
			...
			<fieldset id="field3" style="border:solid 1px #aaa;padding:3px;width: 1250px;">
				...
				<table style="table-layout:fixed;">
					<tr>
						<td align="right" style="width:310px;">总计：</td>
						<td id="sumtotalworkamount" style="width:125px;" align="center" ></td>
						<td style="width: 250px;"></td>
						<td id="sumtotalpre" style="width:200px" align="right" ></td>
					</tr>
				</table>
				</div>
			</fieldset>
