...
<div class="nui-fit">
	...
	<jsp:include page="/ame_common/ameFlowOperTips/ameFlowOperTipsInfo.jsp"/>
		<form id="form1" method="post">
			<fieldset id="field1" style="border:solid 1px #aaa;padding:3px;">
				...
				<input name="workitem.activityDefID" id="activityDefID" class="nui-hidden" />
				<input name="workitem.workitemid" id="workitemid" class="nui-hidden" />
				
				<!-- <input name="purSupplier.isdefault" id="isdefault" class="nui-hidden" />
				 -->
	...
	<div style="text-align:center;padding:10px;" class="nui-toolbar">
		...
		<a class="nui-button" onclick="onOk(0)" id="breakPurCont"style="width:80px;margin-right:20px;">终止流程</a> 
