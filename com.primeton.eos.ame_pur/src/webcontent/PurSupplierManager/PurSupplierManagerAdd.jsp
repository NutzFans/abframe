	...
	<div class="nui-fit">
		<form id="form1" method="post">
				...
				<table style="table-layout:fixed;" id="table_file1">
					<tr>
						...
						<td style="width:300px">
							<input name="purSupplier.custid" id="custid" class="nui-buttonedit" 
	    	...
	    	<div style="float: left;margin-left: 10px;">
			    ...
			    <div id="datagridShareholder" class="nui-datagrid" style="width: 490px;;height:auto;" allowResize="false" dataField="purSupplierShareholders" 
					...
					<div property="columns">
						...
						<div field="shareholderName" width="70" align="center" headerAlign="center" allowSort="false">股东姓名
							<input property="editor" class="nui-textbox" style="width: 100%"/>
						</div>
						<div field="shareholderCardno" width="170" align="left" headerAlign="center" allowSort="false">身份证号码
							<input property="editor" class="nui-textbox" style="width: 100%"/>
						</div>
						<div field="shareholdingRatio" width="auto" align="left" headerAlign="center" allowSort="false" numberFormat="p">持股比例
			...
			<div style="float: left;margin-left: 10px;">
				...
				<div id="datagridExecutives" class="nui-datagrid" style="width: 520px;height:auto;" allowResize="false" dataField="purSupplierExecutives" 
					...
					<div property="columns">
						<div type="checkcolumn" width="25"></div>	
						<div field="executivesName" width="70" align="center" headerAlign="center" allowSort="false">高管姓名
							<input property="editor" class="nui-textbox" style="width: 100%"/>
						</div>
						<div field="executivesCardno" width="170" align="left" headerAlign="center" allowSort="false">身份证号码
							<input property="editor" class="nui-textbox" style="width: 100%"/>
						</div>
						<div field="executivesPositions" width="auto" align="center" headerAlign="center" allowSort="false">高管职务
							<input property="editor" class="nui-textbox" style="width: 100%"/>
						</div>
        	...
        	if(form.validate()){
				...
				nui.confirm("确定要保存吗？","系统提示",function(o){
					if(o=="ok"){
			            ...
			            nui.ajax({
			                url: "com.primeton.eos.ame_pur.PurSupplierManager.addPurSupplierManager.biz.ext",
							type: 'POST',
							data: json,	
