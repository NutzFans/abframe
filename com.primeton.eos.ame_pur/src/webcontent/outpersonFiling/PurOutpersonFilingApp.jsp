...
<!-- 
  - Author(s): zyl
  - Date: 2017-01-12 11:05:24
  - Description:
-->
<head>
	<title>重新发起外包人员报备申请</title>
...
<body>
				...
				<div style="padding:5px;">
					<table style="table-layout:fixed;" id="table_file">
						<tr>
							...
							<td><input name="purOutperson.outpername" id="outpername" class="nui-textbox" onblur="checkName" 
						...
						<tr>
							...
							<td><input name="purOutperson.linktel" id="linktel" required="true" class="nui-textbox" style="width:130px" />
							</td>
	...
	<script type="text/javascript">
		...
		//外包人员归属项目
	  	...
	  	init();
		function init(){
			var data={workItemID: <%=workItemID %>,iden: "app"};
