...
<div class="nui-fit">
	...
	<form id="form1" method="post">
			...
			<div style="padding:5px;">
				<table style="table-layout:fixed;" id="table_file">
					<tr>
						...
						<td align="right" style="width:120px;">供应商：</td>
						<td><input name="purSettle.custid"  onbuttonclick="changeCust" <%--onvaluechanged="changeCust"--%> id="custid" readOnly="readOnly" valueField="custid" textField="custname" class="nui-buttonedit" emptyText="请选择供应商" required="true" style="width:200px" allowInput="false" />
						</td>
	     ...
	     <fieldset id="field10" style="border:solid 1px #aaa;padding:3px;">
	     	...
	     	<div id="datagrid10" class="nui-datagrid" dataField="purProjCont" style="width:100%;height:auto;" 
				...
				<div property="columns">
					...
					<div field="settlementno" width="90" align="right" headerAlign="center" allowSort="true">
						结算单编号
						<input property="editor" class="nui-textbox" style="width:100%;" vtype="float" />
					</div>
				</div>
			...
			<div style="width: 100%;height:24px;float:left;">
				<table style="table-layout:fixed;">
					<tr>
						<td align="right" style="width: 380px;">结算费用总计：</td>
	     ...
	     <fieldset id="field3" style="border:solid 1px #aaa;padding:3px;">
			...
			<div id="datagrid2" class="nui-datagrid" dataField="purPresettles" style="width:100%;height:auto;" 
				...
				<div property="columns">
					<div type="checkcolumn" width="30" align="center" visible="true" width="70"></div>
					<div field="accruedid" headerAlign="center" allowSort="true" align="center" visible="true" width="55">计提编号</div>
		             ...
		             <div field="syb" headerAlign="center" allowSort="true" width="80" renderer="dictGetContOrg" >所属事业部</div>
		             ...
		             <div field="accruedstatus" headerAlign="center" allowSort="true" renderer="dictGetStatus" width="110" align="center" >状态</div>
			...
			<div style="padding:5px;">
				...
				<table style="table-layout:fixed;" id="table_file">
					<tr>
						...
						<td><input name="expReiList.expRei.total" id="setamount2" readOnly="readOnly"  inputStyle="text-align: right;"  onvaluechanged="changeSetamount"  class="nui-textbox" required="true" style="width:150px" />&nbsp  (元)</td>
						<td align="right" style="width:120px;">税率：</td>
						<td><input name="purSettle.tax" id="tax" onvaluechanged="changePurOutcostTax" class="nui-textbox"  allowLimitValue="false" changeOnMousewheel="false" showButton="false" required="true" inputStyle="text-align: right;" style="width: 100px;" /> %</td>
						</tr>
					<tr>
						<td align="right" style="width:150px;">成本结转金额(不含税)：</td>
						<td><input name="purSettle.notaxmon" id="notaxmon" readOnly="readOnly" class="nui-textbox" inputStyle="text-align: right;" style="width: 150px;" /></td>
						<td align="right" style="width:120px;">付款方式：</td>
						<td><input name="expReiList.expRei.paymode" id="appmode" readOnly="readOnly" class="nui-dictcombobox" dictTypeId="EXP_PAYMODE" required="true" style="width:150px"/></td>
					</tr>
					<tr>
						...
						<td><input name="expReiList.expRei.bankname" id="bankname" readOnly="readOnly" class="nui-textbox" required="true" style="width:150px"/></td>
					</tr>
					<tr>
						...
						<td><input name="erpexptpettyexp.linkman" id="linkman" readOnly="readOnly" class="nui-textbox" required="false" style="width:150px"/></td>
					--%></tr>
					<tr>
					...
					<tr>
					    <%--<td align="right" style="width:150px;">结算单编号：</td>
						<td><input name="purSettle.settlementno" id="settlementno" readOnly="readOnly" class="nui-textbox" required="true" onblur="checkSettlementno" style="width:250px"/></td>--%>
					...
					<span>
					<tr>
						<td align="right" style="width:150px;">报销单：</td>
	...
	<fieldset id="field6" style="border:solid 1px #aaa;padding:3px;">
			...
			<input id="receivernameTemp" class="nui-hidden" />	
				<table>
						...
						<td colspan="3"><input name="amePostservice[0].receivername" readOnly="readOnly" id="receivername" vtype="rangeChar:2,30" class="nui-textbox" required="false"  style="width:250px"/></td>
					    </tr>
						<tr>
						<td align="right" style="width:120px">送递内容：</td>
						<td colspan="3"><input name="amePostservice[0].postcontent" id="postcontent" readOnly="readOnly" class="nui-textbox" required="false"  style="width:250px"/>
						</td>
					   </tr>
				</table>
			</form>
	...
	<form id="opioionform" method="post">
		...
		<fieldset style="border:solid 1px #aaa;padding:3px;">
        	...
        	<div id="datagrid1" class="nui-datagrid" style="width:100%;height:auto;" dataField="misOpinions"
			    ...
			    allowAlternating="true" multiSelect="true" showPager="false" allowCellWrap="true" visible="false">
			    <div property="columns">
   ...
   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div id="allSuccess" name="allSuccess" class="nui-checkbox" readOnly="false" onvaluechanged="onValueChangedAll">财务已收到相应的纸质凭证（发票等），并确认有效。</div>
...
<div style="text-align:center;padding:10px;" class="nui-toolbar">
		...
		<a class="nui-button" onclick="doPrint" style="width:100px;margin-right:20px;" iconCls="icon-print" id="printButton">打印报销单</a>
...
<form name="viewlist1" id="viewlist1" action="com.primeton.eos.ame_common.ameExportCommon.flow" method="post">
   ...
   <input type="hidden" name="fileName" filter="false"/>
	...
	<script type="text/javascript">
		...
		init();
		function init(){
		    promptInit({"workItemID":<%=workItemID %>,"processDefName":"com.primeton.eos.ame_pur.ame_purOtherSettlePay","activityDefID":"manualActivity5"});
			...
			nui.ajax({
				...
				success:function (o){
			        ...
			        nui.get("tax").setValue(o.purSettles[0].tax/0.01);
					...
					//采购结算信息
					//nui.get("pettyexpno").setValue(o.erpexptpettyexp.pettyexpno);
    	...
    	function makeOtherGoSettelpayRev(){
    		...
    		//项目信息
         	...
         	//data.erpexptpettyexpParent=erpexptpettyexpParent;
         	//拼接结算单
    		...
    		data.purSettle.presettleflag = 2;//标识当前是财务收单审核归档
    		//回退信息
		...
		function onOk(){
        	...
        	if(auditstatus == "2" || auditstatus == "0"  ){
			   ...
			   if(rows.length == 0){
				...
				//税率不可为空
	        	if(nui.get("tax").getValue()== null){
	        		nui.alert("税率必填！");
	        		return;
	        	}
	        	//税率为0
	        	if(nui.get("tax").getValue()== 0){
	        		massage=massage+"税率未零，"
	        	}
        	
        	    //审核归档判断
				if(!checked ){
	        		nui.alert("请确认并选择纸质凭证送抵成功已归档的选项后提交。");
	        		return;
	        	}
	        	if(form.validate()){
					nui.confirm(massage+"确认提交吗？", "确定？",
    	...
    	function changePurOutcostTax(){
    		//含税金额
    		var purOutcostTaxmon = nui.get("setamount2").getValue();
    		//税率
    		var purOutcostTax = nui.get("tax").getValue();
    		//alert(1 + parseFloat(purOutcostTax));
    		var purOutcostNotaxmon = purOutcostTaxmon/(1 + purOutcostTax/100);
    		nui.get("notaxmon").setValue(parseFloat(purOutcostNotaxmon).toFixed(2));
    	}
	    ...
	    //打印报销单信息
		function doPrint(){
			var pettyexpno = nui.get("pettyexpno").getValue();
			var expStart = pettyexpno.indexOf("P");
			var exptype="E";
			if(expStart == 0){
			   exptype="2";
			}
			executeUrl = "<%= request.getContextPath() %>/ame_fee/myExpenseReimbursement/printAll.jsp?expno=" + pettyexpno+"&exptype="+exptype;
			window.open(executeUrl);		
 		}
