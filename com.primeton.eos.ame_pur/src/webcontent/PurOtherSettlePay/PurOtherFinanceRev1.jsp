	     ...
	     <fieldset id="field3" style="border:solid 1px #aaa;padding:3px;">
			...
			<div id="datagrid2" class="nui-datagrid" dataField="purPresettles" style="width:100%;height:auto;" 
			     ...
			     <div property="columns">
		             ...
		             <div field="projectname" width="80" headerAlign="center" allowSort="true" visible="true">项目名称</div>
			...
			<div style="padding:5px;">
				...
				<table style="table-layout:fixed;" id="table_file">
					<tr>
						...
						<td><input name="expReiList.expRei.total" id="setamount2"  inputStyle="text-align: right;" onvaluechanged="changeSetamount"  class="nui-textbox" required="true" style="width:170px" />&nbsp  (元)</td>
						<td align="right" style="width:150px;">税金：</td>
						<td style="width:200px;"><input name="expReidetail.tictax" id="exptictax"  inputStyle="text-align: right;" onvaluechanged="changeSetamount" format="n2"  minValue="0" showButton="false" allowLimitValue="false"  class="nui-spinner" required="true" style="width:200px" /></td>
						<td align="right" style="width:150px;">不含税金额：</td>
						<td style="width:200px;"><input name="purSettle.notaxmon" id="notaxmon" format="n2" changeOnMousewheel="false"  inputStyle="text-align: right;" readonly="readOnly" style="width:200px" class="nui-spinner" showButton="false" allowLimitValue="false"/></td>
					</tr>
						<tr>
							...
							<td><input name="expReiList.expRei.paymode" id="appmode" class="nui-dictcombobox" dictTypeId="EXP_PAYMODE" required="true" style="width:200px"/></td>
							<td align="right" style="width:150px;">税率：</td>
							<td style="width:200px;"><input name="purSettle.tax" id="tax" format="n2" changeOnMousewheel="false" inputStyle="text-align: right;" readonly="readOnly" style="width:200px" class="nui-spinner" showButton="false" allowLimitValue="false"/></td>
						</tr>
						<tr>
							...
							<td><input name="expReiList.expRei.bankname" id="bankname"  class="nui-textbox" required="true" style="width:200px"/></td>
							<td align="right" style="width:150px;">财务合同编号：</td>
							<td><input name="purSettle.contnum" id="contnum"   class="nui-buttonedit" allowInput="true" required="false" style="width:200px" onbuttonclick="selectCont"/></td>
						</tr>
						<tr>
							...
							<td><input name="purSettle.workamount" id="workamount" class="nui-spinner" showButton="false" allowLimitValue="false" changeOnMousewheel="false" style="width: 200px;" inputStyle="text-align: left"  /></td>
							<td align="right" style="width:150px;">成本归属类型：</td>
							<td ><input name="purSettle.costtype" id="costtype" class="nui-dictcombobox" dictTypeId="AME_CONTCOSTTYPE" required="false" style="width:200px"/></td>
						</tr>
						<tr style="display:none">
							<td align="right" style="width:150px;">对应客户：</td>
							<td>
							<input name="expReiList.custname" id="custno2" readOnly="readOnly" showButton="false" valueField="miscustid" textField="custname" class="nui-combobox" required="false" style="width:200px;" /></td>
							<td align="right" style="width:150px;">对应项目：</td>
							<td><input name="expReiList.projectname" id="projectno2" readOnly="readOnly" showButton="false" valueField="projectNo" textField="projectName" class="nui-combobox" required="false" style="width:200px" /></td>
						</tr>
						<tr style="display:none">
							<td align="right" style="width:150px;">受益部门：</td>
							<td><input name="expReiList.benefdeptno" id="benefitid2" readOnly="readOnly" showButton="false" class="nui-buttonedit" required="false" style="width:200px" /></td>
						</tr>
						<tr >
						...
						<tr>
		                    ...
		                    <td ><input name="checkid" id="checkid" readOnly="readOnly"  class="nui-buttonedit" required="true" style="width:200px;" allowinput="false" />
		                    </td>
						</tr>
				</table>
			</div>
...
经营采购付款批权限执行：
<br>1、软件/服务/人力派遣/其他类（如装修）：20万以下由运营副总裁终审，20万及以上总裁终审
<br>2、硬件/数据类：40万以下运营副总裁终审，40万及以上总裁终审
	                    </td>
	                </tr>
	            </table>
	        </div>
