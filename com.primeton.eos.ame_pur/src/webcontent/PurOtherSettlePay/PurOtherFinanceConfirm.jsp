...
<div class="nui-fit">
	...
	<form id="form1" method="post">
	     <fieldset id="field1" style="border:solid 1px #aaa;padding:3px;">
			...
			<input name="purSettle.benefitid" id="benefitid" class="nui-hidden"/>
			...
			<div id="datagrid2" class="nui-datagrid" dataField="purPresettles" style="width:100%;height:auto;" 
				...
				<div property="columns">
					<div field="accruedid" headerAlign="center" allowSort="true" align="center" visible="true" width="55">计提编号</div>
		             ...
		             <div field="projectname" width="70" headerAlign="center" allowSort="true" visible="true">项目名称</div>
		             ...
		             <div field="comment" width="70" headerAlign="center" allowSort="true" visible="fales">备注</div>
				...
				<table style="table-layout:fixed;" id="table_file">
					<tr>
						...
						<td style="width:200px;"><input name="expReiList.expRei.total" id="setamount2"  inputStyle="text-align: right;" format="n2" changeOnMousewheel="false"
							 showButton="false"  class="nui-spinner" readonly="readOnly" style="width:150px" allowLimitValue="false"/>&nbsp  (元)</td>
					...
					<tr>
						...
						<td><input name="purOutcost.pzyear" id="purOutcostPzyear" onvaluechanged="changepzyear" class="nui-monthpicker" format="yyyy" required="false" style="width:150px" /></td>
						<td align="right" style="width:100px;">凭证月：</td>
						<td ><input name="purOutcost.pzmonth" id="purOutcostPzmonth" onvaluechanged="changepzmonth" class="nui-monthpicker" format="MM"  required="false" style="width:100px" /></td>
						...
						<td colspan="3"><input name="purSettle.costmemo" id="costmemo" class="nui-combobox" multiSelect="false" showNullItem="true" 
							required="true" style="width:100px" textField="dictname" valueField="dictid" dataField="costmemos"  onvaluechanged="changecostmemo" />
						</td>
					</tr>
					<tr style="display:none">
					...
					<tr >
						...
						<td colspan="5"><input name="expReiList.explain" id="explain"  class="nui-textarea"  onvaluechanged="changecomment" style="width:700px;height:40px;"/></td>
					</tr>
					<tr>
		...
		function init(){
			...
			nui.ajax({
				...
				success:function (o){
					...
					nui.get("purcontid").setValue(o.purSettles[0].purcontid);
					...
					nui.get("benefitid").setValue(o.purSettles[0].benefitid);
			       ...
			       // nui.get("settlementno").setValue(o.purSettle.settlementno);
		         	nui.get("purOutcostTax").setValue(parseFloat(o.purSettles[0].tax/0.01).toFixed(2));
		         	//nui.get("purOutcostNotaxmon").setValue(o.purSettles[0].notaxmon);
...
//             ------------------------------------------------冲销信息初始化----结束----------------------------------
    	...
    	function makeOtherGoSettelpayRev(){
    		...
    		//data.purSettle.pzhs=nui.get("purOutcostPzhs").getValue();
    		//data.purSettle.pzhs=nui.get("purOutcostPzhs").getValue();
    		...
    		//data.purSettle.notaxmon=nui.get("purOutcostNotaxmon").getValue();
    		...
    		data.purSettle.presettleflag = 1;//标识当前是财务确认付款
    		//审核信息
		...
		function changecostmemo(){
			var costmemo = nui.get("costmemo").getValue();
			if(costmemo){
				nui.get("costmemo1").setValue(costmemo);
			}
		}
	</script>
</body>
