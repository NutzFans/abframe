			...
			<div style="padding:5px;">
				...
				<table style="table-layout:fixed;" id="table_file">
					...
					<tr>
						...
						<td><input name="erpexptpettyexp.linkman" id="linkman" class="nui-textbox" required="false" style="width:150px"/></td>--%>
					</tr>
					<tr>
					    <%--<td align="right" style="width:120px;">联系电话：</td>
						<td><input name="erpexptpettyexp.companytel" id="companytel" class="nui-textbox" required="false" style="width:250px"/></td>--%>
						<td align="right" style="width:120px;">工作量单位：</td>
						<td><input name="purSettle.workunit" id="workunit" readOnly="readOnly" value="1" class="nui-dictcombobox" dictTypeId="SERV_NUM_TYPE" required="false" style="width: 80px" /></td>
						<!-- 工作量数量 -->
					...
					<tr>
						...
						<td><input name="purSettle.costtype" id="costtype" readOnly="readOnly" class="nui-dictcombobox" dictTypeId="AME_CONTCOSTTYPE" required="false" style="width:150px"/></td>
					</tr>
					<tr style="display:none">
					...
					<tr >
						...
						<td colspan="3"><input name="expReiList.explain" id="explain" class="nui-textarea" required="false" onvaluechanged="changecomment" style="width:700px;height:40px;"/></td>
					</tr>
					<span>
					<tr>
...
<form name="viewlist1" id="viewlist1" action="com.primeton.eos.ame_common.ameExportCommon.flow" method="post">
   ...
   <input type="hidden" name="fileName" filter="false"/>
	...
	<script type="text/javascript">
		...
		init();
		function init(){
		    promptInit({"workItemID":<%=workItemID %>,"processDefName":"com.primeton.eos.ame_pur.ame_purOtherSettlePay","activityDefID":"manualActivity4"});
			...
			nui.ajax({
				...
				success:function (o){
					...
					//nui.get("custno").setValue(o.purSettles[0].miscustid);//客户id
					//nui.get("custno").setText(o.purSettles[0].miscustname);//客户名称
			        ...
			        //nui.get("settlementno").setValue(o.purSettles[0].settlementno);
			        //成本归属类型为空，默认设置为成本项
