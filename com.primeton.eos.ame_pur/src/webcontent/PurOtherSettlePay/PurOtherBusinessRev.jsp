			...
			<div style="padding:5px;">
				...
				<table style="table-layout:fixed;" id="table_file">
					...
					<tr>
						...
						<td style="width:200px;"><input name="purSettle.tax" format="n2" id="tax" changeOnMousewheel="false"  inputStyle="text-align: right;" readonly="readOnly" style="width:150px" class="nui-spinner" showButton="false" allowLimitValue="false"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input name="purSettle.workamount" id="workamount" class="nui-spinner" showButton="false" allowLimitValue="false" changeOnMousewheel="false" style="width: 100px;" inputStyle="text-align: left"  /></td>
...
<div id="win1" class="nui-window" title="成本确认日期" style="width:100px;height:120px;" 
	...
	<script type="text/javascript">
		...
		init();
		function init(){
		    promptInit({"workItemID":<%=workItemID %>,"processDefName":"com.primeton.eos.ame_pur.ame_purOtherSettlePay","activityDefID":"manualActivity2"});
			...
			nui.ajax({
				...
				success:function (o){
					...
					if(o.purSettles[0].workunit != null ){
						nui.get("workunit").setValue(o.purSettles[0].workunit);//工作量单位
					}
					if(o.purSettles[0].workamount != null){
					...
					//nui.get("projectno").setText(o.purSettles[0].projectname);
					//nui.get("benefitid").setValue(o.purSettles[0].orgid);
					//nui.get("benefitid").setText(o.purSettles[0].orgname);
		...
		function onSelectCont(e){ 
            ...
            var sum=0;
            if(purSettles[0].contnum == null || purSettles[0].contnum==""){
            	nui.get("contnum").setValue(rows.outcontnum);
                        ...
                        success:function(text){
                            ...
                            if(returnJson.exception == null){
                                nui.alert("确认计提成功", "系统提示",function(){
                                	...
                                	var jsonPresettle = nui.decode({purPresettle: {custid: custid,projectno: projectno,purcontnum:purcontnum}});//,iden: "2"
	    ...
	    function onSelectPrj(e){
        	...
        	if(rows.length == 0){
        		...
        		var purcontnum = grid.getSelecteds()[0].purcontnum;
        		var jsonPresettle = nui.decode({purPresettle: {custid: custid,projectno: projectnos,purcontnum:purcontnum}});//,iden: "1"
        		grid2.load(jsonPresettle,function(){
	            	//选择计提
	            	if(purSettles.length >= 1) {
	            		grid2.selectAll(false);
