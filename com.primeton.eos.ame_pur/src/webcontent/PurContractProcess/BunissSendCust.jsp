			...
			<fieldset id="field3" style="border:solid 1px #aaa;padding:3px;">
            	...
            	<table style="table-layout:fixed;" id="table_purOrder">
					...
					<tr>
						...
						<td colspan="5"><input name="purOrder.purordernum" id="purordernum" class="nui-textbox" required="false" vtype="rangeChar:0,30" style="width:120px"/></td>
					</tr>
					<tr>
				...
				<fieldset id="field3" style="border:solid 1px #aaa;padding:3px;">
					<legend>送递信息</legend>
					<input name="amePostservice[0].post" id="post" class="nui-hidden" value="2"/>	
					<input name="amePostservice[0].postid" id="postid" class="nui-hidden" />	
					<table>
						<tr>
							<td align="right" style="width:150px">送递人：</td>
							<td><input name="amePostservice[0].postorname" id="postorname" class="nui-textbox" required="false"  style="width:100px"/></td>
						...
						<tr>
							...
							<td><input name="amePostservice[0].postdate" id="postdate" class="nui-datepicker" required="false"  style="width:100px"/></td>
						...
						<tr>
							...
							<td><input name="amePostservice[0].receivername" id="receivername" class="nui-textbox" required="false"  style="width:100px"/></td>
						...
						<tr>
							...
							<td colspan="3"><input name="amePostservice[0].postaddress" id="postaddress" class="nui-textbox" required="false" style="width:100%"/></td>
						</tr>
						<tr>
							<td align="right" style="width:150px">邮寄内容：</td>
							<td colspan="3"><input name="amePostservice[0].postcontent" id="postcontent" class="nui-textbox" required="false"  style="width:100%"/></td>
						</tr>
					</tbody>
				</table>
			</fieldset>
...
<script type="text/javascript">
	...
	function loadData(){
		...
		nui.ajax({
			...
			success:function (o){
				...
				//邮寄信息更改
				nui.get("postorname").setValue(o.amePostservice[0].receivername);
				nui.get("receivername").setValue(o.purContract.liankman);
	...
	function SaveData() {
        ...
        var json = nui.encode({purContract:o.purContract,purOrder:o.purOrder,misOpinion:data5.misOpinion,amePostservice:o.amePostservice[0],purProjConts:data_purProjCont});
        nui.ajax({
