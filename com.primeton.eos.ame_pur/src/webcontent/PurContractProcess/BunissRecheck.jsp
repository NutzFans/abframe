...
<body>
	<div class="nui-fit">
		...
		<fieldset id="field1" style="border:solid 1px #aaa;padding:3px;">
			...
			<form id="form1" method="post">
				...
				<input name="purContract.isHaveOrder" id="isHaveOrder" class="nui-hidden"/>
				...
				<div style="padding:5px;">
					<table style="table-layout:fixed;" id="table_file">
						<tr>
							...
							<td style="width:130px;"><input name="purContract.contmoney" id="contmoney" class="nui-textbox" style="width:100px" vtype="float" onvaluechanged="contmoneyValueChanged"/>&nbsp;(元)</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input name="purContract.linktel" id="linktel" class="nui-textbox" vtype="rangeLength:8,30" style="width:140px"/></td>
						...
						<tr>
							...
							<td><input name="purContract.purcontnum" id="purcontnum" class="nui-textbox" style="width:140px"/></td>
						</tr>
						<tr>
			...
			<form id="form3" method="post">
            	...
            	<table style="table-layout:fixed;" id="table_purOrder">
					...
					<tr>
						...
						<td><input name="purOrder.purordernum" id="purordernum" class="nui-textbox" required="false" vtype="rangeChar:0,30" style="width:200px"/></td>
					</tr>
					<tr>
	...
	<form id="opioionform" method="post">
	    ...
	    <input name="misOpinion.auditopinion" value="修改合同处理信息" class="nui-hidden" />
		...
		<fieldset style="border:solid 1px #aaa;padding:3px;">
	        ...
	        <div style="padding:5px;" id="opinionHide">
	            <table style="table-layout:fixed;">
		            ...
		            <tr>
	                    <td style="width:150px;" align="right">会签处理人：</td>
...
<script type="text/javascript">
		...
		nui.ajax({
			...
			success:function (o){
				...
				if(o.purContract.YesOrNo==0){
					...
					nui.get("isHaveOrder").setValue(0);//不带订单，不走PMO信息入库环节处理
					...
					nui.get("isHaveOrder").setValue(1);
				}
    ...
    var activitydefid3= nui.get("activitydefid").getValue()
        console.log(activitydefid3);
     if(activitydefid3=='manualActivity2'){
		        var checkerid1 = nui.get("checkerid").getValue()
		    		if(checkerid1==null||checkerid1==""){
		    			nui.alert("会签处理人不可以为空！");
		    			return false;
		    		} 
