...
<div class="nui-fit">
	...
	<jsp:include page="/ame_common/ameFlowOperTips/ameFlowOperTipsInfo.jsp"/>
			...
			<form id="form1" method="post">
				...
				<table style="table-layout:fixed;" id="table_file">
					<tr>
						...
						<td style="width:200px;"><input name="purContract.purSupplier.custid" id="custid" class="nui-buttonedit" required="true" style="width:200px" emptyText="请选择供应商" onbuttonclick="selectSupplier" allowInput="false" /></td>
						<td align="right" style="width:100px">合同类型：</td>
						<td style="width:130px;"><input name="purContract.purtype" id="purtype"  class="nui-dictcombobox" dictTypeId="AME_CONTYPE" required="true" style="width:100px" showNullItem="true" nullItemText="" onvaluechanged="dealWithPurContName"/></td>
						<td align="right" style="width:100px">合同金额：</td>
						<td style="width:285px;"><input name="purContract.contmoney" id="contmoney" class="nui-textbox" style="width:170px" vtype="float" onvaluechanged="contmoneyValueChanged"/>&nbsp;(元)</td>
					</tr>
					<tr>
						<td align="right" style="width:120px">有效开始日期：</td>
						<td><input name="purContract.startdate" id="startdate" class="nui-datepicker" vtype="date:yyyy-MM-dd" style="width:100px" onblur="dealWithPurContName"/></td>
						<td align="right" style="width:100px">有效截止日期：</td>
						<td style="width:130px"><input name="purContract.enddate" id="enddate" class="nui-datepicker" vtype="date:yyyy-MM-dd" style="width:100px" onblur="dealWithPurContName"/></td>
					...
					<tr>
						...
						<td align="right" style="width:100px">供应商联系电话：</td>
						<td><input name="purContract.linktel" id="linktel" class="nui-textbox" vtype="rangeLength:8,30" style="width:130px"/></td>
						<td align="right" style="width:100px">供应商电子邮件：</td>
						<td colspan="5"><input name="purContract.linkemail" id="linkemail" class="nui-textbox" vtype="email" style="width:200px"/></td>
					</tr>
					<tr>
		...
		<div id="chosepurorder">
			<table style="table-layout:fixed;" id="tb_purOrderYesOrNo">
				<tr>
					<td style="width:120px;" align="right">是否携带工作协议书：</td>
					<td style="width:140px;">  
						<input name="purorderyon" id="purorderyon" class="mini-dictradiogroup" value="n" style="width:180px;" required="true" dictTypeId="ABF_YESORNO"  onvaluechanged="yesOrNo()" />
					</td>
				</tr>
			</table>
		</div>
            	...
            	<table style="table-layout:fixed;" id="table_purOrder">
					<tbody>
						<tr>
							...
							<td style="width:200px"><input name="purOrder.projectno" id="projectno" class="nui-combobox" valueField="projectno" required="true" textField="projectName" allowInput="false" showNullItem="true" nullItemText="" style="width:200px" /></td>
	...
	function loadData(){
		...
		nui.ajax({
			...
			success:function (o){
				...
				if(o.purContract.YesOrNo==0){//不带订单
					document.getElementById("field3").style.display="none";
				}else if(o.purContract.YesOrNo==1){//带订单
					document.getElementById("chosepurorder").style.display="none";
...
// 			nui.get("auditopinion").setValue("");
		...
		//是否带订单
		function yesOrNo(){
			var purorderyon = nui.get("purorderyon").getValue();
			if(purorderyon=="y"){
				addPurOrder();
			}else {
				delPurOrder();
	...
	function SaveData() {
	    ...
	    var json = nui.encode({purContract:data1.purContract,purOrder:data3.purOrder,misOpinion:data5.misOpinion,purProjConts:data_purProjCont, paymentPlans:data_paymentPlan});
        nui.ajax({
