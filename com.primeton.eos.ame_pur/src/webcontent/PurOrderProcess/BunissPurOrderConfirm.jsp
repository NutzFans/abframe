	...
	<jsp:include page="/ame_common/ameFlowOperTips/ameFlowOperTipsInfo.jsp"/>
		...
		<fieldset id="field3" style="border:solid 1px #aaa;padding:3px;">
			...
			<form id="form3" method="post">
				...
				<input name="purOrder.isDirectToSupplier" id="isDirectToSupplier" class="nui-hidden"/>
			...
			<input id="receivernameTemp" class="nui-hidden" />	
				<table>
					<tr>
							...
							<td style="width:200px"><input type="radio" value="0"  name="isDirectToSupplier" id="isDirectToSupplier" onclick="getRadio()" checked="checked"/>销售
...
<script type="text/javascript">
	...
	function onOk(){
		...
		var isDirectToSupplier=""; //0销售、1供应商
		for(var i=0;i<temp.length;i++)  {  
		    if(temp[i].checked)      
		    isDirectToSupplier = temp[i].value;
		} */
		nui.get("isDirectToSupplier").setValue("1");
		if(confirm("确认提交？")){
