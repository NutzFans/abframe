	...
	<form id="form1" method="post">
			...
			<div style="padding:5px;">
				<table style="table-layout:fixed;" id="table_file">
					<tr>
						...
						<td align="right" style="width:120px;">供应商：</td>
						<td cosplan="3"><input name="purSettle.custid"  onbuttonclick="changeCust" <%--onvaluechanged="changeCust"--%> id="custid" readOnly="readOnly" valueField="custid" textField="custname" class="nui-buttonedit" emptyText="请选择供应商" required="true" style="width:200px" allowInput="false" />
						</td>
					</tr>
	     ...
	     <fieldset id="field2" style="border:solid 1px #aaa;padding:3px;">
	       ...
	       <div id="datagrid" class="nui-datagrid" dataField="purContracts" style="width:100%;height:auto;"
			    ...
			    <div property="columns">
			       ...
			       <div field="payMoney" headerAlign="center" allowSort="false" visible="true" numberFormat="n2" width="100" align="right">已付款/审核中的合同额</div>
	     ...
	     <fieldset id="field10" style="border:solid 1px #aaa;padding:3px;">
	     	...
	     	<div id="datagrid10" class="nui-datagrid" dataField="purProjCont" style="width:100%;height:auto;" 
				...
				<div property="columns">
					...
					<div field="managerdept" align="center" headerAlign="center" allowSort="false" visible="false">实施部门id</div>
					...
					<div field="projectName" width="55" align="center" headerAlign="center" allowSort="false" >项目名称</div>
					...
					<div field="settlementno" width="90" align="right" headerAlign="center" allowSort="false" cellCls="myIndex">
						结算单编号
						<input property="editor" class="nui-textbox" style="width:100%;" vtype="float" />
					</div>
			...
			<div style="width: 100%;height:24px;float:left;">
				<table style="table-layout:fixed;">
					<tr>
						<td align="right" style="width: 280px;">结算费用总计：</td>
	     ...
	     <fieldset id="field3" style="border:solid 1px #aaa;padding:3px;">
			...
			<div id="datagrid2" class="nui-datagrid" dataField="purPresettles" style="width:100%;height:auto;" 
				...
				<div property="columns">
					<div field="accruedid" headerAlign="center" allowSort="true" align="center" visible="true" width="55">计提编号</div>
		             ...
		             <div field="notaxmoney" headerAlign="center" allowSort="true" width="55" align="right" dataType="currency" >(不含税)金额</div>
			...
			<table style="table-layout:fixed;">
				<tr>
					...
					<td id="sumNottotalpre" style="width:70px;" align="right" ></td>
				</tr>
			</table>
			</div>
	    </fieldset>
		...
		<fieldset id="field5" style="border:solid 1px #aaa;padding:3px;">
			...
			<div style="padding:5px;">
				...
				<table style="table-layout:fixed;" id="table_file">
					<tr>
						<td align="right" style="width:150px;">本次结算金额：</td>
						<td style="width:200px;"><input name="expReiList.expRei.total" id="setamount2"  inputStyle="text-align: right;" format="n2" changeOnMousewheel="false"
							 showButton="false"  class="nui-spinner" readonly="readOnly" style="width:170px" allowLimitValue="false"/>&nbsp  (元)</td>
						...
						<td style="width:200px;"><input name="purSettle.notaxmon" id="notaxmon"  inputStyle="text-align: right;" changeOnMousewheel="false" format="n2" readonly="readOnly" style="width:150px" class="nui-spinner" showButton="false" allowLimitValue="false"/></td>
					</tr>
					<tr>
						...
						<td align="right" style="width:150px;">税率：</td>
							<td style="width:200px;"><input name="purSettle.tax" id="tax"  inputStyle="text-align: right;" readonly="readOnly" changeOnMousewheel="false" format="n2" style="width:150px" class="nui-spinner" showButton="false" allowLimitValue="false"/>
							</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input name="purSettle.workunit" id="workunit"  value="1" class="nui-dictcombobox" dictTypeId="SERV_NUM_TYPE" required="true" style="width: 200px" /></td>
						<!-- 工作量数量 -->
						<td align="right" style="width:100px;">工作量数量：</td>
					...
					<tr>
						<td align="right" style="width:150px;">凭证年：</td>
						<td><input name="purOutcost.pzyear" id="purOutcostPzyear" onvaluechanged="changepzyear" class="nui-monthpicker" format="yyyy" required="false" style="width:200px" /></td>
						<td align="right" style="width:100px;">凭证月：</td>
						<td ><input name="purOutcost.pzmonth" id="purOutcostPzmonth" onvaluechanged="changepzmonth" class="nui-monthpicker" format="MM"  required="false" style="width:150px" /></td>
						<td align="right" style="width:150px;">成本说明：</td>
						<td colspan="3"><input name="purSettle.costmemo" id="costmemo" class="nui-combobox" multiSelect="false" showNullItem="true" 
							required="true" style="width:150px" textField="dictname" valueField="dictid" dataField="costmemos"/>
						</td>
					</tr>
					<tr style="display:none">
					...
					<tr >
						...
						<td colspan="5"><input name="expReiList.explain" id="explain"  class="nui-textarea"  onvaluechanged="changecomment" style="width:800px;height:40px;"/></td>
					</tr>
					<tr>
		...
		<td><input name="purOutcost.confirmdate" id="purOutcostConfirmdate" class="nui-datepicker" required="true" inputStyle="text-align: right;" style="width: 150px;" /></td>
		<td align="right" style="width:100px;" id="a5">付款日期：</td>
		<td><input name="purOutcost.paydate" id="purOutcostPaydate" class="nui-datepicker" required="true" inputStyle="text-align: right;" style="width: 100px;" /></td>
		<td align="right" style="width:100px;" id="a2">税率：</td>
		<td id="a7"><input name="purOutcost.tax" id="purOutcostTax" onvaluechanged="changePurOutcostTax" class="nui-textbox"  allowLimitValue="false" changeOnMousewheel="false" showButton="false" required="true" inputStyle="text-align: right;" style="width: 70px;" /> %</td>
		<td align="right" style="width:100px;" id="a8">成本说明</td>
		<td> <input name="purOutcost.costmemo" id="costmemo1" class="nui-combobox" multiSelect="false" showNullItem="true" 
		...
		<fieldset id="field6" style="border:solid 1px #aaa;padding:3px;">
			...
			<div id="datagrid3" class="nui-datagrid" dataField="purOutCosts" style="width:100%;height:auto;" 
			     ...
			     allowCellEdit="true" onlyCheckSelection="true" allowSortColumn="false" showPager="false">
			     <div property="columns">
		             ...
		             <div field="pzhs" headerAlign="center" allowSort="true" width="120" align="center" >凭证编号
		             		<input property="editor" class="nui-textbox" style="width:100%;" />
		             </div>
		             <div field="outcoststatus" headerAlign="center" width="70" visible="false">结转状态</div>
			     </div>
	        </div>
	    </fieldset>
				...
				<div id="paymentPlanGrid" class="nui-datagrid" style="width:100%;height:auto;" allowResize="false" dataField="plans"  showSummaryRow="true" ondrawsummarycell="drawPaymentPlanSum"
			 	url="com.primeton.eos.ame_pur.purPaymentPlan.paymentPlanQueryByContract.biz.ext"  allowCellEdit="false" showPager="false" multiSelect="true" >
					<div property="columns">
						...
						<div field="purContract.purcontname" width="250" align="left" headerAlign="center" >采购合同名称</div>	
			...
			<input id="receivernameTemp" class="nui-hidden" />	
				<table>
					    <tr>
							...
							<td><input name="amePostservice[0].postorname" id="postorname" readOnly="readOnly"  class="nui-textbox" required="false" vtype="rangeChar:2,30" style="width:250px"/></td>
							<td align="right" style="width:120px">送递方式：</td>
							<td><input name="amePostservice[0].postway" id="postway" readOnly="readOnly"  class="nui-dictcombobox" dictTypeId="AME_POSTWAY" style="width:250px" showNullItem="true" nullItemText=""/></td>
						</tr>
				</table>
			</form>
		</fieldset>
...
<form name="viewlist1" id="viewlist1" action="com.primeton.eos.ame_common.ameExportCommon.flow" method="post">
   ...
   <input type="hidden" name="fileName" filter="false"/>
	...
	<script type="text/javascript">
		...
		function init(){
		    promptInit({"workItemID":<%=workItemID %>,"processDefName":"com.primeton.eos.ame_pur.ame_purOtherSettlePay","activityDefID":"manualActivity6"});
			...
			nui.ajax({
				...
				success:function (o){
					...
					var flag = true;
					var settlementidList1 = "";
					if(projectnos.indexOf(",") > -1){
					for(var i=0;i<projectnos.length-1;i++){
						for(var j=0;j<projectnos.length;j++)
						if(projectnos[i]==projectnos[j]){
						flag = false;
						settlementidList1 = settlementidList.substring(0,settlementidList.indexOf(","));
						break;
						}
					}
					//加载附件设置参数
            		nui.get("grid_0").load({"groupid":"purSettle","relationid":settlementidList1});
					}else{
					//加载附件设置参数
					...
					nui.get("costmemo1").setValue(o.purOutCosts[0].costmemo);
			        }
		        	...
		        	if(settlementid){
			    		var json2 = nui.decode({"criteria": 
					                		  ...
					                		  ,"_expr[1]": {"_property": "purtype","_op": "in","_value": 'SO,HW,SU,PU,BU,OT,HU'}
                    ...
                    //与订单相关的计提信息
					var jsonPresettle = nui.decode({purPresettle: {projectno: projectnos},settlementid: settlementidList});
		        	...
		        	if(o.purOutCosts==null||jQuery.isEmptyObject(o.purOutCosts)){
		        			grid3.clearRows();
		            		...
		            		var newRow={name: "New Row",taxmon:outmoney,projectno:projectno,settlementid:settlementid,accruedid:accuredids,
    	...
    	function changeSetamount(){
			...
			var exptictax = nui.get("exptictax").getValue();
    	...
    	function makeOtherGoSettelpayRev(){
    		...
    		if(rdProject.length == 1){
    			for(var i=0;i<rdProject.length;i++){
	         		data.purSettle.projectno = rdProject[i].projectno;
         		}
    		}
    		//回退信息
    		if(backTo == 'manualActivity1'){
    		  data.backflag = "2";
    		}
    		else if(backTo == 'manualActivity2' || backTo == 'manualActivity3' || backTo == 'manualActivity4'){
    		  data.backflag = "1";
    		}
    		else if(backTo == 'manualActivity')
    		{
    		  data.backflag = "3";
    		}
    		
    		//结转明细数据
    		data.purSettle.paydate=nui.get("purOutcostPaydate").getValue();
    		data.purSettle.tax=nui.get("purOutcostTax").getValue()/100;
    		data.purOutcost.tax=nui.get("purOutcostTax").getValue()/100;
    		data.purSettle.confirmdate=nui.get("purOutcostConfirmdate").getValue();
    		data.purOutcost.purcontno=rows[0].purcontnum;
    		//结转的成本说明
    		data.purOutcost.costmemo = nui.get("costmemo1").getValue();
    		var pzyear = nui.get("purOutcostPzyear").getValue();
    		if(pzyear){
	    		pzyear = pzyear.getFullYear();
	    		data.purSettle.pzyear = pzyear;
    		}
    		var pzmonth = nui.get("purOutcostPzmonth").getValue();
    		if(pzmonth){
    		...
    		data.purSettle.setstatus="2";
    		data.purOutcost.contnum=data.purSettle.contnum;
    		...
    		data.purSettle.purPresettle = rowsPre;
		...
		function onOk(){
        	...
        	if(auditstatus == "2" || auditstatus == "0"  ){
			   ...
			   if(rows.length == 0){
				...
				if(checkSure == '1'){
					if(form.validate()){
						nui.confirm(massage+"本操作提交将通知发起人本次结算已付款，确定提交吗？", "确定？",
			            function (action) {            
			                if (action == "ok") {
			                	nui.get("sureButton").setEnabled(false);
						    	document.getElementById("fileCatalog1").value="purSettle";
    	...
    	function sumtaxmon(){
			...
			if(!isNaN(tax)){
				...
				var rate = tax;
	    		nui.get("purOutcostTax").setValue(rate);
				//成本结转金额（不含税）
    	...
    	//凭证年选择事件
	  	function changepzyear(){
	  		...
	  		if(pzyear){
		  		...
		  		nui.get("purOutcostPzmonth").setValue(yearmonth);
	  		}
	  	}
	  	//凭证月选择事件
	  	function changepzmonth(){
	  		...
	  		if(pzmonth){
		  		...
		  		var yearmonth = cyear + "-" + cmonth;
		  		nui.get("purOutcostPzyear").setValue(yearmonth);
		  	}
	  	}
	    ...
	    function onSelectPrj(e){
        	...
        	if(rows.length == 0){
        		...
        		var settlementid=nui.get("settlementid").getValue();
        		var jsonPresettle = nui.decode({purPresettle: {custid: custid,projectno: projectnos},settlementid:settlementid});
        		grid2.load(jsonPresettle,function(){
	            	//选择计提
	            	if(purSettles.length >= 1) {
	            		grid2.selectAll(false);
