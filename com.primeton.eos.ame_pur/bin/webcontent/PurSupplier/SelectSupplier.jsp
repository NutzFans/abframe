...
<body>
    ...
    <div class="nui-fit">
    	<div id="datagrid1" class="nui-datagrid" style="width:100%;height:100%;" allowResize="true" onrowdblclick="onRowDblClick" dataField="purSuppliers" url="com.primeton.eos.ame_pur.PurSupplier.queryPurSupplier.biz.ext" sizeList="[10,20,50,100]" pageSize="15"  multiSelect="false">
