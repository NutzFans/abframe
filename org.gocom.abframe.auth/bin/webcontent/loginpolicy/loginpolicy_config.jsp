...
<body leftmargin="0" topmargin="0">
    ...
    <w:tabPanel id="config" height="100%" width="100%">
        <w:tabPage id="blackConfig" tabType="iframe" title="<%=blackList %>" url="/abframe/auth/loginpolicy/loginpolicy_black_config.jsp" >
        </w:tabPage>
        <w:tabPage id="whiteConfig" tabType="iframe" title="<%=whiteList %>" url="/abframe/auth/loginpolicy/loginpolicy_white_config.jsp" >
        </w:tabPage>
    </w:tabPanel>
</body>
</html>
...
<script language="javascript">
   ...
   function isEnabledPolicy(){
         ...
         if(!$name("isEnabled").checked){
		     var myAjax = new Ajax("org.gocom.abframe.auth.LoginPolicyManager.setLoginPolicy.biz");
