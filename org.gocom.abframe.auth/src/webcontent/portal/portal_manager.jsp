    ...
    <tr>
      <td valign="top">
	    ...
	    <r:datacell id="portalDatacell"
		    queryAction="org.gocom.abframe.auth.PortalManager.queryAllPortalresList.biz"
		    xpath="portals"
		    width="390"
		    height="380"
		    pageSize="10"
		    pageSizeList="10,20,30" submitAction="org.gocom.abframe.auth.PortalManager.savePortalreslist.biz"  paramFormId="portalForm">
	   ...
	   <td valign="top">
	       <w:panel id="function" width="390" title="<%=funcRes %>">
		    ...
		    queryAction="org.gocom.abframe.auth.PortalManager.queryAllFunction.biz"
		    xpath="funcs"
		    width="390"
		    height="380"
		    pageSize="10"
