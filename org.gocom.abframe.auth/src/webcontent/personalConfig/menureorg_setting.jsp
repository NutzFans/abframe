...
<script type="text/javascript">
	...
	function saveIdentity(){		
        var myAjax = new Ajax("org.gocom.abframe.auth.PersonalsettingManager.updateSetting.biz");   
 		...
 		if( $name("operconfig/configvalue").checked ) {
 		    myAjax.addParam("operconfig/configvalue", "y");
 		} else{
 		    myAjax.addParam("operconfig/configvalue", "n");
 		}
...
<form action="org.gocom.abframe.auth.application.PersonalsettingManager.flow" name="form1" method="post">
...
<table align="center" border="0" width="100%" class="form_table">
	...
	<tr>
		...
		<td>
			<l:equal property="operconfigs/configvalue" targetValue ="y" compareType="string" scope="request">
			...
			<l:notEqual property="operconfigs/configvalue" targetValue ="y" compareType="string" scope="request">
