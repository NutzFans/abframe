...
<script type="text/javascript" language="javascript">
	...
	function clickNode(node)
	{
		...
		$name('detail').src='org.gocom.abframe.auth.application.PersonalsettingManager.flow?_eosFlowAction=querysetting&operconfig/configname='+dictid+"&operconfig/configvalue="+dictName;
	}
</script>
</head>
...
<TABLE border="0" width="100%" height="100%" cellpadding="0" cellspacing="0">
	<TR>
	  ...
	  <td valign="top" width="75%" height="100%">
	       <iframe  name="detail" style="width:100%;height:100%" frameBorder="0" scrolling="auto" src="org.gocom.abframe.auth.application.PersonalsettingManager.flow?_eosFlowAction=querysetting"></iframe>
	  </td>
  	</tr>
</table>
</body>
