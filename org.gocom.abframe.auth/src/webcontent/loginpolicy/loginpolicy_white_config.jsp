...
<%
	//登录限制管理
    String whiteQuery = com.eos.foundation.eoscommon.ResourcesMessageUtil.getI18nResourceMessage("loginPolicyManager_l_title_whiteQuery");
    //请选择
...
<body leftmargin="0" topmargin="0">
    <w:panel id="panel1" width="765" title="<%=whiteQuery %>">
        <table align="center" border="0" width="765" class="form_table">
            ...
            <tr>
	            ...
	            <td>
	                 <d:select dictTypeId="ABF_YESORNO" style="width:133" nullLabel="<%=pleaseSelect %>" name="criteria/_expr[4]/isenabled"></d:select>
	            </td>
	            ...
	            <td>
		             ...
		             <h:hidden property="criteria/_expr[5]/_pattern" value="yyyy-MM-dd"/>
	            </td>
	            ...
	            <td>
		             ...
		             <h:hidden property="criteria/_expr[6]/_pattern" value="yyyy-MM-dd"/>

                     <!-- 默认查询的是白名单 -->
		             <h:hidden property="criteria/_expr[7]/policytype" value="1"/>
    ...
    <r:datacell id="loginlimitConfig"
	    queryAction="org.gocom.abframe.auth.LoginPolicyManager.queryAllLoginPolicy.biz"
	    xpath="loginPolicys"
	    width="765"
	    height="330"
	    pageSize="10"
	    pageSizeList="10,20,30" submitAction="org.gocom.abframe.auth.LoginPolicyManager.saveLoginPolicyItem.biz" paramFormId="queryForm">
		...
		<!-- 不显示当前的登录限制类型 -->
	    <r:field fieldName="policytype" width="0" defaultValue="1" label="<%=policytype %>" >
	    </r:field>

	    <r:field fieldName="isenabled" label="<%=isenabled %>" >
	        <d:select property="isenabled" dictTypeId="ABF_YESORNO" nullLabel="<%=pleaseSelect %>"></d:select>
	    </r:field>
