/*******************************************************************************
 * $Header: /cvsroot/MIS10/src/NEWERP/org.gocom.abframe.auth/src/org/gocom/abframe/auth/listener/AuthContributionListener.java,v 1.1 2013/06/02 19:53:49 huangqj Exp $
 * $Revision: 1.1 $
...
package org.gocom.abframe.auth.listener;

import java.util.Iterator;

import org.gocom.abframe.ABFConfigKey;
import org.gocom.abframe.ABFGroup;
 ...
 * 修改历史 Revision 1.1  2013/06/02 19:53:49  huangqj
 ...
 * 修改历史 Update:如果eos governor中配置使用portal模式则abframe也同步取消权限校验
 * 修改历史
