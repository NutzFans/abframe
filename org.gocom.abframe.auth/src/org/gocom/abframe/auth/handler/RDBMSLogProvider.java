/*******************************************************************************
 * $Header: /cvsroot/MIS10/src/NEWERP/org.gocom.abframe.auth/src/org/gocom/abframe/auth/handler/RDBMSLogProvider.java,v 1.1 2013/06/02 19:53:46 huangqj Exp $
 * $Revision: 1.1 $
...
package org.gocom.abframe.auth.handler;
...
public class RDBMSLogProvider implements LogStorageProvider {
	...
	public void log(IUserObject user, LogConfig logConfig, IRuntimeContext runtimeContext, LogicSignature logicSignature, Throwable t) {
		...
		DataObject logObject=DataObjectUtil.createDataObject("org.gocom.abframe.dataset.tools.AtOperlog");
		
		logObject.set("operatorid", user.getAttributes().get("operatorid"));
		logObject.set("userid", user.getUserId());
		logObject.set("operatorname", user.getUserRealName());
