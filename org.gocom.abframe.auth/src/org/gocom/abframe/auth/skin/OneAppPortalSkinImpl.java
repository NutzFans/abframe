/*******************************************************************************
 * $Header: /cvsroot/MIS10/src/NEWERP/org.gocom.abframe.auth/src/org/gocom/abframe/auth/skin/OneAppPortalSkinImpl.java,v 1.1 2013/06/02 19:53:26 huangqj Exp $
 * $Revision: 1.1 $
 ...
 * Modify history Revision 1.1  2013/06/02 19:53:26  huangqj
 ...
 * Modify history portal的默认default 样式=abframe 的blue样式
 * Modify history
 * Modify history Revision 1.1  2010/12/24 20:03:11  caisy
 * Modify history 包重构到org.gocom.abframe.auth.skin
 * Modify history
...
public class OneAppPortalSkinImpl extends
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.gocom.abframe.auth.ISkinConvertor#getLayout()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.gocom.abframe.auth.ISkinConvertor#getOutsideName(java.lang.String)
	 */
	public String getStyle(HttpServletRequest request) {
		/**
		 * 先读取参数 再判断portal session 再abframe session
		 */
