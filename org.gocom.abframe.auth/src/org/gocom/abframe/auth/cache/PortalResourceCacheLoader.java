/*******************************************************************************
 * $Header: /cvsroot/MIS10/src/NEWERP/org.gocom.abframe.auth/src/org/gocom/abframe/auth/cache/PortalResourceCacheLoader.java,v 1.1 2013/06/02 19:53:42 huangqj Exp $
 * $Revision: 1.1 $
...
public class PortalResourceCacheLoader extends BasePermissionCacheLoader{
	...
	private Map getPortalResourceAll(){
		...
		if(portalResources==null||portalResources.length==0){
			...
			m.put("URL","org.gocom.abframe.auth.Login.flow");
			portalResources[0] =m; 			
		}
