/*******************************************************************************
 * $Header: /cvsroot/MIS10/src/NEWERP/org.gocom.abframe.auth/src/org/gocom/abframe/auth/bizlet/PermissionUtil.java,v 1.1 2013/06/02 19:53:38 huangqj Exp $
 * $Revision: 1.1 $
 * $Date: 2013/06/02 19:53:38 $
 *
 *==============================================================================
 *
...
import org.gocom.abframe.auth.cache.FunctionCacheManager;
import org.gocom.abframe.auth.cache.PortalResourceCacheManager;
import org.gocom.abframe.auth.permission.PermissionChecker;
import org.gocom.abframe.auth.permission.PermissionCheckerFactory;
 ...
 * 修改历史 Revision 1.1  2013/06/02 19:53:38  huangqj
...
public class PermissionUtil {
	...
	public static void retrieveFunction(String contributionPattern) {
		...
		for (IContributionMetaData contribution : contributions) {
			...
			if (conname.matches(contributionPattern)) {
				DataObject funcgroup = DataObjectUtil.createDataObject("org.gocom.abframe.dataset.privilege.AcFuncgroup");
				...
				for (IPageFlowMetaData pageflow : pageflows) {
					...
					for (IPageFlowActionMetaData action : actions) {
						...
						DataObject funcObject = DataObjectUtil.createDataObject("org.gocom.abframe.dataset.privilege.AcFunction");
	...
	private static void addFunc(List<DataObject> funcs, DataObject group, IPageFlowMetaData pageflow) throws Exception {
		DataObject mainfuncObject = DataObjectUtil.createDataObject("org.gocom.abframe.dataset.privilege.AcFunction");
	...
	private static DataObject addFuncGroup(List<DataObject> funcgroups, DataObject group, IPageFlowMetaData pageflow) {
		DataObject subfuncgroup = DataObjectUtil.createDataObject("org.gocom.abframe.dataset.privilege.AcFuncgroup");
	...
	public static void main(String[] args) {
		String[] qNames = {
				"http://www.baidu.com/eos-default/auth/org.gocom.abframe.auth.Login.flow",
				// "http://www.baidu.com/eos-default/auth/org.gocom.abframe.auth.Login.flowx?_eosFlowAction=login&a=1",
				// "http://www.baidu.com/eos-default/auth/org.gocom.abframe.auth.Login.flow.ajax",
				// "http://www.baidu.com/eos-default/auth/org.gocom.abframe.auth.Login.login.action",
				// "http://www.baidu.com/eos-default/auth/org.gocom.abframe.auth.Login.flowx.ajax",
				// "http://www.baidu.com/eos-default/auth/org.gocom.abframe.auth.LoginManager.login.remote",
				// "http://www.baidu.com/eos-default/auth/org.gocom.abframe.auth.LoginManager.login.bizx.ajax",
				"http://www.baidu.com/eos-default/auth/org.gocom.abframe.auth.LoginManager.login.biz.ajax", "http://www.baidu.com/eos-default/auth/org.gocom.abframe.auth.LoginManager.login.biz.ext",
				"http://www.baidu.com/eos-default/auth/org.gocom.abframe.auth.LoginManager.login.service.ajax", "http://www.baidu.com/eos-default/auth/org.gocom.abframe.auth.Login.login.remote" };
