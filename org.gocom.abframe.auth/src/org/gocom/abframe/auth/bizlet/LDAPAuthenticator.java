/*******************************************************************************
 * $Header: /cvsroot/MIS10/src/NEWERP/org.gocom.abframe.auth/src/org/gocom/abframe/auth/bizlet/LDAPAuthenticator.java,v 1.1 2013/06/02 19:53:38 huangqj Exp $
 * $Revision: 1.1 $
...
import org.gocom.abframe.auth.ldap.LDAPAuthResult;
import org.gocom.abframe.auth.ldap.LDAPUtil;
import org.gocom.abframe.auth.ldap.PasswordExpiredException;
import org.gocom.abframe.auth.ldap.UserLockoutException;
 ...
 * Revision 1.1  2013/06/02 19:53:38  huangqj
 * *** empty log message ***
 *
...
public class LDAPAuthenticator {
	...
	public static void main(String[] args){
		...
		System.out.println("SHA\t"+CryptoUtil.digestBySHA("abframe"));
		System.out.println("MD5\t"+CryptoUtil.digestByMD5("abframe"));
