/*******************************************************************************
 * $Header: /cvsroot/MIS10/src/NEWERP/org.gocom.abframe.auth/src/org/gocom/abframe/auth/bizlet/MenuUtil.java,v 1.1 2013/06/02 19:53:38 huangqj Exp $
 * $Revision: 1.1 $
...
public class MenuUtil {
		...
		if (funclist != null) {
			for (int i = 0; i < funclist.length; i++) {
				...
				if (!appid.equals(tmpApp)) {
					tmpApp = appid;
					DataObject acApplication = DataObjectUtil.createDataObject("org.gocom.abframe.dataset.privilege.AcApplication");
		...
		if (funclist != null) {
			for (int i = 0; i < funclist.length; i++) {
				...
				if (!groupid.equals(tmpFuncGoup)) {
					tmpFuncGoup = groupid;
					DataObject acFuncgroup = DataObjectUtil.createDataObject("org.gocom.abframe.dataset.privilege.AcFuncgroup");
	...
	public static boolean updateMenuSeq() {
		...
		try {
			String update_level_1 = "org.gocom.abframe.auth.menuMaintain.update_level_1";
			String update_level_n = "org.gocom.abframe.auth.menuMaintain.update_level_n";
			String update_seq_1 = "org.gocom.abframe.auth.menuMaintain.update_seq_1";
			String update_seq_n = "org.gocom.abframe.auth.menuMaintain.update_seq_n";
			String select_menu = "org.gocom.abframe.auth.menuMaintain.select_menu";
