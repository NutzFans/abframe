/*******************************************************************************
 * $Header: /cvsroot/MIS10/src/NEWERP/org.gocom.abframe.auth/src/org/gocom/abframe/auth/bizlet/SkinUtil.java,v 1.1 2013/06/02 19:53:38 huangqj Exp $
 * $Revision: 1.1 $
...
import org.gocom.abframe.auth.skin.DefaultSkinImpl;
import org.gocom.abframe.auth.skin.ISkinConvertor;
...
public class SkinUtil {
	...
	public static ISkinConvertor initISkinConvertor() {
		...
		try {
			...
			service = new DefaultSkinImpl();
			LogUtil.logError("init Static  ISkinConvertor instance faild,use org.gocom.abframe.auth.DefaultSkinImpl ", e, (Object) null);
		}
		return service;
	}
