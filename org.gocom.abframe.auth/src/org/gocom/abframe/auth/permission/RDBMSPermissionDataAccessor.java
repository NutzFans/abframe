/*******************************************************************************
 * $Header: /cvsroot/MIS10/src/NEWERP/org.gocom.abframe.auth/src/org/gocom/abframe/auth/permission/RDBMSPermissionDataAccessor.java,v 1.1 2013/06/02 19:53:48 huangqj Exp $
 * $Revision: 1.1 $
...
public class RDBMSPermissionDataAccessor implements PermissionDataAccessor {
	...
	public Object[] loadRolePermissionAll()throws Exception {
		return DatabaseExt.queryByNamedSql("default", "org.gocom.abframe.auth.permission.loadRolePermissionAll", new HashMap());
	}
	...
	public Object[] loadRolePermissionAll(String roleId)throws Exception {
		...
		return DatabaseExt.queryByNamedSql("default", "org.gocom.abframe.auth.permission.loadRolePermissionAll", parameterMap);
	}

	public Object[] loadOperatorFunctionAll()throws Exception {
		return DatabaseExt.queryByNamedSql("default", "org.gocom.abframe.auth.permission.loadOperatorFunctionAll", new HashMap());
	}
	...
	public Object[] loadOperatorFunctionAll(String operatorid)throws Exception {
		...
		return DatabaseExt.queryByNamedSql("default", "org.gocom.abframe.auth.permission.loadOperatorFunctionAll", parameterMap);

	}

	public Object[] loadPortalResourceAll()throws Exception {
		return DatabaseExt.queryByNamedSql("default", "org.gocom.abframe.auth.permission.loadPortalResourceAll",new HashMap());
	}
	public Object loadPortalResourceAll(String url)throws Exception {
		Object ret = null;
		HashMap<String ,String> param = new HashMap<String,String>();
		param.put("url", url);
		Object[] obj = DatabaseExt.queryByNamedSql("default", "org.gocom.abframe.auth.permission.loadPortalResourceAll",param);
