 /*******************************************************************************
 * $Header: /cvsroot/MIS10/src/NEWERP/org.gocom.abframe.auth/src/org/gocom/abframe/auth/permission/PermissionCheckedHandler.java,v 1.1 2013/06/02 19:53:48 huangqj Exp $
 * $Revision: 1.1 $
 ...
 *           &lt;group name=&quot;Provider&quot;&gt;
 *               &lt;!-- 用户自定义资源检查的handler --&gt;
 *               &lt;configValue key=&quot;CheckedHandler&quot;&gt;org.gocom.abframe.auth.permission.PermissionCheckedHandler&lt;/configValue&gt;
 *               &lt;!-- 用户自定义资源的创建工厂 --&gt;
 ...
 * 修改历史 Revision 1.1  2013/06/02 19:53:48  huangqj
 * 修改历史 *** empty log message ***
 * 修改历史
 * 修改历史 Revision 1.15  2010/12/24 20:03:10  caisy
 * 修改历史 包重构到org.gocom.abframe.auth.skin
 * 修改历史
 ...
 * governor中配置使用portal模式则abframe也同步取消权限校验
 * 
 ...
 * 
 * Revision 1.1 2009/01/05 02:34:50 caisy abframe二期初始版本
 * 
